...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_backup_job_create_gp_mssql.html"
last_updated: "2026"
...
* Select the Until the corresponding image-level backup is deleted option if you want to remove transaction log backups and the related image-level backups at the same time, according to the retention policy settings specified at [step 4](hpe_backup_job_create_destination.md).
...
![Microsoft SQL Server Transaction Log Settings](images/hpe_backup_job_create_gp_mssql.webp)
