...
2. In the Host or Cluster field, specify a host on which the VM will run.
...
4. Click the Customize machine BIOS UUID button and choose whether to preserve the BIOS UUID or generate a new BIOS UUID. By default, the BIOS UUID is preserved.
