...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vcd_guest_processing.html"
...
* [Application-aware processing](vcd_app_processing.md)
...
* [PostgreSQL settings](vcd_replication_postgresql.md)
* [File exclusion settings](vcd_replica_guest_exclusions.md)
* [Pre-freeze and post-thaw scripts](vcd_replica_scripts.md)

![Step 12. Specify Guest Processing Settings](images/vcd_replica_guest.webp)
