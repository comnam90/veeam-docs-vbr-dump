...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hardened_repository_add_web_review.html"
...
At the Review step of the wizard, review details of the hardened repository and specify importing settings.

1. Review the hardened repository settings and list of components that will be installed on the hardened repository server.
