...
Performing Restore to Proxmox VE

The restore procedure of entire workloads to Proxmox VE practically does not differ from the procedure described in the [Performing VM Restore](https://helpcenter.veeam.com/docs/vbproxmoxve/userguide/restore_entire_vm.html?ver=3) section in the Veeam Plug-In for Proxmox VE User Guide.
