...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/login_on_to_office_365_lib.html"
...
This step is only available for data restore from backups created by Veeam Backup for Microsoft 365 and if you have selected the Modern Authentication option at the [previous step](specify_credentials_lib.md) of the wizard.
