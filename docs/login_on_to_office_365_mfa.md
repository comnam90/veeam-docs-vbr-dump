...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/login_on_to_office_365_mfa.html"
...
This step is only available if you have selected the Modern Authentication (one-time password) option at the [previous step](select_authentication_method_mfa.md#auth_code) of the wizard.
