...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_workers.html"
last_updated: "2026"
...
| --- |
| Important |
| To modify the worker settings, use the Veeam Backup & Replication console as described in section [Editing Workers](sangfor_workers_edit.md). Making any configuration changes to VMs running as workers manually in the Sangfor Cloud Platform Admin Portal may cause technical issues. |
...
* [Adding Workers](sangfor_workers_add.md)
* [Testing Workers](sangfor_workers_test.md)
* [Enabling and Disabling Workers](sangfor_workers_disable.md)
* [Editing Workers](sangfor_workers_edit.md)
* [Disabling Automatic Worker Updates](sangfor_workers_update.md)
* [Removing Workers](sangfor_workers_remove.md)
