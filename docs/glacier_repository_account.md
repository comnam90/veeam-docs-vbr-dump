...
The user account must have permissions listed in section [Permissions](permissions_object_storage.md#agos).
...
![Step 3. Specify Object Storage Account](images/glacier_account.webp)
