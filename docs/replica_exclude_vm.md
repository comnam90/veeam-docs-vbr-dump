...
* [VMs or VM containers](replica_exclude_vm.md#vm)
* [VM disks](replica_exclude_vm.md#disks)

|  |
| --- |
| Note |
| To make the replication process faster and reduce the size of created replicas, Veeam Backup & Replication automatically excludes the following objects from replication:   * VM log files * VM templates from VM containers |
...
![Step 5. Exclude Objects from Replication Job](images/vm_replica_job_exclude_vms.webp)
