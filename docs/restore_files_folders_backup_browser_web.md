---
title: "Step 2. Select Files and Folders to Restore"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_files_folders_backup_browser_web.html"
last_updated: "2026"
...
In the Browse, select files and folders to restore. Backup browser has three representations of restore points. You can select one of the following options in the Restore Point group on the ribbon to display file versions:
...
* If you restore a whole folder, you will be prompted to the [Select Restore Point to Use](restore_files_folders_restore_point_web.md) step to select a restore point to restore files from.
...
* If you restore a single file, you will be prompted to the [Select File Version to Restore](restore_files_folders_file_version_web.md) step to select a file version to restore the file from.
...
[![Step 2. Select Files and Folders to Restore](images/restore_files_folders_backup_browser_web.webp)](images/restore_files_folders_backup_browser_web.webp)
...
[![Step 2. Select Files and Folders to Restore](images/restore_files_folders_backup_browser_owerwrite_web.webp)](images/restore_files_folders_backup_browser_owerwrite_web.webp)
...
If you restore files and folders to a new location, you will be prompted to the [Specify Destination for File Restore](restore_files_folders_destination_web.md) step to specify a new destination.

[![Step 2. Select Files and Folders to Restore](images/restore_files_folders_backup_browser_copy_to_web.webp)](images/restore_files_folders_backup_browser_copy_to_web.webp)
...
1. Select the necessary folder in the file tree in the left pane or a folder or file in the right pane. You can use [Ctrl] to select multiple objects in the right pane.
2. Select Compare to Production on the ribbon.
...
| --- |
| Tip |
| Consider the following:   * To show only changed files and folders (in the changed and deleted states), perform the compare operation, and click Show Changes Only on the ribbon. To show all files and folders, click the Show changes only option once again.  * To switch off the comparison states, select an item in the comparison state and click Compare with Production on the ribbon. Note that if you switch off comparison for child files and folders, comparison for parent folders will also be switched off. |

[![Step 2. Select Files and Folders to Restore](images/restore_files_folders_backup_browser_compare_web.webp)](images/restore_files_folders_backup_browser_compare_web.webp)
...
[![Step 2. Select Files and Folders to Restore](images/restore_files_folders_backup_browser_owerwrite_changed_web.webp)](images/restore_files_folders_backup_browser_owerwrite_changed_web.webp)
...
[![Step 2. Select Files and Folders to Restore](images/restore_files_folders_backup_browser_compare_attributes_web.webp)](images/restore_files_folders_backup_browser_compare_attributes_web.webp)
