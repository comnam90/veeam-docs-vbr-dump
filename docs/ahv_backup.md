...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_backup.html"
...
If some file in the backup chain is missing, you will not be able to roll back to the necessary state. For this reason, you must not delete individual backup files from the backup repository manually. Instead, you must specify retention policy settings that will let you maintain the necessary number of backup files in the backup repository.  For more information, see [Backup Retention](ahv_retention_backups.md).

Related Topics

* [Forever Forward Incremental Backup](ahv_forever_forward_backup.md)
* [Forward Incremental Backup](ahv_forward_backup.md)
