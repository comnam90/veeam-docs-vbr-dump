...
The plug-in enables integration between the backup server and the Scale Computing HyperCore cluster. The plug-in also allows the backup server to deploy and manage workers.
