---
title: "Upgrading to Veeam Plug-In for Nutanix AHV 10"
product: "vbr"
doc_type: "userguide"
...
# Upgrading to Veeam Plug-In for Nutanix AHV 10


You can upgrade Veeam Plug-in for Nutanix AHV from version 8 or 9 to version 10. To upgrade Veeam Backup for Nutanix AHV version 4.0, 4a, 5.0, 5.1, 6, 6.1 and 7 to version 10, you must first upgrade it to version 7.1 as described in the Veeam Backup for Nutanix AHV 7 User Guide, section [Upgrading to Veeam Backup for Nutanix AHV 7.1](https://helpcenter.veeam.com/archive/vbahv/7/userguide/upgrading_vbahv.html).
...
To upgrade Veeam Plug-in for Nutanix AHV to version 10, do the following:

1. Upgrade your Veeam Backup & Replication server to version 13.1 as described in section [Upgrade and Update](vbr_updating.md).
...
| --- |
| Important |
| [Applies only to Veeam Plug-in for Nutanix AHV version 7.1] Do not remove the backup appliance manually if the upgrade process completes with errors. If you remove the appliance, you will have to reconfigure workers and recreate backup jobs that will start new backup chains of your backups. |
