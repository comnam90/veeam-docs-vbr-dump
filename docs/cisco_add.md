...
1. [Launch New Cisco HyperFlex System wizard](cisco_add_launch.md).
2. [Specify the storage name or address and storage role](cisco_add_name.md).
3. [Specify credentials](cisco_add_creds.md).
4. [Specify a proxy](cisco_add_proxy.md).
