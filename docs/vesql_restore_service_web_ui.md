...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vesql_restore_service_web_ui.html"
last_updated: "2026"
...
These components are deployed on the staging server (in case of data export and data recovery to a specific transaction) or on the target server (all remaining operations).
...
Veeam Explorer for Microsoft SQL Server also has an enhanced security mode, which allows you to only use persistent components during data recovery. To enable this functionality, go to %ProgramData%\Veeam\Backup\SQLExplorer on the mount server. If a configuration file named Config.xml does not exist in this directory, create this file. In the configuration file, enter the following XML code:
...
* [How Restore Works](vesql_how_restore_works_web_ui.md)
* [How Publishing Works](vesql_how_publishing_works_web_ui.md)
* [How Instant Recovery Works](vesql_instant_hiw_web_ui.md)
* [How Export Works](vesql_how_export_works_web_ui.md)
