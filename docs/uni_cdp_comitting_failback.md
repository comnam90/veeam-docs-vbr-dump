...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uni_cdp_comitting_failback.html"
...
For more information on failback commit, see [Failover and Failback for CDP](uni_cdp_failover_failback.md) and [Failback Commit](uni_cdp_failback_commit.md).
