...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_pne_sql_dns_zones.html"
last_updated: "2025"
...
* If you want to create and manage the DNS zones manually, log in to the [Microsoft Azure portal](https://portal.azure.com) and create 3 Azure private DNS zones named privatelink.blob.core.windows.net, privatelink.queue.core.windows.net and privatelink.database.windows.net, as described in [Microsoft Docs](https://learn.microsoft.com/en-us/azure/dns/private-dns-getstarted-portal). It is recommended that you create the DNS zones in the same resource group where the backup appliance resides, to simplify resource management.
...
[![Creating Private DNS Zones for SQL Server](images/azure_pne_sql_dns_zones.webp)](images/azure_pne_sql_dns_zones.webp "Creating Private DNS Zones for SQL Server")
