...
1. [Launch the Restore wizard](vesp_restore_item_wizard_doc.md).
2. [Select an authentication method](specify_credentials_doc.md).
3. [Log in to Microsoft 365](login_on_to_office_365_doc.md).
4. [Specify a target list](vesp_restore_item_target_doc.md).
