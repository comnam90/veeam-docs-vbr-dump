---
title: "Step 9. Define Job Schedule"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_job_schedule_hv_web.html"
...
+ Monthly at this time. The job will run once a month on specific days. In the fields on the right of the radio button, specify the time and required days and months.
...
To create a chain of jobs, you must define the time schedule for the first job in the chain. For the rest of the jobs in the chain, at the Schedule step of the wizard, select the After this job option and choose the preceding job from the list. For more information on job chaining and recommendations for it, see [Chained Jobs](job_schedule_hv.md#chain).
...
1. Select the Terminate the job outside of the allowed backup window check box and click Configure Backup Window.
...
[![Click to zoom in](images/hv_backup_job_schedule_web.webp)](images/hv_backup_job_schedule_web.webp "Click to zoom in")
