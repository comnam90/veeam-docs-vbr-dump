...
| MongoDB | Veeam Backup & Replication supports backup of the following MongoDB versions:   * MongoDB 8.0 (Community Edition and Enterprise Advanced) * MongoDB 7.0 (Community Edition and Enterprise Advanced)   For more information, see [MongoDB Backup](mongo_backup.md). |
