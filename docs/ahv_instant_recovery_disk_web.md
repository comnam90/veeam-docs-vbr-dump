...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_instant_recovery_disk_web.html"
last_updated: "2026"
...
With Instant Disk Recovery, you can immediately restore VM disks from a backup file and publish them in their initial format. Before you start a Instant Disk Recovery operation, check the following prerequisites:
...
1. [Check prerequisites and limitations](ahv_ir_disk_limitations_web.md).
2. [Launch the Instant Disk Recovery wizard](ahv_recovery_disks_launch_web.md).
3. [Select a restore point](ahv_recovery_disks_restore_point_web.md).
4. [Configure disk mapping](ahv_recovery_disks_mapping_web.md)
5. [Specify a restore reason](ahv_recovery_disks_reason_web.md).
6. [Finalize the instant recovery operation](ahv_recovery_disks_summary_web.md).
