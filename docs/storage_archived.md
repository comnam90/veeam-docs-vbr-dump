...
After the retrieval finishes, Veeam Backup & Replication will show the retrieved snapshots under the ![Retrieving Archived Snapshots](images/icon_snapshot_retrieved.webp "Retrieve snapshot icon") icon.
