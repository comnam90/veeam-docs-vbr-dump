...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/entra_id_log_job_repo.html"
...
| --- |
| Note |
| Veeam Backup for Microsoft Entra ID does not support storing log backups in [Veeam Cloud Connect repositories](https://helpcenter.veeam.com/docs/backup/cloud/cloud_connect_repository.html?ver=13) or [Amazon S3 repositories with multiple buckets](object_storage_repository.md). |
