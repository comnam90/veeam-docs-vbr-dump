...
* In the Home tab on the ribbon, click Restore > Object Storage. In the Restore from Object Storage Backup window, click Restore entire bucket.
...
* Right-click the buckets or containers that you want to restore and select Restore entire bucket.
