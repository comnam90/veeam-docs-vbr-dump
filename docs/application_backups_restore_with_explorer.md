...
* [For Microsoft SQL Server database backup] Click Microsoft SQL Server on the ribbon or right-click the backup and select Restore from Microsoft SQL Server backup.
