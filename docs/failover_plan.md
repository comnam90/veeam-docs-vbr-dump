...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/failover_plan.html"
...
![Failover Plans](images/failover_plan.webp)
...
When you perform failback or permanent failover, you need to process each VM individually. For more information, see [Performing Failback](performing_failback.md) and [Performing Permanent Failover](failover_permanent.md). When you undo failover, you can process the whole group. For more information, see [Undoing Failover by Failover Plans](failover_plan_undo.md).

Related Topics

* [Creating Failover Plans](creating_failover_plans.md)
* [Running Failover Plans](running_failover_plans.md)
* [Undoing Failover by Failover Plans](failover_plan_undo.md)
