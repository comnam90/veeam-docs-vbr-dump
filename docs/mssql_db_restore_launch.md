...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/mssql_db_restore_launch.html"
...
To launch the Restore Database wizard, on Microsoft SQL Server, do one of the following:
