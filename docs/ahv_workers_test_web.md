...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_workers_test_web.html"
last_updated: "2026"
...
2. Select the necessary worker and click Test Worker.

Note that you can select and test multiple workers at once.

As soon as Veeam Backup & Replication finishes the worker configuration test, the worker will be powered off. Powered-off workers are displayed with an Offline status on the Proxies & Workers page.

[![Editing Workers](images/ahv_workers_test_web.webp)](images/ahv_workers_test_web.webp "Editing Workers")
