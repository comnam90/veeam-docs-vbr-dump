...
To restore a IBM Db2 database from a full backup, use one of the following commands depending on the OS you are using:
...
|  |
| --- |
| db2 restore db <database\_name> load 'C:\Program Files\Veeam\VeeamPluginforDB2\DB2Plugin.dll' taken at <timestamp> |
...
To restore a IBM Db2 database from an incremental backup, use one of the following commands depending on the OS you are using:
...
|  |
| --- |
| db2 restore db <database\_name> incremental automatic load 'C:\Program Files\Veeam\VeeamPluginforDB2\DB2Plugin.dll' taken at <timestamp> |
...
1. Extract archive logs from the backup file with one of the following commands depending on the OS you are using:
...
|  |
| --- |
| db2 restore database <database\_name> logs load 'C:\Program Files\Veeam\VeeamPluginforDB2\DB2Plugin.dll' LOGTARGET <path\_to\_logs> |
...
1. Return the database to the state recorded in a backup with one of the following commands depending on the OS you are using:
...
|  |
| --- |
| db2 restore database <database\_name> load 'C:\Program Files\Veeam\VeeamPluginforDB2\DB2Plugin.dll' taken at <timestamp> replace existing |
