...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/veor_ir_multiple_latest_specify_switchover_settings.html"
...
* Manual: switchover is started manually by the user at any time after all database files are copied and synchronized.
