...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_schedule_based_policy_byb.html"
last_updated: "2026"
...
* Veeam Plug-in for AWS runs retention sessions for backup policies at 4:00 AM by default, according to the time zone set on the backup appliance. If you schedule backup policies to execute at 4:00 AM, the backup policies and retention tasks will be queued.
