...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/detach_backup.html"
...
The detached backup files remain in the backup repository and the Veeam Backup & Replication console. Veeam Backup & Replication shows the detached backups in the [inventory pane](vbr_ui.md) in the node with the (Orphaned) postfix. These backups are retained according to the background retention process. For more information, see [Background Retention](background_retention_job.md).
