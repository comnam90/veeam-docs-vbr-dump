...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_win_volumes_web.html"
last_updated: "2026"
...
The Objects step of the wizard is available if you have selected the Volume-level backup option at the [Backup Mode](agent_policy_win_mode_web.md) step of the wizard.

At this step of the wizard, specify volumes to include in or exclude from the backup. The specified settings will apply to all computers that are added to the backup policy. If a specified volume does not exist on one or more computers in the policy, the policy will skip such volume on those computers and back up only existing ones.
...
[![Specify Volumes to Back Up](images/agent_policy_volumes_web.webp)](images/agent_policy_volumes_web.webp "Specify Volumes to Back Up")
