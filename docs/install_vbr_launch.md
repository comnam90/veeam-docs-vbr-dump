...
1. After you mount the image or insert the disk, Autorun will open a splash screen. If Autorun is not available or disabled, run the Setup.exe file from the image or disk.
2. In the splash screen, click Install.
