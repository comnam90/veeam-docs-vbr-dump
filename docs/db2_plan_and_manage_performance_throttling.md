---
title: "Reducing Load on the IBM Db2 Server"
product: "vbr"
doc_type: "userguide"
...
To reduce the load that backup operations put on the IBM Db2 server, you can throttle Veeam Plug-In performance.
