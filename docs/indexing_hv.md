...
![VM Guest OS File Indexing](images/indexing_hyperv.webp)

Requirements for VM Guest OS File Indexing

Consider the following requirements for VM guest OS file indexing:

* Veeam Backup & Replication supports file indexing for VMs running Microsoft Windows and Linux OS.
* Linux VMs must have the following tools installed: openssh, gzip and tar.
...
* [Veeam Backup Catalog](indexing_catalog_hv.md)
