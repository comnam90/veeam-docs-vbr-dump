---
title: "Restore to Sangfor aSV"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_sangfor.html"
last_updated: "2026"
product_version: "13.1.0.411"
---

# Restore to Sangfor aSV


Veeam Backup & Replication allows you to recover different workloads as Sangfor aSV VMs.

Supported Backup Types

To restore workloads to Sangfor aSV, you can use the following backups:
...
Performing Restore to Sangfor aSV

The restore procedure of entire workloads to Sangfor aSV practically does not differ from the procedure described in [Performing VM Restore](sangfor_restore_entire_vm.md).

[![Launch Full VM Restore to Red Hat Virtualization Wizard](images/sangfor_restore_entire_vm_launch.webp)](images/sangfor_restore_entire_vm_launch.webp "Launch Full VM Restore to Red Hat Virtualization Wizard")
