...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/policy_microsoft_sql_server_databases.html"
...
At the Databases step of the wizard, select protection groups, computers, SQL instances or individual databases whose data you want to back up.
...
| --- |
| Note |
| In the Select Objects window, Veeam Backup & Replication shows only those computers on which Veeam Backup & Replication have detected a Microsoft SQL Server database during the rescan job. To learn more, see [Rescan Job](rescan_job.md). |
...
![Step 3. Specify Databases](images/plugins_policy_mssql_database.webp)
...
![Step 3. Specify Databases](images/plugins_policy_mssql_database_exclude.webp)
