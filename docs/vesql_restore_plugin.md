...
This section explains how to restore data from backups created with Veeam Plug-In for Microsoft SQL Server. For more information, see [Veeam Plug-In for](mssql_plugin.md) Microsoft SQL Server.
