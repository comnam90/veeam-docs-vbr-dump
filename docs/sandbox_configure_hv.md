...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sandbox_configure_hv.html"
...
1. Configure a virtual lab in which you plan to start VMs. For more information, see [Creating Virtual Lab](vlab_hv.md).
2. Configure an application group. The application group must contain all VMs that you plan to start in the On-Demand Sandbox and all VMs on which these VMs are dependent. For more information, see [Creating Application Groups](appgroup_create_hv.md).
