...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_backup_job_vbr_vss_sql_web.html"
last_updated: "2026"
...
* Select the Until the corresponding image-level backup is deleted option if you want to remove transaction log backups and the related image-level backups at the same time, according to the retention policy settings specified at [step 4](ahv_backup_job_vbr_destination_web.md).
...
[![Launch Add Job Wizard](images/ahv_backup_job_vbr_vss_sql_web.webp)](images/ahv_backup_job_vbr_vss_sql_web.webp "Launch Add Job Wizard")
