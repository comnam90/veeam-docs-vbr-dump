...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/dell_vnx_agents_access.html"
...
[This step is available if you have selected the Block storage for Microsoft Windows servers check box at the [Specify Storage Name or Address and Storage Role](dell_vnx_add_name.md) step of the wizard.]
...
![Step 6. Specify Agents Access Options](images/emc_vnx_add_agents.webp)
