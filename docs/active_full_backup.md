...
* To create an active full backup manually, follow the steps described in section [Performing Active Full Backup](performing_active_full_backup.md).
...
![Active Full Backup](images/active_full_backup_vm.webp)
