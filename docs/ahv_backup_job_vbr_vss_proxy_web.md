...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_backup_job_vbr_vss_proxy_web.html"
last_updated: "2026"
...
| --- |
| Important |
| Due to technical limitations, Linux-based proxies cannot access Windows guest OSes in the current version. That is why if you have added Windows-based VMs to the backup scope at [step 3](ahv_backup_job_vbr_assign_vms.md) of the wizard, you must also add at least one Microsoft Windows server to the backup infrastructure. |

[![Launch Add Job Wizard](images/ahv_backup_job_vbr_vss_proxy_web.webp)](images/ahv_backup_job_vbr_vss_proxy_web.webp "Launch Add Job Wizard")
