...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/swap_files.html"
...
* [Configure swap file exclusion for backup jobs](backup_job_advanced_storage_vm.md)
* [Configure swap file exclusion for replication jobs](replica_advanced_traffic_vm.md)
