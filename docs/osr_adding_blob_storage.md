...
1. [Launch the New Object Storage Repository wizard](new_object_repository_azure.md).
2. [Specify object storage name](azure_repository_name.md).
3. [Specify object storage account](azure_repository_account.md).
4. [Specify object storage settings](azure_storage_details.md).
5. [Specify mount server settings](azure_storage_mount_server.md).
6. [Review components](azure_storage_review.md).
