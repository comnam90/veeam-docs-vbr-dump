...
* [Editing Settings of Scale-Out Backup Repositories](sobr_edit.md)
* [Rescanning Scale-Out Repositories](sobr_rescan.md)
* [Discovering Backups in Scale-Out Backup Repositories](sobr_discover.md)
* [Backup State Indicators](backup_states_indicators.md)
* [Extending Scale-Out Repositories](sobr_add_extent.md)
* [Service Actions with Scale-Out Backup Repositories](backup_repository_sobr_service.md)
* [Receiving Scale-Out Backup Repository Reports](sobr_reports.md)
