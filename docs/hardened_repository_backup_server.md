...
If you use a Veeam Software Appliance as a backup server, it acts as an immutable repository without additional preparation. This provides similar functionality to a hardened repository on a dedicated server.
