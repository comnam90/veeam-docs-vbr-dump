...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/veor_df_export_frp.html"
...
| --- |
| Note |
| This step is available only if you have selected the Perform restore to the specific transaction check box at the [Specify Restore Point](veor_df_export_srp.md) step of the wizard. |
