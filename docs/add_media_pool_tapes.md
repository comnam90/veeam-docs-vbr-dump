...
* Parallel processing: in this mode, tape jobs use drives in all libraries parallelly. For more information, see [Tape Parallel Processing](parallel_processing.md).
