...
1. [Сheck prerequisites](restore_azure_byb.md).
2. [Launch the Restore to Azure wizard](restore_azure_launch.md).
3. [Select workloads and restore points](restore_azure_vm.md).
4. [Select a subscription and location](restore_azure_location.md).
5. [Specify VM size and disks to restore](restore_azure_size.md).
6. [Specify a VM name and resource group](restore_azure_resource_group.md).
7. [Select a virtual network](restore_azure_network.md).
8. [Specify secure restore settings](restore_azure_av.md).
9. [Specify a restore reason](restore_azure_reason.md).
10. [Start the restore process](restore_azure_start.md).
