---
title: "Reducing Load on the Oracle Server"
product: "vbr"
doc_type: "userguide"
...
# Reducing Load on the Oracle Server


To reduce the load that backup operations put on the Oracle server, you can throttle Veeam Plug-In performance.
