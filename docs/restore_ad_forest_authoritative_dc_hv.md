...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_ad_forest_authoritative_dc_hv.html"
last_updated: "2026"
...
You can select a restore point only for the authoritative domain controllers of the non-root domains. The restore point for the root domain controller was set at the [AD Forest](restore_ad_forest_pit_hv.md) step of the wizard, where it defines the forest point in time.
...
![Step 3. Specify Restore Points for Authoritative Domain Controllers](images/restore_ad_forest_primary_dc_hv.webp "Selecting Restore Point for Authoritative Domain Controllers")
