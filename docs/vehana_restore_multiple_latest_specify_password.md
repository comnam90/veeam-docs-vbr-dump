---
title: "Step 5. Specify SYSTEM User Password"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vehana_restore_multiple_latest_specify_password.html"
...
This step of the wizard is only available if any of the databases selected at the [Select Databases](vehana_restore_multiple_latest_select_databases.md) step do not exist on the target server. In this case, the SAP HANA system creates new tenant databases on the target server and a new SYSTEM user for the new databases.
