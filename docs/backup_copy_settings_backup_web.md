...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_copy_settings_backup_web.html"
last_updated: "2026"
...
2. If you want to periodically perform a health check of the most recent restore point in the backup chain, select the Perform backup files health check on option and specify the health check schedule.
...
1. Select the Remove deleted items data after option and specify the retention policy settings for deleted workloads.
...
1. To periodically compact a full backup file, select the Defragment and compact full backup file option and specify the schedule.
