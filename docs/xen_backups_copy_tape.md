...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/xen_backups_copy_tape.html"
last_updated: "2026"
...
| --- |
| Note |
| You cannot restore Xen VMs directly from tapes. To restore a Xen VM, you must first restore its backups to a repository as described in section [Backup Restore from Tape to Repository](vm_restore_from_tape_to_repository.md). |
