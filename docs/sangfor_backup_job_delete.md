...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_backup_job_delete.html"
last_updated: "2026"
...
| --- |
| Tip |
| If you want to delete backup files as well, follow the instructions provided in section [Deleting Backups](sangfor_backups_delete.md). |

[![Deleting Backup Jobs](images/sangfor_backup_job_delete.webp)](images/sangfor_backup_job_delete.webp "Deleting Backup Jobs")
