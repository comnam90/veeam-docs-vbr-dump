...
Because Veeam Explorer for Microsoft SharePoint that is distributed as a part of Veeam Backup & Replication does not process hidden lists, such lists are also included in the table.
