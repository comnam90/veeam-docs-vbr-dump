...
2. In the inventory pane, select Virtual Labs under SureBackup and click Connect Virtual Lab on the ribbon or right-click Virtual Labs and select Connect Virtual Lab.
