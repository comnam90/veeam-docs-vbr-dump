...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/performing_active_full_backup_console.html"
...
| --- |
| Important |
| You can perform active full backup for individual workloads only if their backups are [per-machine with separate metadata files](per_vm_backup_files.md). |
