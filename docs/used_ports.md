...
| Gmail REST API  (gmail.googleapis.com) | TCP | 443 | Port used to communicate with Google Mail services.  For the authentication process, you need to access accounts.google.com and also gstatic.com for ressources like javascript. |
...
| Backup repository | TCP | 6162 | Default port used by Veeam Transport Service (Veeam Data Mover Service if Veeam Backup & Replication is installed on the Microsoft Windows machine). |
...
| From | To | Protocol | Port | Notes |
| --- | --- | --- | --- | --- |
| Source extent | Target extent | TCP | 2500 to 3300 | Default range of ports used for evacuation and rebalance operations of a scale-out backup repository. |
| TCP | 6162 | Default port used by Veeam Transport Service (Veeam Data Mover Service if Veeam Backup & Replication is installed on the Microsoft Windows machine). |
| Target extent | Source extent | TCP | 2500 to 3300 | Default range of ports used for evacuation and rebalance operations of a scale-out backup repository. |
| TCP | 6162 | Default port used by Veeam Transport Service (Veeam Data Mover Service if Veeam Backup & Replication is installed on the Microsoft Windows machine). |
