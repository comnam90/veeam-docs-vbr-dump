...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_instant_recovery_ahv_web.html"
last_updated: "2026"
...
1. [Check prerequisites and limitations](ahv_byb_instant_recovery_ahv_web.md).
2. [Launch the Instant Recovery wizard](ahv_ir_launch_ahv_web.md).
3. [Choose a restore point](ahv_ir_workloads_ahv_web.md).
4. [Choose a restore mode](ahv_ir_mode_ahv_web.md).
5. [Select a target cluster](ahv_ir_target_cluster_ahv_web.md).
6. [Specify a name for the restored workload](ahv_ir_workloads_ahv_web.md).
7. [Select a target storage container](ahv_ir_target_container_ahv_web.md).
8. [Configure network settings](ahv_ir_network_ahv_web.md).
9. [Specify a restore reason](ahv_ir_reason_ahv_web.md).
10. [Finalize the recovery process](ahv_ir_finalize_ahv_web.md).
