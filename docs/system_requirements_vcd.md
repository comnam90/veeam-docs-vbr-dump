---
title: "System Requirements (VMware Cloud Director)"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/system_requirements_vcd.html"
...
| --- |
| Note |
| The information on this page lists only infrastructure components specific for the protection of VMware Cloud Director vApps and virtual machines. For the list of all Veeam components, refer to [System Requirements](system_requirements.md). |
...
Veeam CDP Source and Target Datastore
