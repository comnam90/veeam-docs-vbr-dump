...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_delete_jobs.html"
...
| --- |
| Tip |
| If you want to delete backup files as well, follow the instructions provided in section [Deleting Backups](ahv_retention.md). |

[![Deleting Jobs](images/ahv_job_delete.webp)](images/ahv_job_delete.webp "Deleting Jobs")
