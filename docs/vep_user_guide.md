...
* [Planning and Preparation](vep_prerequisites.md)
* [Launching Application and Exploring Backups](vep_first_steps.md)
* [General Application Settings](vep_settings.md)
* [Data Restore](vep_data_restore.md)
* [Data Publishing](vep_data_publishing.md)
* [Instant Recovery](vep_ir.md)
