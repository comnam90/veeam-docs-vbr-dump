...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/iris_policy_advanced_notifications.html"
last_updated: "2026"
...
To specify notification settings for the application backup policy:
...
1. In the Subject field, specify a notification subject. You can use the following variables in the subject: %Time% (completion time), %JobName%, %JobResult%, %ObjectCount% (number of instances in the backup policy) and %Issues% (number of instances in the backup policy that have been processed with the Warning or Failed status).
...
[![Create New Application Backup Policy](images/iris_policy_advanced_notifications.webp)](images/iris_policy_advanced_notifications.webp "Create New Application Backup Policy")
