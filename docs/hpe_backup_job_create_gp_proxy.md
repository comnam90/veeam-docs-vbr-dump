...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_backup_job_create_gp_proxy.html"
last_updated: "2026"
...
| --- |
| Important |
| Due to technical limitations, Linux-based proxies cannot access Windows guest OSes in the current version. That is why if you have added Windows-based VMs to the backup scope at [step 3](hpe_backup_job_create_assign_vms.md) of the wizard, you must also add at least one Microsoft Windows server to the backup infrastructure. |

![Step 5c. Choose Guest Interaction Proxy](images/hpe_backup_job_create_gp_proxy.webp)
