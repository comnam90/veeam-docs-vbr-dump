...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/synthetic_full_hiw_hv.html"
...
If an active or synthetic full backups are scheduled for the chained job, but the initial job does not run on these days, the active and synthetic full backups will not be created for the chained job. For more information, see [Chained Jobs](job_schedule_hv.md#chain).
