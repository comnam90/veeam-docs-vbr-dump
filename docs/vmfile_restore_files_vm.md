...
1. From the Server list, select where to store VM files: on an ESXi host, on a Microsoft Windows or Linux server added to the backup infrastructure. Use the Details button to view or change connection settings of the target host or server.
