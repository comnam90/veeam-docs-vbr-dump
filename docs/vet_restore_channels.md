...
1. [Launch the Restore wizard](vet_launch_restore_channels.md).
2. [Select an authentication method](vet_select_auth_restore_channels.md).
3. [Log in to Microsoft 365](vet_login_restore_channels.md).
