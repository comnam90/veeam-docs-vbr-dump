...
After synchronization is completed, Veeam Plug-in for Kasten shows this information in the Veeam Backup & Replication console and performs incremental synchronization every 5 seconds to get updates.
