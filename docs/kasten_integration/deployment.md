...
If you want to set an additional layer of storage, configure the capacity tier and archive tier. For more information, see [Capacity Tier](https://helpcenter.veeam.com/docs/vbr/userguide/capacity_tier.html?ver=13) and [Archive Tier](https://helpcenter.veeam.com/docs/vbr/userguide/archive_tier.html?ver=13) sections in the Veeam Backup & Replication User Guide.

1. [Optional] Configure Tape infrastructure.

If you want to use tape devices to store Kubernetes persistent volumes, configure the tape infrastructure. For more information, see the [Tape Device Support](https://helpcenter.veeam.com/docs/vbr/userguide/tape_device_support.html?ver=13) section in the Veeam Backup & Replication User Guide.
