...
2. Complete the wizard as described in the [Performing Export](https://helpcenter.veeam.com/docs/vbr/userguide/performing_full_export.html?ver=13) section in the Veeam Backup & Replication User Guide.
