...
Backup files reside in a dedicated job folder in the backup repository. A set of backup files form a backup chain. For more information, see the [Backup Chain](https://helpcenter.veeam.com/docs/vbr/userguide/backup_files.html?ver=13) section in the Veeam Backup & Replication User Guide.
