...
| Backup server | Backup server | TCP/HTTPS | 6172 | Used by the Veeam Plug-in for Kasten to enable communication with the Veeam Backup & Replication database. |
| Veeam Kasten | TCP/HTTPS | 443 | Used by the Veeam Plug-in for Kasten to connect to Kasten. |
