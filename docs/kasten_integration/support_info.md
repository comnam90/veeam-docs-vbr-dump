...
source_url: "https://helpcenter.veeam.com/docs/vbr/kasten_integration/support_info.html"
last_updated: "2026"
...
If you have any questions or issues with Veeam Plug-in for Kasten, you can search for a resolution on [Veeam R&D Forums](https://forums.veeam.com/) or submit a support case in the [Veeam Customer Support Portal](https://www.veeam.com/support.html).
...
4. Complete the wizard as described in the [Exporting Logs](https://helpcenter.veeam.com/docs/vbr/userguide/agents_logs_export.html?ver=13) section in the Veeam Backup & Replication User Guide.

|  |
| --- |
| Important |
| In the Export Logs wizard, you cannot export logs for separate Kasten policies and backup files. |

![Support Information](images/export_logs.webp "Export Logs")
