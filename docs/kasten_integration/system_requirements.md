...
The machine where Veeam Plug-in for Kasten will run must meet the system requirements described in the [System Requirements](https://helpcenter.veeam.com/docs/vbr/userguide/system_requirements.html?ver=13) section in the Veeam Backup & Replication User Guide.
...
A Veeam Kasten application must be version 5.5.3 or later.

Kasten Dashboard Access

Set up external access to the Kasten dashboard. For more information, see [Veeam Kasten Docs](https://docs.kasten.io/latest/access/dashboard.html).
