...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/xen_configure_repository.html"
last_updated: "2026"
...
| --- |
| Important |
| Veeam Plug-in for Xen does not support storing backups directly in [Veeam Cloud Connect](https://helpcenter.veeam.com/docs/vbr/cloud/cloud_overview.html?ver=13) repositories. However, you can use them for [storing copies of backups](xen_backups_copy.md) created with Veeam Plug-in for Xen. |
