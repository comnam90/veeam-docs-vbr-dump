...
You can deploy Veeam Plug-In for Oracle RMAN, Veeam Plug-In for SAP HANA, Veeam Plug-In for Microsoft SQL Server, and Veeam Plug-In for SAP on Oracle from the Veeam Backup & Replication console. To deploy Veeam Plug-Ins, Veeam Backup & Replication needs to discover computers whose data you want to back up. To enable discovery, you organize your computers into one or more protection groups. Protection group settings define what computers Veeam Backup & Replication will discover and how the discovery process will run. To learn more, see [Protection Groups](protection_group_hiw.md).
