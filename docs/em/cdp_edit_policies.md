...
1. [Launch the Edit Policy wizard](cdp_launch_wizard.md).
2. [Edit the policy name and description](cdp_edit_name.md).
3. [Edit the list of VMs](cdp_edit_list_of_vms.md).
