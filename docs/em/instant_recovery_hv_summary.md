...
product: "vbr"
doc_type: "em"
source_url: "https://helpcenter.veeam.com/docs/vbr/em/instant_recovery_hv_summary.html"
...
![Step 7. Review Recovery Settings](images/instant_recovery_hv_summary.webp "Finishing Working with Wizard")

What You Do Next

After you have performed instant recovery, you have to finalize it. For more information, see [Finalizing Instant Recovery to Microsoft Hyper-V](instant_recovery_hv_finalize.md).
