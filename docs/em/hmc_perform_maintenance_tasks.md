...
For more information, see [Enterprise Manager Components](em_components.md).
...
In the Veeam Host Management TUI, you can reset the time shift protection on a Veeam Software Appliance. To do this, perform the following steps:
