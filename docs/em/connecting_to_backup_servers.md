---
title: "How Enterprise Manager Authenticates to Backup Servers"
product: "vbr"
doc_type: "em"
...
1. Veeam Backup Enterprise Manager sends the credentials as well as the server certificate thumbprint that will be used by Veeam Backup Enterprise Manager Service and Veeam Guest Catalog Service for authentication.
...
1. The next time Enterprise Manager connects to Veeam Backup & Replication, the Enterprise Manager server certificate is used for authentication.
