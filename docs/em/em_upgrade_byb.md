...
* To upgrade Veeam Backup Enterprise Manager to version 13.1, you must be running version 12.3.1 or later. To upgrade from earlier versions, contact [Veeam Customer Support](https://www.veeam.com/support.html).
...
* Check the Known Issues section of the [Veeam Backup & Replication Release Notes](https://helpcenter.veeam.com/rn/veeam_backup_13_1_release_notes.html).
...
The following table lists the updated SP settings for Enterprise Manager version 12 and 13.
