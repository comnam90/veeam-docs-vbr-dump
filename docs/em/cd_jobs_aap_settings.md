---
title: "cd_jobs_aap_settings"
source_url: "https://helpcenter.veeam.com/docs/vbr/em/cd_jobs_aap_settings.html"
...
* [General Settings](cd_jobs_aap_general.md)
* [Microsoft SQL Server Transaction Log Settings](cd_jobs_aap_sql.md)
* [Oracle Archived Log Settings](cd_jobs_aap_oracle.md)
* [PostgreSQL Archive Log Settings](cd_jobs_aap_postgresql.md)
* [VM Guest OS File Exclusion](cd_jobs_aap_file_exclusions.md)
