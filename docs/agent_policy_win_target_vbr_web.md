...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_win_target_vbr_web.html"
last_updated: "2026"
...
If you have selected the Veeam backup repository option at the [Destination](agent_policy_win_destination_web.md) step of the wizard, specify settings to connect to the backup repository:
...
[![Specify Backup Server](images/agent_policy_backup_server_web.webp)](images/agent_policy_backup_server_web.webp "Specify Backup Server")
...
1. Click Change default advanced settings to specify advanced settings for the backup policy. To learn more, see [Specify Advanced Backup Settings](agent_policy_win_advanced_web.md).

|  |
| --- |
| NOTE |
| You must enable backup file encryption in the [backup policy storage settings](agent_policy_advanced_storage_web.md) if you back up data to the Veeam Data Cloud Vault storage added as a Veeam backup repository. |

[![Specify Backup Storage Settings](images/agent_policy_storage_web.webp)](images/agent_policy_storage_web.webp "Specify Backup Storage Settings")
