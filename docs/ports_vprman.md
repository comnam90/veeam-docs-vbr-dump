...
The following table describes network ports that must be opened to ensure proper communication of the Oracle database server and backup infrastructure components.
