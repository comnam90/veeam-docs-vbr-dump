...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/repository_permissions_sap_orcl.html"
...
* Consider supported types of backup repositories and limitations for Veeam Plug-In backups in [Veeam Backup Repositories](sap_orcl_repos.md).
