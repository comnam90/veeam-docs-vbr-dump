...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hv_server_launch_web.html"
...
2. Click Add Server on the ribbon and select Virtualization Platforms > Microsoft Hyper-V.
3. Select the type of a Microsoft server to add to the backup infrastructure.
...
[![Step 1. Launch New Hyper-V Server Wizard](images/add_server_hv_web.webp)](images/add_server_hv_web.webp)
