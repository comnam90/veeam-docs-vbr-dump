...
You can manually start an application backup policy. This may be helpful if you want to create an additional restore point and do not want to change the backup schedule. You can also stop the policy, for example, if processing of an instance is about to take a long time and you do not want to produce extra workload on the production environment during business hours.
