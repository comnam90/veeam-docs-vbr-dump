...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_backup_job_delete.html"
...
| --- |
| Tip |
| If you want to delete backup files as well, follow the instructions provided in section [Deleting Backups](hpe_backups_delete.md). |

[![Deleting Backup Jobs](images/hpe_backup_job_delete.webp)](images/hpe_backup_job_delete.webp "Deleting Backup Jobs")
