...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_policy_finish_efs.html"
last_updated: "2026"
...
At the Summary step of the wizard, it is recommended that you run the backup policy configuration check before you click Finish — to do that, click Test Configuration. Depending on the option selected at [step 3](aws_add_policy_scope_efs.md) of the wizard, the following will happen:
...
[![Creating EFS Backup Policy](images/aws_backup_add_finish_efs.webp)](images/aws_backup_add_finish_efs.webp "Creating EFS Backup Policy")
