...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/cdp_failback_summary.html"
...
![Step 11. Finish Working with Wizard](images/cdp_failback_summary.webp "Finish working with wizard")

What You Do Next

Failback is an intermediate step that needs to be finalized. You can finalize failback in the following ways:

* [Commit failback](cdp_comitting_failback.md).
* [Undo failback](cdp_undoing_failback.md).
