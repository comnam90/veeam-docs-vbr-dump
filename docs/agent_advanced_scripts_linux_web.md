...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_advanced_scripts_linux_web.html"
last_updated: "2026"
...
* If you select the Run scripts every <N> backup session option, specify the number of backup job sessions after which the scripts must be executed.
...
| --- |
| NOTE |
| Custom scripts that you define in the advanced job settings relate to the backup job itself, not the OS quiescence process on protected computers. To add pre-freeze and post-thaw scripts for Veeam Agent computer OS quiescence, use the [Guest Processing](agent_job_guest_web.md) step of the wizard. |
