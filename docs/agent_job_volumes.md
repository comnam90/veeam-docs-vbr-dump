...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_job_volumes.html"
...
The Objects step of the wizard is available if you have selected the Volume level backup option at the [Backup Mode](agent_job_mode.md) step of the wizard.
...
![Specifying Volumes to Back Up](images/agent_job_volumes.webp "Specify Volumes to Back Up")
