...
1. [Launch the Quick Migration wizard](quick_migration_launch_hv.md).
2. [Select VMs to relocate](quick_migration_vms_hv.md).
3. [Specify a VM destination](quick_migration_destination_hv.md).
