...
* General Options. Allows you to configure general application settings. For more information, see [General Application Settings](vet_general_application_settings.md).
...
* Exit. Closes the Veeam Explorer for Microsoft Teams window.

|  |
| --- |
| Tip |
| To open online help, press [F1] in any Veeam Explorer for Microsoft Teams wizard or window. You will then be redirected to the relevant section of the user guide. |

[![Main Menu](images/vet_know_ui.webp)](images/vet_know_ui.webp "Main Menu")
...
* The navigation pane, which allows you to browse through the hierarchy of folders with backed-up data. Also, it allows you to search for teams using keywords.
