...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_restore_volume_settings.html"
last_updated: "2026"
...
At the Instances step of the wizard, you can add EC2 instances to the restore session and select restore points to be used to perform the restore operation for each added instance. By default, the backup appliance uses the most recent valid restore point. However, you can restore EBS volumes to an earlier state.

|  |
| --- |
| Important |
| If you select a restore point stored in an archive backup repository and the same restore point is also available in a standard backup repository, the backup appliance will display the Confirmation Restore window. To proceed, choose whether you want to use the archived or standard restore point to perform the restore operation. |
...
[![Restoring EBS Volumes](images/aws_restore_volume_point.webp)](images/aws_restore_volume_point.webp "Restoring EBS Volumes")
