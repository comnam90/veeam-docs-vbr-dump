...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/starting_transaction_log_jobs_hv_web.html"
...
* [Disable transaction log shipping](#aaip_hv)
* [Disable the parent backup job](#parent_hv)
...
[![Click to zoom in](images/log_backup_disable_hv_web.webp)](images/log_backup_disable_hv_web.webp "Click to zoom in")
