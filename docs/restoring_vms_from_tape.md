...
To restore VMs from tape, follow the next steps:

1. [Launch the Entire VM Restore wizard](restore_vms_from_tape_launch.md).
2. [Choose virtual machines to restore](restore_vms_from_tape_vms.md).
3. [Select a restore point](restore_vms_from_tape_point.md).
