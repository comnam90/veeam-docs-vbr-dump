...
* To decrypt the tape, specify a password for the initial media pool used as a target in the backup to tape job. Backups from the tape will be moved under the Backup > Tape (Encrypted) node in the inventory pane.
