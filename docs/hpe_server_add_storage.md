...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_server_add_storage.html"
last_updated: "2026"
...
Note that only the Directory Pool, NFS Pool and GFS2 Pool (Global File System 2) datastores are supported. For more information on how to create datastores, see [HPE Morpheus VM Essentials documentation](https://support.hpe.com/hpesc/public/docDisplay?docId=sd00007370en_us&page=GUID-451A0EAA-D2AF-4529-AEF0-9543A638CE03.html).

![Step 4. Configure Storage Settings](images/hpe_server_add_storage.webp)
