...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_copy_rman.html"
...
Before creating a job, [check prerequisites](backup_copy_prerequisites_rman.md). Then use the New Backup Copy Job wizard to configure a backup copy job.

1. [Launch Backup Copy Job wizard](backup_copy_launch_rman.md).
2. [Specify a job name and description](backup_copy_name_rman.md).
3. [Select backups to process](backup_copy_backups_rman.md).
4. [Define backup copy target](backup_copy_target_rman.md).
5. [Specify advanced settings](backup_copy_advanced_rman.md).
6. [Define backup copy schedule](backup_copy_schedule_rman.md).
7. [Finish working with the wizard](backup_copy_summary_rman.md).
