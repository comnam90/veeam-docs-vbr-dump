...
To restore a standalone database or Data Guard database as of the selected point-in-time state, do the following:

1. [Launch the Restore wizard](veor_restore_single_pit_wizard.md).
