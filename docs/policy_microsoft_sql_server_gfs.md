---
title: "Step 5. Configure Long-Term Retention"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/policy_microsoft_sql_server_gfs.html"
last_updated: "2026"
product_version: "13.1.0.411"
---

# Step 5. Configure Long-Term Retention


If you want to ignore the short-term retention policy for some full backups and store them for long-term archiving, you can configure a long-term retention policy (or GFS retention policy) for the application backup policy. For more information on GFS and its limitations, see [Long-Term Retention Policy (GFS)](plugins_managed_retention_gfs.md).
...
![Step 5. Configure Long-Term Retention](images/plugins_policy_mssql_storage_gfs.webp)
