...
* You can not create storage backup copy jobs using Web UI. You can only select HPE StoreOnce or Dell Data Domain backup repository as a target.
* You can not create application-level backup copy job.
* If you plan to copy backups to HPE StoreOnce or Dell Data Domain repository, see [Dell Data Domain](dell_dd.md) and [HPE StoreOnce](deduplicating_appliance_storeonce.md) for limitations and requirements.
