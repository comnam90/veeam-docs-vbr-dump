...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ad_objects_finish_web.html"
last_updated: "2026"
...
2. If you want to copy the configuration information for future reference, click Copy to Clipboard.
3. To start the rescan job after you close the wizard, make sure that the Run discovery when I click Finish option is selected.
...
[![Finish Working with Wizard](images/pg_ad_finish_web.webp)](images/pg_ad_finish_web.webp "Finish Working with Wizard")
