...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/replica_vss_exclusion_hv.html"
...
1. In the Specify Folder window, specify which files and folders you want to include or exclude. For the methods that you can use to specify the list of exclusions or inclusions, see [VM Guest OS Files](guest_file_exclusion_hv.md).

|  |
| --- |
| Note |
| When you select files to be included or excluded, consider requirements and limitations that are listed in section [Requirements and Limitations for VM Guest OS File Exclusion](guest_file_exclusion_hv.md). |

![VM Guest OS File Exclusion](images/hv_replica_job_vss_exclude.webp)
