...
* [Restore of the entire bucket or container](os_data_recovery_restore_entire_bucket.md) allows you to restore a whole object storage bucket or container to one of the restore points.
* [Rollback to a point in time](os_data_recovery_roll_back_to_point.md) allows you to restore only changed objects to one of the restore points.
