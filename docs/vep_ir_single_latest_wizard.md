...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vep_ir_single_latest_wizard.html"
...
2. On the Instance tab, select Instant Recovery > Instant recovery of the latest state to <original\_location>.

Alternatively, you can right-click an instance and select Instant recovery > Instant recovery of the latest state to <original\_location>.
...
[![Launching Instant Recovery Wizard](images/vep_ir_latest_launch.webp)](images/vep_ir_latest_launch.webp "Launching Instant Recovery Wizard")
