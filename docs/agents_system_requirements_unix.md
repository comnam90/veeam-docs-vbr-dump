...
| OS | IBM AIX 6.1, 7.1 – 7.3 TL3 are supported.  Note:   * IBM AIX 6.1 has an experimental support status. For details about experimental support, see [this Veeam KB article](https://www.veeam.com/kb2976).  * Only GA versions of the IBM AIX operating system that have been released before the Veeam Agent for IBM AIX 13.1 are supported. * Backup of a Virtual I/O Server (VIOS) is not supported. |
