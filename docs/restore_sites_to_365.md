...
1. [Launch the Restore wizard](vesp_restore_site_launch_wizard_m365.md).
2. [Select a target site location](restore_sites_target_location_m365.md).
3. [Select an authentication method](vesp_select_authentication_method_sites_m365.md).
4. [Log in to Microsoft 365](vesp_login_sites_m365.md).
5. [Specify a target site web address](specify_target_site_m365.md).
