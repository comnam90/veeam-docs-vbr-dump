...
1. [Launch the Restore wizard](vesql_restore_wizard_multiple.md).
2. [Select databases you want to restore](vesql_restore_select_databases_multiple.md).
3. [Specify a restore point](vesql_restore_point_multiple.md).
