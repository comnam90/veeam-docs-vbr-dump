...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_advanced_notify.html"
...
2. Select the Send daily e-mail report to the following recipients check box and specify a recipient’s email address in the field below. You can enter several addresses separated by a semicolon.
...
![Notification Settings](images/agent_job_settings_notify_policy.webp "Specify Notification Settings for Backup Policy")
