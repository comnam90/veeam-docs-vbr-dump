...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_restore_app_items.html"
last_updated: "2026"
...
| --- |
| Note |
| By default, Veeam Plug-in for Universal Hypervisor API produces only crash-consistent backups that in some cases cannot be used for application item restore. |
...
| --- |
| Tip |
| As an alternative to application item restore, you can also [perform file-level restore](uh_vm_guest_restore.md) to recover standalone databases. |

[![Performing Application Item Restore](images/uh_restore_app_items.webp)](images/uh_restore_app_items.webp "Performing Application Item Restore")
