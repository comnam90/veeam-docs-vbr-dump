...
1. [Applies only if you perform restore of files and folders from a VM with an operating system other than Microsoft Windows] Launches a helper host.
...
3. [Applies only if you perform restore of a VM with an operating system other than Microsoft Windows] Suspends the helper host.
