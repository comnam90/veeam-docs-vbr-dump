...
2. In the working area, select a job and click Edit on the ribbon or right-click the job and select Edit.
3. Edit the job settings as described in section [Creating Backup Jobs Using Web UI](backup_job_hv_web.md).

[![Click to zoom in](images/edit_jobs_hv_web.webp)](images/edit_jobs_hv_web.webp "Click to zoom in")
