...
To perform failover, use the Hyper-V Failover wizard.

1. [Check prerequisites](failover_before_you_begin.md).
2. [Launch the Failover wizard](failover_launch_hv.md).
3. [Select VMs and restore points](failover_vms_hv.md).
