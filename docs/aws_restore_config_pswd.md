...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_restore_config_pswd.html"
last_updated: "2026"
...
If you do not remember the password, you can restore configuration backup data without providing it. To do that, click the I forgot the password link and follow the instructions provided in section [Decrypting Data Without Password](decrypt_without_pass.md).
...
![Step 4. Specify Password](images/aws_restore_config_pswd.webp)
