...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_server_add_credentials_web.html"
last_updated: "2026"
...
After you click Next, the backup server will connect to the Proxmox VE server and check its TLS certificate. If the certificate is not trusted on the backup server, the Untrusted Certificate will display a warning notifying that secure communication cannot be guaranteed. To allow the backup server to connect to the Proxmox VE server using the certificate, click Trust and Continue.

![Step 3. Enter Credentials](images/pve_server_add_credentials_web.webp)
