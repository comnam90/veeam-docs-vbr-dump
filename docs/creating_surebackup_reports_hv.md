---
title: "Creating SureBackup Session Reports"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/creating_surebackup_reports_hv.html"
...
2. In the inventory pane, select Jobs.
3. In the working area, select the session and click Report on the ribbon. You can also right-click the session and select Report.
