...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_backup_job_create_web.html"
last_updated: "2026"
...
To create a backup job, you can either use the [Veeam Plug-in for Nutanix AHV web console](ahv_backup_web.md) or the [Veeam Backup & Replication console](ahv_backup_console.md). To create a backup job using the Veeam Plug-in for Nutanix AHV web console, do the following:
