...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_backup_job_create_destination_web.html"
last_updated: "2026"
...
To help you implement a comprehensive backup strategy, Veeam Backup & Replication allows you to [enable long-term retention policy for backups](pve_backup_job_create_gfs_web.md) and to [configure backup job advanced settings](pve_backup_job_create_advanced_web.md) (for example, enable changed block tracking, plan backup maintenance and customize email notifications).

[![Launch Add Job Wizard](images/pve_backup_job_create_destination_web.webp)](images/pve_backup_job_create_destination_web.webp "Launch Add Job Wizard")
