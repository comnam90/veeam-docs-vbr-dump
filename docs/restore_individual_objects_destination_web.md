---
title: "Step 6. Specify Destination for Object Restore"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_individual_objects_destination_web.html"
last_updated: "2026"
product_version: "13.1.0.411"
---

# Step 6. Specify Destination for Object Restore


The Destination step is required if you choose the Copy To option at the [Select Objects to Restore](restore_individual_objects_browser_web.md) step. Specify the destination where the restored objects must be stored:
...
[![Step 6. Specify Destination for Object Restore](images/restore_individual_objects_destination_web.webp)](images/restore_individual_objects_destination_web.webp)
