...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/repository_permissions_rman.html"
...
* Consider supported types of backup repositories and limitations for Veeam Plug-In backups in [Veeam Backup Repositories](repos_rman.md).
