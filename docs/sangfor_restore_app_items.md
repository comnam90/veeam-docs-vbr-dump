...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_restore_app_items.html"
last_updated: "2026"
...
| --- |
| Note |
| Due to technical limitations, Veeam Plug-in for Sangfor aSV produces only crash-consistent (not application-consistent) backups that in some cases cannot be used for application item restore. |
...
[![Performing Application Item Restore](images/sangfor_restore_app_items.webp)](images/sangfor_restore_app_items.webp "Performing Application Item Restore")
