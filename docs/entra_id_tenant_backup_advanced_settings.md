...
You can also use KMS keys for encryption. For more information, see section [Key Management System Keys](kms.md).
...
By default, Veeam Backup & Replication applies global SNMP settings configured as described in section [Specifying SNMP Settings](snmp_settings.md).
