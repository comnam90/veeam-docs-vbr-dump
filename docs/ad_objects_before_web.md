...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ad_objects_before_web.html"
last_updated: "2026"
...
* Failover clusters are not supported when you use [Veeam Deployment Kit](agents_deploy_deployer.md) to install Veeam Agent on computers in the protection group.
