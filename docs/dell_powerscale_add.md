...
1. [Launch the wizard](dell_vnx_add_launch.md).
2. [Specify storage name or address and storage role](dell_powerscale_add_name.md).
3. [Specify credentials](dell_powerscale_add_creds.md).
4. [Specify NAS access options](dell_powerscale_add_options.md).
