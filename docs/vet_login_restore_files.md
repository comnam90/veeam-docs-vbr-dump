...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vet_login_restore_files.html"
...
This step is only available if you have selected the Modern authentication option at the [previous step](vet_select_auth_restore_files.md) of the wizard.
