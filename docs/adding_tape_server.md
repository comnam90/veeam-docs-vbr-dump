...
1. [Launch the New Tape Server wizard](launch_new_tapeserver_wizard.md).
2. [Choose a server](choose_server.md).
3. [Configure traffic throttling rules](configure_traffic_rules.md).
4. [Review components](review_components.md).
