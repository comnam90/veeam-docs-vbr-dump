...
* Reduce the number of user sessions opened for a long time. Set the idle timeout to automatically log off users. To do this, go to Users & Roles, select the Enable auto log off after <number> min of inactivity check box, and set the number of minutes.
