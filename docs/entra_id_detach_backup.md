...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/entra_id_detach_backup.html"
...
Alternatively, you can detach backups from a backup or backup copy job — this may be helpful, for example, if you plan to reconfigure the job. In this case, backup files will remain in the target backup repository but will be treated by Veeam Backup & Replication as orphaned entities, which will be retained according to their own background retention settings. For more information, see section [Background Retention](background_retention_job.md).
