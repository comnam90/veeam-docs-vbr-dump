...
To deploy Veeam Plug-In, you must install the plug-in on an SAP on Oracle server and configure plug-in integration settings.

In This Section

* [Installing Veeam Plug-In for SAP on Oracle](installing_plugin_sap_orcl.md)
* [Access and Encryption Settings on Repositories](repository_permissions_sap_orcl.md)

* [Granting Permissions to Users](granting_permissions_sap.md)
...
* [Uninstalling Veeam Plug-In for SAP on Oracle](uninstall_plugin_sap_orcl.md)
