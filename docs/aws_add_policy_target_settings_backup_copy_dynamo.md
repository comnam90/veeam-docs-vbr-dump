...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_policy_target_settings_backup_copy_dynamo.html"
last_updated: "2026"
...
1. From the Target region drop-down list, select the target AWS Region to which the backup appliance must copy created backups of the selected tables.
...
[![Creating DynamoDB Backup Policy](images/aws_backup_add_backup_copy_dynamodb.webp)](images/aws_backup_add_backup_copy_dynamodb.webp "Creating DynamoDB Backup Policy")
