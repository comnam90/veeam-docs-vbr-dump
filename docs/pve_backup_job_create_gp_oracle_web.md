...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_backup_job_create_gp_oracle_web.html"
last_updated: "2026"
...
* Select the Until the corresponding image-level backup is deleted option if you want to remove archived redo log backups and the related image-level backups at the same time, according to the retention policy settings specified at [step 4](pve_backup_job_create_destination_web.md).
...
[![Launch Add Job Wizard](images/pve_backup_job_create_gp_oracle_web.webp)](images/pve_backup_job_create_gp_oracle_web.webp "Launch Add Job Wizard")
