...
| Veeam Software | Veeam Backup & Replication version 13.0.2.29 with Veeam Plug-in for oVirt KVM version 13.7.2.9 (or later) must be deployed on the backup server. |
