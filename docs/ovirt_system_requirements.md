...
| Veeam Software | Veeam Backup & Replication version 13.0.1.1071 with Veeam Plug-in for oVirt KVM version 13.7.0.473 (or later) must be deployed on the backup server. |
