...
To speed up entire VM restore and Restore to Microsoft Azure, Amazon EC2 or Google Compute Engine from Dell Data Domain, Veeam Backup & Replication uses the mechanism of sequential data reading from backups and parallel VM disks restore.
