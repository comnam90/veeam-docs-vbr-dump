...
1. [Launch the Restore wizard](vehana_restore_multiple_latest_wizard.md).
2. [Select databases to restore](vehana_restore_multiple_latest_select_databases.md).
3. [Specify server credentials](vehana_restore_multiple_latest_specify_server_credentials.md).
