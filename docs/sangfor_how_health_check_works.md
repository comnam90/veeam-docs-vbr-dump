...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_how_health_check_works.html"
last_updated: "2026"
...
* If the health check detects corrupted metadata in a full or incremental restore point, Veeam Backup & Replication marks the backup chain as corrupted in the configuration database. During the next backup job session, Veeam Backup & Replication copies the full VM image, creates a full restore point in the backup repository and starts a new backup chain in the backup repository.
