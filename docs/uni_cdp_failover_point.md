...
To restore to a short-term restore point, select a point in the green area. The darker the green, the more I/O load was produced on the source workload. To restore to a crash-consistent restore point, select a violet vertical bar with a circle at the top.
