...
[![Removing License Using Console](images/license_open_menu.webp)](images/license_open_menu.webp)

1. In the License Information window, click Remove.

![Removing License Using Console](images/license_remove.webp)

If you have both socket and instance licenses, you will be asked which license you want to remove.

![Removing License Using Console](images/license_remove_select.webp)
