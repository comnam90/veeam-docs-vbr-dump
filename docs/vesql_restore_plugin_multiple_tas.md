...
1. [Launch the Restore wizard](vesql_restore_plugin_multiple_tas_wizard.md).
2. [Select databases you want to restore](vesql_restore_plugin_multiple_tas_select_databases.md).
3. [Specify a restore point](vesql_restore_plugin_multiple_tas_specify_restore_point.md).
