...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/realtime_statistics_hv.html"
...
| --- |
| Tip |
| Consider the following:   * To collapse and expand the real-time statistics window, use Hide Details and Show Details buttons at the bottom left corner of the window.  * To switch between the job sessions backward and forward, use left and right arrow keys on the keyboard. |

![Viewing Real-Time Statistics](images/realtime_stats_collapsed_hv.webp)
...
![Viewing Real-Time Statistics](images/realtime_stats_detailed_hv.webp)
