...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/retention_policy_hv.html"
...
You can change the minimum number of retained restore points in the configuration file on the Linux-based backup server or with a registry value on the Microsoft Windows-based backup server. For more information, contact [Veeam Customer Support](https://www.veeam.com/support.html).
...
* [Forever Forward Incremental Backup Retention Policy](retention_forever_incremental_hv.md)
* [Forward Incremental Backup Retention Policy](retention_incremental_hv.md)
* [Reverse Incremental Backup Retention Policy](retention_reversed_hv.md)

|  |
| --- |
| Note |
| When the specified number of restore points or days is exceeded, Veeam Backup & Replication deletes the whole backup file, not separate VMs from it. For more information, see [Removal of Restore Points](retention_separate_vms_hv.md). |

![Short-Term Retention Policy](images/retention_policy_hv.webp)

Related Topics

* [Retention Policy for Deleted Items](retention_deleted_vms_hv.md)
* [Specifying Backup Storage Settings](backup_job_storage_hv.md)
