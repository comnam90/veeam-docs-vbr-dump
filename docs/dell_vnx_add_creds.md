...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/dell_vnx_add_creds.html"
...
2. When you add a storage system, Veeam Backup & Replication saves to the configuration database a thumbprint of the TLS certificate installed on the management server.
...
![Step 3. Specify Credentials](images/emc_vnx_add_creds_cert.webp)
