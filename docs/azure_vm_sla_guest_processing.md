...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_vm_sla_guest_processing.html"
last_updated: "2026"
...
* [Application-aware processing](azure_vm_sla_application_aware_processing.md)
...
* [Guest scripting](azure_vm_sla_custom_script.md)
...
For example, you can instruct the backup appliance to execute a pre-snapshot script on an Azure VM to quiesce its applications — this will allow the backup appliance to create a transactionally consistent snapshot while no write operations occur on the virtual disks of the VM. After the snapshot is created, a post-snapshot script can start the applications again.
