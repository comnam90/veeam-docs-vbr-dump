...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_backups_copy_tape.html"
last_updated: "2026"
...
| --- |
| Note |
| You cannot restore VMs directly from backups stored on tapes. To restore a VM, you must first restore its backups to a repository as described in section [Backup Restore from Tape to Repository](vm_restore_from_tape_to_repository.md). |

[![Backup to Tape Jobs](images/uh_backups_copy_tape.webp)](images/uh_backups_copy_tape.webp "Backup to Tape Jobs")
