...
1. [Launching the Restore wizard](vemdb_rs_restore_collection_single_wizard.md).
2. [Specify restore settings](vemdb_rs_restore_collection_single_specify_restore_settings.md).
3. [Specify the replica set credentials](vemdb_rs_restore_collection_single_specify_rs_credentials.md).
4. [Specify primary node credentials](vemdb_rs_restore_collection_single_specify_primary_node_credentials.md).
5. [Specify target collection](vemdb_rs_restore_collection_single_specify_target_collection.md).
