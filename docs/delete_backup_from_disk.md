...
To learn more about per-machine backup files, see [Backup Chain Formats](per_vm_backup_files.md).

* When you delete a separate VMs from a backup and if the [per-machine](per_vm_backup_files.md) functionality is enabled for this VM, Veeam Backup & Replication behaves differently:
