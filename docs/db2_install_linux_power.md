...
1. In the Plugins\IBM Db2\Linux\ppc64le folder, find the VeeamPluginforDB2-13.1.0.411-1.ppc64le.rpm package.

1. Upload the VeeamPluginforDB2-13.1.0.411-1.ppc64le.rpm package to the machine with IBM Db2.
...
2. In the \VeeamPluginForIBMDb2-13.1.0.411\DB2Linux\ppc64le folder, find the VeeamPluginforDB2-13.1.0.411-1.x86\_64.rpm package.

1. Upload VeeamPluginforDB2-13.1.0.411-1.ppc64le.rpm package to the machine with IBM Db2.

1. Install Veeam Plug-In with the following command:

|  |
| --- |
| rpm -i VeeamPluginforDB2-13.1.0.411-1.ppc64le.rpm |
...
1. In the Plugins\IBM Db2\Linux\ppc64le folder, find the veeampluginfordb2\_13.1.0.411-1\_ppc64el.deb package.

1. Upload the veeampluginfordb2\_13.1.0.411-1\_ppc64el.deb package to the machine with IBM Db2.

Using veeam.com

1. Download the setup archive for Veeam Plug-In for IBM Db2 from [this Veeam webpage](https://www.veeam.com/products/data-platform-trial-download.html?tab=application-plugins).
2. In the \VeeamPluginForIBMDb2-13.1.0.411\DB2Linux\ppc64le folder, find the veeampluginfordb2\_13.1.0.411-1\_ppc64el.deb package.
3. Upload the veeampluginfordb2\_13.1.0.411-1\_ppc64el.deb package to the machine with IBM Db2.

1. Install Veeam Plug-In with the following command:

|  |
| --- |
| apt-get install veeampluginfordb2\_13.1.0.411-1\_ppc64el.deb |
...
1. Download the setup archive for Veeam Plug-In for IBM Db2 from [this Veeam webpage](https://www.veeam.com/products/data-platform-trial-download.html?tab=application-plugins).
2. In the \VeeamPluginForIBMDb2-13.1.0.411\DB2Linux\ppc64le folder, find the VeeamPluginforDB2.tar.gz archive.
