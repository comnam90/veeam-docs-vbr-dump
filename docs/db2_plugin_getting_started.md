...
1. Deploy Veeam Plug-In on the machine that runs IBM Db2. For more information, see [Installing Veeam Plug-In for IBM Db2](db2_install.md).
2. Configure connection between Veeam Plug-In and the backup repository managed by the Veeam Backup & Replication server. For more information, see [Configuring Plug-In](db2_configure.md).
