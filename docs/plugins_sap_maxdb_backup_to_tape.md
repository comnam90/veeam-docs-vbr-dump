...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/plugins_sap_maxdb_backup_to_tape.html"
last_updated: "2026"
...
Veeam Backup & Replication will copy all closed backup files stored in the repository and skip backup files that are not yet closed. For details on when Veeam Plug-In for SAP MaxDB closes backup files, see [Reuse of Backup Files](plugins_sap_maxdb_overview_backup_files.md#bfiles_reuse).
...
For details, see [Performing Restore](plugins_sap_maxdb_restore.md).
