...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_licensing.html"
...
Veeam Plug-in for Nutanix AHV is licensed by the number of protected Nutanix AHV VMs. Each protected VM consumes one Veeam Universal License instance from the license scope. A VM is considered protected if it has a restore point created during the past 31 days.
