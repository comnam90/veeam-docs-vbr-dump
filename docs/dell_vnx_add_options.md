...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/dell_vnx_add_options.html"
...
[This step is available if you have selected the Block or file storage for VMware vSphere check box at the [Specify Storage Name or Address and Storage Role](dell_vnx_add_name.md) step of the wizard.]
...
![Step 4. Specify VMware Access Options](images/emc_vnx_add_options.webp)
