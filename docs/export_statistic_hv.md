...
* The Reason tab — shows you the reason for export you may have provided at the [Specify Export Reason](specify_export_reason_hv.md) step of the wizard.
* The Parameters tab — shows you the date when the exported backup files will be removed due to the retention policy you may have configured at the [Select Restore Points to Export](specify_restore_points_to_export_hv.md) step of the wizard. In this tab, you can also find a backup name and Date/time of a restore point that was synthesized into a full backup file.
