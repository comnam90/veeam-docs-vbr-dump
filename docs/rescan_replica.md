...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/rescan_replica.html"
...
* After you delete restore points for one or more replicas. For details, see [this Veeam KB article](https://www.veeam.com/kb1987).
...
[![Rescanning Replicas](images/replica_rescan.webp)](images/replica_rescan.webp)
