...
Ensure that the performance extents of the scale-out backup repository contain repositories supported by Veeam Plug-In for SAP on Oracle. You can use object storage repositories as performance extents to store backups created with Veeam Plug-Ins.
