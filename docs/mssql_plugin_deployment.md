...
1. [Install the plug-in on the Microsoft SQL Server machine](install_mssql.md).
2. [Set the access and encryption settings on backup repositories](repository_permissions_mssql.md).
3. [Configure the plug-in settings](configuring_mssql_plugin.md).
