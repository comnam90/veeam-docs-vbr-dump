...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_backup_archiving.html"
last_updated: "2026"
...
| --- |
| Note |
| Restoring from an archived backup is longer and more expensive than restoring from a regular backup as it is required to retrieve data from the archive repository. For more information, see [Retrieving EC2 Data From Archive](aws_data_retrieval.md). |
...
[![Enabling Backup Archiving](images/aws_backup_archiving_repo.webp)](images/aws_backup_archiving_repo.webp "Enabling Backup Archiving")
...
[![Enabling Backup Archiving](images/aws_backup_archiving_weekly.webp)](images/aws_backup_archiving_weekly.webp "Enabling Backup Archiving")
...
[![Enabling Backup Archiving](images/aws_backup_archiving_monthly.webp)](images/aws_backup_archiving_monthly.webp "Enabling Backup Archiving")
...
2. On the second and third Mondays of February, the backup appliance will create restore points at 7:00 AM and add them to the standard backup chain as incremental backup files in the backup repository.

[![Enabling Backup Archiving](images/aws_backup_archiving_rp_weekly_ec2.webp)](images/aws_backup_archiving_rp_weekly_ec2.webp "Enabling Backup Archiving")
...
For more information on how backup appliances transform standard backup chains, see [EC2 Backup Retention](aws_retention_backup.md).

[![Enabling Backup Archiving](images/aws_backup_archiving_weekly_retention_ec2.webp)](images/aws_backup_archiving_weekly_retention_ec2.webp "Enabling Backup Archiving")
...
[![Enabling Backup Archiving](images/aws_backup_archiving_rp_monthly.webp)](images/aws_backup_archiving_rp_monthly.webp "Enabling Backup Archiving")
...
[![Enabling Backup Archiving](images/aws_backup_archiving_monthly_incr.webp)](images/aws_backup_archiving_monthly_incr.webp "Enabling Backup Archiving")
...
For more information on how backup appliances transform archive backup chains, see [Retention Policy for Archived Backups](aws_retention_archive.md).

[![Enabling Backup Archiving](images/aws_backup_archiving_monthly_retention.webp)](images/aws_backup_archiving_monthly_retention.webp "Enabling Backup Archiving")
