---
title: "Creating Policy for Unix Computers"
product: "vbr"
doc_type: "userguide"
...
1. [Launch the New Agent Backup Job wizard](agent_policy_launch_unix.md).
2. [Select the type of protected computers](agent_policy_protection_unix.md).
3. [Specify policy name and description](agent_policy_name_unix.md).
4. [Select computers to back up](agent_policy_comp_unix.md).
5. [Select backup mode](agent_policy_mode_unix.md).
6. [Specify backup scope](agent_policy_scope_unix.md).
7. [Select backup destination](agent_policy_target_unix.md).
8. [Specify backup storage settings](agent_policy_target_set_unix.md).
9. [Specify advanced backup settings](agent_policy_advanced_unix.md).
10. [Specify secondary backup target](agent_policy_secondary_target_unix.md).
11. [Specify guest processing settings](agent_policy_guest_unix.md).
