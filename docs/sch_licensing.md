...
If you already use Veeam Backup & Replication and you have spare Veeam Universal License instances on your backup server, they can be used to protect Scale Computing HyperCore VMs. You can check the number of available license instances in the Veeam Backup & Replication console as described in section [Viewing License Information](license_view.md).
