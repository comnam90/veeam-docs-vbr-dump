...
For information on the move operation, how it works and its limitations, see [Backup Move](backup_moving.md).
...
[![Moving Backups_2](images/backups_move_to_repo.webp)](images/backups_move_to_repo.webp)
...
[![Moving Backups_2](images/backups_move_to_job.webp)](images/backups_move_to_job.webp)
