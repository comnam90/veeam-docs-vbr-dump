...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_backup_to_tape.html"
...
| --- |
| Note |
| You cannot restore Nutanix AHV VMs directly from tapes. To restore a Nutanix AHV VM, you must first restore its backups to a repository as described in section [Backup Restore from Tape to Repository](vm_restore_from_tape_to_repository.md). |

[![Copying Backups to Tapes](images/ahv_backup_to_tape.webp)](images/ahv_backup_to_tape.webp)
