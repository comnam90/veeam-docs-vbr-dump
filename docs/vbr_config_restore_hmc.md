...
* After you run the configuration restore for the [capacity tier](capacity_tier.md), Veeam Backup & Replication will put the capacity tier extents into the [Sealed mode](sobr_seal.md). Rescan the backup infrastructure and then remove the extents from the Sealed mode.
...
Veeam Backup & Replication will use the specified backup file to perform the restore of configuration database.
