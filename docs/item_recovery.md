...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/item_recovery.html"
...
Item recovery includes the following methods for the VMware vSphere platform:

* [VM files restore](vmfile_recovery.md) — to restore VM files (.VMX, .VMXF and so on) without restoring the entire VM.
