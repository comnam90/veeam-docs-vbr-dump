...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_review_mac.html"
...
If you want to apply backup policy immediately, you must synchronize Veeam Agent with Veeam Backup & Replication from the Veeam Agent computer side manually. To learn more, see [Applying Protection Group Configuration to Veeam Agent for Mac](deploy_agent_mac.md#configure).

![Step 13. Review Backup Job Settings](images/agent_policy_summary_mac.webp)
