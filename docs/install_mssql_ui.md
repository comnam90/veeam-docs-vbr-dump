...
![Installing Veeam Plug-In](images/mssql_plugin_install_welcome.webp)

1. At the License Agreement step of the wizard, follow the links to view license agreements and click I Accept.

![Installing Veeam Plug-In](images/mssql_plugin_install_license.webp)
...
![Installing Veeam Plug-In](images/mssql_plugin_install_path.webp)

1. Wait for the installation process to complete and click Finish to exit the wizard.

![Installing Veeam Plug-In](images/mssql_plugin_install_finish.webp)
