...
![Step 4. Configure Backup Repository Settings](images/nfs_repo_repository.webp)
...
1. The This repository is backed by rotated hard drives option is disabled for NFS repositories. For more information, see [Deploying Backup Repositories with Rotated Drives](rotated_drives_configure.md).
