...
+ If you select the Run scripts on the selected days only option, click Configure and specify week days on which the scripts must be executed.
...
![Scripts Settings](images/vm_backup_job_settings_adv.webp)
