---
title: "Step 2. Select Objects to Restore"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_individual_objects_browser_web.html"
last_updated: "2026"
...
* If you restore a whole prefix, you will be prompted to the [Select Restore Mode](restore_individual_objects_restore_mode_web.md) step to select a restore mode and restore point to restore objects from.
...
* If you restore a single object, you will be prompted to the [Select Object Version to Restore](restore_individual_objects_object_version_web.md) step to select a object version to restore the object from.
...
If you restore objects and prefixes to a new location, you will be prompted to the [Specify Destination for Object Restore](restore_individual_objects_destination_web.md) step to specify a new destination.
