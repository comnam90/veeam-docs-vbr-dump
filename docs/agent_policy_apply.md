...
You can apply a backup policy to protected computers in one of the following ways:
...
Applying Backup Policy to Protected Computers Using Veeam Backup & Replication Console
...
Applying Backup Policy to Protected Computers Using Veeam Backup & Replication Web UI

To assign a backup policy to protected computers:

1. In the management pane, click Jobs.
2. Select the check box next to the necessary backup policy and click Apply Configuration on the toolbar. Alternatively, right-click the policy and select Apply Configuration.

[![Apply Backup Policy](images/agent_policy_apply_web.webp)](images/agent_policy_apply_web.webp "Apply Backup Policy")
