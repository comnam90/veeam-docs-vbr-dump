...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_ir_disk_limitations_web.html"
last_updated: "2026"
...
Before you perform Instant Disk Recovery, do the following:

* Check that the target cluster runs Nutanix AOS 6.0 or later.
* Make sure that the target cluster is [added to the backup infrastructure](ahv_add_ahv_cluster.md).
