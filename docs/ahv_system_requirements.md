...
| Veeam Software | * Veeam Backup & Replication version 13.0.2.29 (or later) with Veeam Plug-in for Nutanix AHV version 13.9.2.17  (or later) must be deployed on the backup server. |
