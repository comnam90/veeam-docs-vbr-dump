...
* On the Home tab, click Add Database > Veeam Backup for Microsoft 365 database on the ribbon.
* Right-click the Databases node and select Veeam Backup for Microsoft 365 database.
