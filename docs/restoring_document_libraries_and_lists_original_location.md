...
1. [Launch the restore wizard](vesp_restore_lib_launch_wizard.md).
2. [Select an authentication method](specify_credentials_lib.md).
3. [Log in to Microsoft 365](login_on_to_office_365_lib.md).
4. [Specify a target list](vesp_restore_lib.md).
