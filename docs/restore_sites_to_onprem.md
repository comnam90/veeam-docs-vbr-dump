...
1. [Launch the Restore wizard](vesp_restore_site_launch_wizard_onprem.md).
2. [Select a target site location](restore_sites_target_location_onprem.md).
3. [Specify a target site web address and credentials](specify_target_site_onprem.md).
