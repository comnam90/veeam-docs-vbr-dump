...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/plugins_db2_backup_to_tape.html"
last_updated: "2026"
...
Veeam Backup & Replication will copy all closed backup files stored in the repository and skip backup files that are not yet closed. For details on when Veeam Plug-In for IBM Db2 closes backup files, see [Reuse of Backup Files](db2_backup_files.md#reuse).
...
For details, see [Performing Restore](db2_restore.md).
