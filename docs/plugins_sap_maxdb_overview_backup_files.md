...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/plugins_sap_maxdb_overview_backup_files.html"
...
* A .VAB file stores a compressed copy of an SAP MaxDB database. Veeam Plug-In creates .VAB files for full, incremental and log backups.
