...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/failover_undo_hv.html"
...
For more information on failover undo, see [Failover Undo](undo_failover_hv.md) and [Failover and Failback for Replication](failover_failback_hv.md).
...
[![Undoing Failover](images/hv_undo_failover_force.webp)](images/hv_undo_failover_force.webp)
