...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vep_restore_databases_multiple_tas_specify_target_server.html"
last_updated: "2026"
...
At this step of the wizard, specify connection settings required to access the target PostgreSQL server.
...
![Step 3. Specify Target Server](images/vep_restore_multiple_tas_specify_server.webp "Specifying Linux Server Connection Credentials")
