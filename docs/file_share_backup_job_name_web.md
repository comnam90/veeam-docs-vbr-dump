...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/file_share_backup_job_name_web.html"
last_updated: "2026"
...
3. Select the High priority check box if you want the resource scheduler of Veeam Backup & Replication to prioritize this job higher than other similar jobs and to allocate resources to it in the first place. For more information on job priorities, see the [Job Priorities](job_priorities.md) section.
...
[![Step 2. Specify Job Name and Description](images/file_share_backup_job_name_web.webp)](images/file_share_backup_job_name_web.webp)
