...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_job_comp_linux_web.html"
last_updated: "2026"
...
| --- |
| NOTE |
| In the Veeam Backup & Replication web UI, you can add only protection groups and computers that are members of existing protection groups. To add a computer that is not a member of any protection group, use the Veeam Backup & Replication console. To learn more, see [Select Computers to Back Up](agent_job_comp_linux.md). |
...
| --- |
| TIP |
| If you used the Add to backup job > Linux > New job option to launch the New Agent Backup Job wizard, the list will already contain computers that you have selected to add to the job. You can remove some computers from the job or add new computers to the job, if necessary. |
...
[![Select Protection Groups to Back Up](images/agent_job_computers_linux_web.webp)](images/agent_job_computers_linux_web.webp "Select Protection Groups to Back Up")
