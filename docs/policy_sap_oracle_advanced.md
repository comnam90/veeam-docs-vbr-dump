...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/policy_sap_oracle_advanced.html"
...
* [Backup settings](policy_sap_oracle_advanced_backup.md)
* [Storage settings](policy_sap_oracle_advanced_storage.md)
* [Notification settings](policy_sap_oracle_advanced_notifications.md)
* [Oracle settings](policy_sap_oracle_advanced_oracle.md)
