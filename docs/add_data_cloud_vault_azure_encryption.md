...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/add_data_cloud_vault_azure_encryption.html"
last_updated: "2026"
...
| --- |
| Important |
| After you create a storage vault with encryption enabled, you can no longer disable encryption for this vault. However, you will be able to change the encryption settings as described in section [Editing Repository Settings](azure_repository_edit.md). |

![Step 5. Enable Data Encryption](images/external_vault_azure_encryption.webp)
