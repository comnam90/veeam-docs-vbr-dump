...
You can [change storage optimization settings](backup_job_advanced_storage_vm.md) for existing jobs. New settings will not have any effect on previously created files in the chain. They will be applied to new files created after the settings were changed.
