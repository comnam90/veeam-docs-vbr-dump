...
* Open the [Viewing History Statistics](history_statistics.md) view. In the inventory pane, select Jobs. In the working area, double-click the necessary job session.
* Open the [Viewing History Statistics](history_statistics.md) view. In the inventory pane, select Jobs. In the working area, right-click the necessary job session and select Statistics.
