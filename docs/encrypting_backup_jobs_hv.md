...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/encrypting_backup_jobs_hv.html"
...
1. Job encryption is configured in the [advanced job settings](backup_job_advanced_storage_hv.md). When you enable the encryption option, you need to enter a password or select a KMS server.
