...
By default, Veeam Backup & Replication selects the latest restore point. If you want to select another restore point, select the Restore from this restore point option and select any valid restore point to recover data.
