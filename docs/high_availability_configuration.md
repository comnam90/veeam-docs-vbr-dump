---
title: "Assembling High Availability Cluster"
product: "vbr"
doc_type: "userguide"
...
To be able to use continuous replication between 2 Veeam Software Appliances, you must submit a request to enable High Availability for both servers, and then assemble these servers into a cluster using the New High Availability Cluster wizard.

Before you assemble a cluster, [check the prerequisites](high_availability_limitations.md). Then, use the New High Availability Cluster wizard to assemble the cluster.
