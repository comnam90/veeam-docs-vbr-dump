...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_win_vss_web.html"
last_updated: "2026"
...
* [Application-aware processing](agent_policy_win_vss_general_web.md)
* [Transaction log handling for Microsoft SQL Server](agent_policy_win_vss_sql_web.md)
* [Archived log handling for Oracle databases](agent_policy_win_vss_oracle_web.md)
* [SharePoint account settings](agent_policy_win_vss_sharepoint_web.md)
* [Use of pre-freeze and post-thaw scripts](agent_policy_win_vss_scripts_web.md)
* [File indexing](agent_policy_win_vss_indexing_web.md)

[![Specify Guest Processing Settings](images/agent_policy_vss_web.webp)](images/agent_policy_vss_web.webp "Specify Guest Processing Settings")
