...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_workers_update.html"
...
1. At the Networks step of the Edit HPE Morpheus VM Essentials Worker wizard, click Advanced and clear the Check for updates online check box. Then, click Finish to save changes made to the worker settings.
...
[![Updating Workers](images/hpe_workers_update.webp)](images/hpe_workers_update.webp "Updating Workers")

Related Topics

[Ports](hpe_used_ports.md)
