...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/os_backup_job_secondary_repository.html"
...
| --- |
| Note |
| This step is available, if you select the Configure secondary destinations for this job check box at the [Backup Repository](os_backup_job_target_repository.md) step of the wizard. |
...
![Step 7. Specify Secondary Repository Settings](images/os_backup_job_secondary_repository.webp "Specify Secondary Target Repository")
...
![Step 7. Specify Secondary Repository Settings](images/os_backup_job_secondary_repository_retention.webp)
