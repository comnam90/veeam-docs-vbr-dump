...
You can temporarily disable a protection group. When you disable a protection group, you disable scheduled discovery of ODB servers added to this protection group. This may be required, for example, if you want to make configuration changes to the ODB servers without triggering automatic topology collection.
...
* Click Disable on the ribbon.
* Right-click the protection group and select Disable.
...
* Click Disable again on the ribbon.
* Right-click the protection group and select Disable to clear the check mark.
