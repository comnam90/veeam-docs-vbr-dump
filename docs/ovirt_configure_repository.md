...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ovirt_configure_repository.html"
last_updated: "2026"
...
| --- |
| Important |
| Veeam Plug-in for oVirt KVM does not support storing backups in [Veeam Cloud Connect](https://helpcenter.veeam.com/docs/vbr/cloud/cloud_overview.html?ver=13) repositories. However, you can use them for [storing copies of backups](ovirt_backup_copy_job.md) created with Veeam Plug-in for oVirt KVM. |
