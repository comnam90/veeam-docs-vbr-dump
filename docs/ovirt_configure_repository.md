...
| --- |
| Important |
| Veeam Plug-in for oVirt KVM does not support storing backups in [Veeam Cloud Connect](https://helpcenter.veeam.com/docs/backup/cloud/cloud_overview.html?ver=120) and [HPE Cloud Bank Storage](storeonce_supported_features.md) repositories. However, you can use them for [storing copies of backups](ovirt_backup_copy_job.md) created with Veeam Plug-in for oVirt KVM. |
