...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_licensing.html"
last_updated: "2026"
...
Veeam Plug-in for Sangfor aSV is licensed by the number of protected Sangfor aSV VMs. Each protected VM consumes one Veeam Universal License instance from the license scope. A VM is considered protected if it has a restore point created during the past 31 days.
...
| --- |
| Note |
| If a machine is protected by Veeam Plug-in for Sangfor aSV and Veeam backup agent simultaniously, the license instance consumption is doubled. |
