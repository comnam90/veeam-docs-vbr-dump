...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_restore_volume_workers_prod.html"
last_updated: "2026"
...
By default, the backup appliance deploys worker instances used to perform restore operations in the [backup account](aws_worker_options.md). However, you can instruct the backup appliance to deploy worker instances in a production account — that is, an account to which the volumes will be restored. To do that, set the Deploy workers in production account toggle to On.
...
[![Restoring EBS Volumes](images/aws_restore_volume_account_keys.webp)](images/aws_restore_volume_account_keys.webp "Restoring EBS Volumes")
