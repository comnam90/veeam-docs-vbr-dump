...
1. [Launch the New Nutanix Files Storage wizard](nutanix_add_launch.md).
2. [Specify a storage name and storage role](nutanix_add_name.md).
3. [Specify credentials](nutanix_add_creds.md).
4. [Specify NAS access options](nutanix_add_nas.md).
