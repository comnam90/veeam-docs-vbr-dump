...
For more information on failover undo, see [Failover and Failback for Universal CDP](uni_cdp_failover_failback.md) and [Failover Undo](uni_cdp_failover_undo.md).
