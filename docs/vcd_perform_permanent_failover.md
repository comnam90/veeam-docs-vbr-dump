...
For more information on permanent failover, see [Failover and Failback for Cloud Director](vcd_failover_failback.md) and [Permanent Failover](vcd_permanent_failover.md).
