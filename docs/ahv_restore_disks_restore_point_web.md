...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_restore_disks_restore_point_web.html"
last_updated: "2026"
...
At the Virtual Machines step of the wizard, select a restore point that will be used to restore data. By default, Veeam Plug-In for Nutanix AHV uses the most recent valid restore point. However, you can restore the data to an earlier state.
...
| --- |
| Tip |
| By default, Veeam Plug-In for Nutanix AHV restores all disks attached to the selected VMs. If you want to exclude specific disks of a VM from restore, do the following. Select a VM, click Exclude Disks and select the disks to exclude. |

[![Step 4. Specify VM Name](images/ahv_restore_disk_select_vm_web.webp)](images/ahv_restore_disk_select_vm_web.webp "Step 4. Specify VM Name")
