...
* [Applies only to Platform9] Veeam Plug-in for Universal Hypervisor API does not support the changed block tracking (CBT) mechanism. In this case, it may take Veeam Backup & Replication more time to create incremental backups.
