---
title: "Creating Subtenant Account for VMware Cloud Director Tenant"
product: "vbr"
doc_type: "cloud"
source_url: "https://helpcenter.veeam.com/docs/vbr/cloud/subtenant_vcd_create.html"
...
Before creating subtenant accounts for a VMware Cloud Director tenant account, [check prerequisites](subtenant_vcd_create_before.md). Then use the New Subtenant wizard to add a new subtenant account.

1. [Launch the New Subtenant wizard](subtenant_vcd_create_launch.md).
2. [Select the Cloud Director user](subtenant_vcd_create_settings.md).
3. [Allocate subtenant quota](subtenant_vcd_create_quota.md).
4. [Finish working with the wizard](subtenant_vcd_create_finish.md).
