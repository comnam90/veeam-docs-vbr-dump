...
* Veeam Cloud Connect supports restore to Amazon EC2 from encrypted tenant backups only if the tenant has granted the SP restore access to all backups. Otherwise, restore to Amazon EC2 is supported from unencrypted backups only. For details, see [Access to Tenant Backups](cc_sp_restore_access.md).
...
![Restoring to Amazon EC2](images/cloud_restore_amazon_machine.webp)
...
![Restoring to Amazon EC2](images/cloud_restore_amazon_account.webp)

1. At the Name step of the wizard, specify names and manage AWS tags for the restored workloads.

![Restoring to Amazon EC2](images/cloud_restore_amazon_name.webp)
...
![Restoring to Amazon EC2](images/cloud_restore_amazon_type_instance.webp)
...
![Restoring to Amazon EC2](images/cloud_restore_amazon_network_custom.webp)
...
![Restoring to Amazon EC2](images/cloud_restore_amazon_secure.webp)
...
![Restoring to Amazon EC2](images/cloud_restore_amazon_helper.webp)
