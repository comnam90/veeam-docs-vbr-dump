...
* To track performance of tenant jobs, the SP can view detailed statistics in the job session window. To learn more, see [Viewing Tenant Job Statistics](cc_report_jobs.md).
