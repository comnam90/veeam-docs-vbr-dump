---
title: "Support for Veeam Backup for Public Clouds"
product: "vbr"
doc_type: "cloud"
...
# Support for Veeam Backup for Public Clouds
...
* [Veeam Backup for AWS](https://helpcenter.veeam.com/docs/vbr/userguide/aws_welcome.html?ver=13)
* [Veeam Backup for Microsoft Azure](https://helpcenter.veeam.com/docs/vbr/userguide/azure_overview.html?ver=13)
...
1. [Performing Restore](https://helpcenter.veeam.com/docs/vbr/userguide/azure_performing_restore.html?ver=13) in the Veeam Backup for Microsoft Azure User Guide
2. [Performing Restore](https://helpcenter.veeam.com/docs/vbr/userguide/aws_recovery.html?ver=13) in the Veeam Backup for AWS User Guide
...
* For details on how to connect to the backup server, see the [Connecting Veeam Backup & Replication Servers](https://helpcenter.veeam.com/docs/vac/provider_admin/connect_backup_servers.html?ver=9.3) section in the Guide for Service Providers.
* For details on how to connect to the public cloud appliance, see the [Managing Veeam Backup for Public Clouds Appliances](https://helpcenter.veeam.com/docs/vac/provider_admin/clouds_appliances.html?ver=9.3) section in the Guide for Service Providers.
...
* [For Microsoft Azure] The [Editing Appliance Settings](https://helpcenter.veeam.com/docs/vbr/userguide/azure_editing_appliance_console.html?ver=13) section in the Veeam Backup for Microsoft Azure User Guide
* [For AWS] The [Editing Appliance Settings](https://helpcenter.veeam.com/docs/vbr/userguide/aws_edit_appliance.html?ver=13) section in the Veeam Backup for AWS User Guide

1. Specify credentials for repositories available on the appliance.

For detailed instructions, see the following sections:

* [For Microsoft Azure] The [Configure Repository Settings](https://helpcenter.veeam.com/docs/vbr/userguide/azure_adding_appliance_repository.html?ver=13) section in the Veeam Backup for Microsoft Azure User Guide
* [For AWS] The [Configure Repository Settings](https://helpcenter.veeam.com/docs/vbr/userguide/aws_connect_appliance_repo.html?ver=13) section in the Veeam Backup for AWS User Guide
