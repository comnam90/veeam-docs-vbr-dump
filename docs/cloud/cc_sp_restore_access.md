...
It is recommended, however, that the SP and tenant both always install latest hotfixes and updates on the backup server.For the SP to see tenant backups in the SP Veeam backup console, the tenant must also
