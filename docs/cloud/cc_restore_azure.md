...
* Veeam Cloud Connect supports restore to Microsoft Azure from encrypted tenant backups only if the tenant has granted the SP restore access to all backups. Otherwise, restore to Microsoft Azure is supported from unencrypted backups only. For details, see [Access to Tenant Backups](cc_sp_restore_access.md).
...
* Backups of Amazon EC2 instances created by [Veeam Backup for AWS](https://helpcenter.veeam.com/docs/vbr/userguide/aws_welcome.html?ver=13).
* Backups of Microsoft Azure virtual machines created by [Veeam Backup for Microsoft Azure](https://helpcenter.veeam.com/docs/vbr/userguide/azure_overview.html?ver=13).
...
* Backups of Nutanix AHV VMs created by [Veeam Backup for Nutanix AHV](https://helpcenter.veeam.com/docs/vbr/userguide/ahv_overview.html?ver=13).
* Backups of oVirt VMs created by [Veeam Backup for OLVM and RHV](https://helpcenter.veeam.com/docs/vbr/userguide/ovirt_overview.html?ver=13).
* Backups of Proxmox VE VMs created by [Veeam Backup for Proxmox VE](https://helpcenter.veeam.com/docs/vbr/userguide/pve_overview.html?ver=13).
...
![Restoring to Microsoft Azure](images/cloud_restore_amazon.webp)
...
![Restoring to Microsoft Azure](images/cloud_restore_azure_machine.webp)
...
![Restoring to Microsoft Azure](images/cloud_restore_azure_subscription.webp)

1. At the Name step of the wizard, specify names and manage tags for the restored workloads.

![Restoring to Microsoft Azure](images/cloud_restore_azure_name.webp)
...
![Restoring to Microsoft Azure](images/cloud_restore_azure_vmsize.webp)
...
![Restoring to Microsoft Azure](images/cloud_restore_azure_resource.webp)
...
![Restoring to Microsoft Azure](images/cloud_restore_azure_network.webp)
...
![Restoring to Microsoft Azure](images/cloud_restore_azure_secure.webp)
