---
title: "cloud_connect_subtenants_edit"
source_url: "https://helpcenter.veeam.com/docs/vbr/cloud/cloud_connect_subtenants_edit.html"
...
| --- |
| Note |
| Consider the following:   * You cannot change a user name for the subtenant account. * If you open the Subtenant Quotas window from the Backup Repositories node, you cannot select a cloud repository on which to allocate storage quota for the edited subtenant account. |
...
![Editing Subtenant Account](images/subtenant_edit.webp)
