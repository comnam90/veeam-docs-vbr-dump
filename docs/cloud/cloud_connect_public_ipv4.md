...
product: "vbr"
doc_type: "cloud"
source_url: "https://helpcenter.veeam.com/docs/vbr/cloud/cloud_connect_public_ipv4.html"
...
1. In the Public IP Addresses Assignment window, click Add and select IPv4 addresses.
2. In the Add IPv4 addresses window, do either of the following:
...
![Managing IPv4 Addresses](images/configure_public_ip.webp)
...
![Managing IPv4 Addresses](images/configure_public_ip_range.webp)
