---
title: "cloud_connect_user_resources"
source_url: "https://helpcenter.veeam.com/docs/vbr/cloud/cloud_connect_user_resources.html"
...
The Backup Resources step of the wizard is available if you selected the Backup storage option at the [Tenant](cloud_connect_user_settings.md) step of the wizard. You can use this step to specify cloud repository quota settings for the created tenant account. You can assign to the tenant a single quota on one cloud repository or several quotas on different cloud repositories.
...
![Step 4. Allocate Backup Resources](images/add_user_resources_new.webp)
