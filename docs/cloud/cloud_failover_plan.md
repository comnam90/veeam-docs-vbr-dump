---
title: "Creating Cloud Failover Plans"
product: "vbr"
doc_type: "cloud"
source_url: "https://helpcenter.veeam.com/docs/vbr/cloud/cloud_failover_plan.html"
...
4. [Specify default gateways](cloud_failover_plan_gateways.md).
5. [Specify public IP addressing rules](cloud_failover_plan_public_ip.md).
6. [Finish working with the wizard](cloud_failover_plan_summary.md).
