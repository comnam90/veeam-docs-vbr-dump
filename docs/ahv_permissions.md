...
Nutanix AHV Administrator Account

The Nutanix AHV administrator account that Veeam Plug-in for Nutanix AHV uses to access the Prism Central or cluster must have privileges of the Prism Admin or Cluster Admin role. For more information on user access control, see [Nutanix documentation](https://portal.nutanix.com/page/documents/details?targetId=Nutanix-Security-Guide-v7_3:ssp-ssp-role-based-access-control-pc-c.html).
