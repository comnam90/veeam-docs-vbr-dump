...
1. Boot from the Veeam Infrastructure Appliance ISO file.
2. In the installation menu, select the deployment type that matches your Veeam Infrastructure Appliance. Then, select Reinstall.
