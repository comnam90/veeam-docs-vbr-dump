...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/iris_restore_different_location_mode.html"
last_updated: "2026"
...
* Private SSH key. Select private SSH key if you want to use your generated authentication key pair. With this option selected, Veeam Backup & Replication will use the specified public and private authentication keys only for the first connection to the computer. After that, Veeam Backup & Replication will use Veeam Transport Service to communicate with the computer. For details, see [SSH Private Keys](credentials_manager_linux_pubkey.md).
