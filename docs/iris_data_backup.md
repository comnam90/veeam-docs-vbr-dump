...
To store backups, you can add and configure backup repositories in your Veeam Backup & Replication infrastructure. All primary backup repositories available in Veeam Backup & Replication are supported as backup targets for InterSystems IRIS application backup policies. Backup mode also requires at least one Linux-based backup proxy in your Veeam Backup & Replication infrastructure. For details, see [Veeam Backup Repositories](iris_backup_repos.md).
