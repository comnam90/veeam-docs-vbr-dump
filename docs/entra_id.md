...
* Export properties and metadata of users, groups, roles, administrative units, applications, conditional access policies, intune policies, contacts and devices from Microsoft Entra ID tenant backups — and save the exported data in the JSON format.
