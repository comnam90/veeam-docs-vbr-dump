...
1. [Launch the New Application Group wizard](appgroup_launch_hv.md).
2. [Specify an application group name and description](appgroup_name_hv.md).
3. [Add machines to application group](appgroup_vms_hv.md).
