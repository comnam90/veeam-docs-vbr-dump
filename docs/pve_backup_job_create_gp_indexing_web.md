...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_backup_job_create_gp_indexing_web.html"
last_updated: "2026"
...
1. In the Granular credentials and advanced settings section, click Configure.
2. In the Advanced Settings window, select the necessary VM and click Other Actions > Guest Indexing. You can configure indexing settings for one or more VMs at a time.
...
If you select the Index everything except or Index following folder only option, you will be able to modify the list of folders included into the indexing scope — either manually or by using system environment variables (for example, %windir%, %ProgramFiles% and %Temp%).
...
[![Launch Add Job Wizard](images/pve_backup_job_create_gp_indexing_web.webp)](images/pve_backup_job_create_gp_indexing_web.webp "Launch Add Job Wizard")
