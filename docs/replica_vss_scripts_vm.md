...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/replica_vss_scripts_vm.html"
...
| --- |
| Tip |
| Beside pre-freeze and post-thaw scripts for VM quiescence, you can instruct Veeam Backup & Replication to run custom scripts before the job starts and after the job completes. For more information, see [Script Settings](replica_advanced_script_vm.md). |

![Pre-Freeze and Post-Thaw Script Settings](images/vm_replica_job_vss_scripts.webp)
