...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_ad_forest_network_hv.html"
last_updated: "2026"
...
1. In the table, expand a domain controller and select one or more network adapters. To select multiple network adapters at once, press and hold [Ctrl] or [Shift].
2. Click Network.
...
1. In the table, expand a domain controller and select the network adapter.
2. Click Disconnect.
...
![Step 7. Configure Network Mapping](images/restore_ad_forest_network_hv.webp "Configuring Network Mapping")
