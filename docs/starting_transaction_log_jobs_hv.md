...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/starting_transaction_log_jobs_hv.html"
...
1. Open the Home view.
2. In the inventory pane, select Jobs.
3. In the working area, select a backup job and click Edit on the ribbon. Alternatively, you can right-click a backup job and select Edit.
...
1. Open the Home view.
2. In the inventory pane, select Jobs.
3. In the working area, select a backup job and click Disable on the ribbon or right-click a job and select Disable.
