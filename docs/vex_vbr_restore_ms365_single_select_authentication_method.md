...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vex_vbr_restore_ms365_single_select_authentication_method.html"
...
Make sure that the organization name matches the name specified at the [previous step](vex_vbr_restore_ms365_single_target_mailbox.md) of the wizard.
