...
| --- | --- |
| OS | Veeam Plug-In for SAP MaxDB is supported for the following x86\_64 versions of Linux distributions:   * RHEL 8.4 – 9.x  * SLES 15 SP3   Veeam Plug-In for SAP MaxDB is supported for the following Unix versions: IBM AIX 7.2, 7.3 |
