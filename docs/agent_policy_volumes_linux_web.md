...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_volumes_linux_web.html"
last_updated: "2026"
...
The Objects step of the wizard is available if you have chosen to create volume-level backup at the [Backup Mode](agent_policy_mode_linux_web.md) step of the wizard.
...
1. On the toolbar, from the Add drop-down list, select the type of object that you want to include in the backup: Device, Mount point, LVM or BTRFS.
...
To edit an object in the list, select it and click Edit. To remove an object from the backup scope, select it and click Remove.

[![Specify Volumes to Back Up](images/agent_policy_volumes_linux_web.webp)](images/agent_policy_volumes_linux_web.webp "Specify Volumes to Back Up")
