...
1. [Launch the Export wizard](vesql_export_wizard_bak_multiple.md).
2. [Select databases you want to export](vesql_bak_multiple_tdl_select_databases.md).
3. [Specify a restore point](vesql_exporting_multiple_bak_1.md).
