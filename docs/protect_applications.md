...
| Database or Application | [Image-Level Backup with Application-Aware Processing](protect_applications_image.md) | [Database-Level Backup with Veeam Plug-Ins or MongoDB Backup](protect_applications_db.md) |
