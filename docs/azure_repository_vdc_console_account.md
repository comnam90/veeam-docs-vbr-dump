...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_repository_vdc_console_account.html"
last_updated: "2026"
...
For a storage vault to be displayed in the list of available vaults, it must be created in Veeam Data Cloud Vault as described in the Veeam Data Cloud User Guide, section [Adding Storage Vaults for Azure Edition](https://helpcenter.veeam.com/docs/vdc/userguide/vault_storage_vaults_add_azure.html). If you have not created the storage vault beforehand, you can do it without closing the Add External Repository wizard. To do that, click Manage, specify credentials of a Veeam account that will be used to create the storage vault, and complete the Add Vault wizard.
...
For a server to be displayed in the Gateway server list, it must be added to the backup infrastructure. For more information on gateway servers, see [Solution Architecture](azure_architecture_overview.md).

![Step 3. Choose Storage Vault](images/azure_repository_vdc_console_account.webp "Adding Storage Vaults Using Console")
