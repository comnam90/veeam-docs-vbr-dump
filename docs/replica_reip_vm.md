...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/replica_reip_vm.html"
...
The Re-IP step of the wizard is available if you have selected the Replica re-IP option at the [Name](replica_name_vm.md) step of the wizard. This step applies only to VMs with Microsoft Windows OSes.
...
![Step 9. Configure Re-IP Rules](images/vm_replica_job_reip.webp)
