---
title: "Backup for Microsoft Hyper-V"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_hv.html"
...
* [About Backup](about_backup_hv.md)
* [Creating Backup Jobs](backup_job_hv.md)
* [Encrypting Backup Jobs](encrypting_backup_jobs_hv.md)
* [Performing Active Full Backup](performing_active_full_backup_hv.md)
* [Quick Backup](quick_backup_hv.md)
* [Importing Backups Manually](importing_backups_hv.md)
* [Managing Backups](managing_backups_hv.md)
* [Managing Backup Jobs](managing_jobs_hv.md)
* [Reporting](reporting_hv.md)
