...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/plugins_sap_orcl_backup_to_tape.html"
last_updated: "2026"
...
Veeam Backup & Replication will copy all closed backup files stored in the repository and skip backup files that are not yet closed. For details on when Veeam Plug-In for SAP on Oracle closes backup files, see [Reuse of Backup Files](saporcl_bfiles.md#bfiles_reuse).
...
For details, see [Database Recovery](restoring_databases_sap_orcl.md).
