...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/netapp_agents_access.html"
...
[This step is available for Microsoft Windows-based backup server, and if you have selected the Block storage for Microsoft Windows servers check box at the [Specify NetApp Server Name or Address and Storage Role](netapp_add_name.md) step of the wizard.]
...
![Step 6. Specify Agents Access Options](images/netapp_add_agents.webp)
