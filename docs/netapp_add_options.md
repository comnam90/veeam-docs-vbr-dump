...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/netapp_add_options.html"
...
[This step is available for Microsoft Windows-based backup server, and if you have selected the Block or file storage for VMware vSphere check box at the [Specify NetApp Server Name or Address and Storage Role](netapp_add_name.md) step of the wizard.]
...
![Step 4. Specify VMware Access Options](images/netapp_add_options.webp)
