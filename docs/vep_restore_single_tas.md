...
2. [Specify a restore point](vep_restore_single_tas_specify_restore_point.md).
3. [Specify a target server](vep_restore_single_tas_specify_target_server.md).
4. [Specify PostgreSQL settings](vep_restore_single_tas_specify_postgresql_settings.md).
