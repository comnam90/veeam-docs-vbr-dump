...
For more information, see [Guest Processing Settings](agent_job_guest.md).
...
If you select this option, you will need to specify database processing settings. For more information, see [Oracle Processing Settings](agent_job_guest_oracle.md), [MySQL Processing Settings](agent_job_guest_mysql.md) and [PostgreSQL Processing Settings](agent_job_guest_postgresql.md).
