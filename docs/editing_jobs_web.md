...
3. Edit the job settings as described in section [Creating Backup Jobs Using Web UI](backup_job_web.md).

[![Click to zoom in](images/edit_jobs_web.webp)](images/edit_jobs_web.webp "Click to zoom in")
