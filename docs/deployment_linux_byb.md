...
* You cannot use Veeam Software Appliance or Veeam Agent for Linux to back up or restore a Veeam Software Appliance. To ensure continuous availability of the Veeam Software Appliance and minimize its downtime, use the [High Availability Cluster](https://helpcenter.veeam.com/docs/vbr/userguide/high_availability_cluster.html) feature.
