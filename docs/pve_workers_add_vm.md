...
1. In the Name field, specify a name for the worker. The maximum length of the name is 40 characters; only the following characters are supported: a-z, A-Z, 0-9, -.
