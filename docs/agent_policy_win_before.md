...
* The Veeam Backup & Replication license must have a sufficient number of instances to process workstations that you plan to add to the Veeam Agent backup policy. To learn more, see [Licensing Requirements](agents_licensing_requirements.md).
