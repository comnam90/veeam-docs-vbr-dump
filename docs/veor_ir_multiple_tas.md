...
1. [Launch the Instant Recovery wizard](veor_ir_multiple_tas_wizard.md).
2. [Specify a restore point](veor_ir_multiple_tas_specify_restore_point.md).
3. [Specify the target server](veor_ir_multiple_tas_specify_target_server.md).
4. [Specify Oracle settings](veor_ir_multiple_tas_specify_oracle_settings.md).
