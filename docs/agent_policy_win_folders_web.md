...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_win_folders_web.html"
last_updated: "2026"
...
The Objects step of the wizard is available if you have selected the File-level backup option at the [Backup Mode](agent_policy_win_mode_web.md) step of the wizard.
...
To specify the backup scope, in the Objects to back up list, select check boxes next to necessary objects. You can include the following data in the backup:
...
* Personal files — data related to user profiles. With this option enabled, Veeam Backup & Replication will include in the backup scope settings and data related to Veeam Agent computer user profiles. To customize which categories to include, expand the drop-down list below the check box and select or clear the necessary categories: Desktop, Documents, Pictures, Video, Music, Favorites, Downloads, or Other files. To learn more, see the [Personal Data Backup](https://helpcenter.veeam.com/docs/agentforwindows/userguide/personal_files_backup.html?ver=13) section in the Veeam Agent for Microsoft Windows User Guide.
...
2. In the window that opens, type the path to a folder, mount point folder, or volume that you want to back up, for example, D:\Reports or D:\, and click OK.
...
[![Specify Folders to Back Up](images/agent_policy_files_web.webp)](images/agent_policy_files_web.webp "Specify Folders to Back Up")
...
* Due to the OS limitations, the Exclude Microsoft OneDrive folders option behaves properly only on Veeam Agent computers running Microsoft Windows 10 and Microsoft Windows 11. If your Veeam Agent computers run other OS versions, we recommend to exclude Microsoft OneDrive folders manually.

[![Configure Filters](images/agent_policy_files_exclude_web.webp)](images/agent_policy_files_exclude_web.webp "Configure Filters")
