...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_linux_guest_indexing_web.html"
last_updated: "2026"
...
| --- |
| NOTE |
| File system indexing is optional. If you do not enable this option in the backup policy settings, you will still be able to perform 1-click restore from the backup created with such backup policy. For more information, see the [Preparing for File Browsing and Restore](https://helpcenter.veeam.com/docs/vbr/em/em_preparing_for_flr_physical.html?ver=13) section in the Veeam Backup Enterprise Manager User Guide. |
...
* Select Index everything if you want to index all files within the backup scope that you have specified at the [Backup Mode](agent_policy_mode_linux_web.md) step of the wizard. Veeam Agent for Linux will index all files that reside:
...
| --- |
| NOTE |
| You can specify a custom indexing scope only for a volume-level backup policy. For a file-level backup policy that processes Linux-based computers, only the Index everything option is available. |

[![Specify Indexing Settings](images/agent_policy_guest_indexing_linux_web.webp)](images/agent_policy_guest_indexing_linux_web.webp "Specify Indexing Settings")
