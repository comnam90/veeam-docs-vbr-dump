...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_backup_retention.html"
last_updated: "2026"
...
Veeam Backup & Replication retains the number of latest restore points defined in job scheduling settings as described in section [Creating Backup Jobs](uh_backup_job_create_destination.md). For backup chains created by jobs without scheduled active or synthetic full backups, Veeam Backup & Replication applies forever forward incremental backup retention policy. For backup chains created by jobs that regularly produce active or synthetic full backups, Veeam Backup & Replication applies forward incremental backup retention policy.
