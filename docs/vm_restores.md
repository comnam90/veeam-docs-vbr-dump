...
* [Staged restore](staged_restore_about.md) — to run executable scripts for VMs before recovering them to the production environment. Staged restore is a part of entire VM restore.
