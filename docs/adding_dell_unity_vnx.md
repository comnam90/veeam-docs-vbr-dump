...
1. [Launch the wizard](dell_select_storage_type.md).
2. [Specify storage name or address and storage role](dell_vnx_add_name.md).
3. [Specify credentials](dell_vnx_add_creds.md).
4. [Specify VMware access options](dell_vnx_add_options.md).
5. [Specify Veeam Agent access options](dell_vnx_agents_access.md).
