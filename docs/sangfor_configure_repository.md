...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_configure_repository.html"
last_updated: "2026"
...
| --- |
| Important |
| [Veeam Cloud Connect](https://helpcenter.veeam.com/docs/vbr/cloud/cloud_overview.html?ver=13) repositories can only be used to store copies of backups created with Veeam Plug-in for Sangfor aSV. |
