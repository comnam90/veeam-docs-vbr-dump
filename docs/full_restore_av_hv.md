...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/full_restore_av_hv.html"
last_updated: "2026"
...
1. Select the Continue scanning all remaining files after the first occurrence check box if you want to continue machine scan after the first malware is found. For information on how to view results of the malware scan, see [Viewing Scan Results Using Console](malware_detection_secure_restore_results.md).

![Step 9. Specify Secure Restore Settings](images/hv_restore_fullvm_av.webp)
