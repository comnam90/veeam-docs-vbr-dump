...
* [Quick Rollback](vcd_cdp_failback_quick_rollback.md)
* [Performing Failback](vcd_cdp_perform_failback.md)
* [Changing Switching Time](vcd_cdp_failback_switching_time.md)
