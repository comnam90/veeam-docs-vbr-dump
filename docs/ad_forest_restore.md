...
In this version, you can restore from VMware vSphere and Microsoft Hyper-V backups to any of these two platforms. Cross-platform restore is supported — for example, a backed-up domain controller running on VMware vSphere can be restored to Microsoft Hyper-V, and the other way around.
