...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ahv_backup_job_vbr_gfs_web.html"
last_updated: "2026"
...
After you configure the GFS retention policy settings, [schedule active full or synthetic full backups](ahv_backup_job_vbr_schedule_web.md). Otherwise, no new full backups will be automatically produced, and Veeam Backup & Replication will be unable to leverage them for long-term retentions.
...
[![Launch Add Job Wizard](images/ahv_backup_job_add_destination_gfs_web.webp)](images/ahv_backup_job_add_destination_gfs_web.webp "Launch Add Job Wizard")
