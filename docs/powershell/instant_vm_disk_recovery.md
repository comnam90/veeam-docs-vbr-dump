...
| Cmdlet | Operation |
| --- | --- |
| [Get-VBRViVirtualDevice](get-vbrvivirtualdevice.md) | Returns details on VMware VM virtual disks.. |
| [Set-VBRViVirtualDevice](set-vbrvivirtualdevice.md) | Modifies settings of VM virtual disks. |
