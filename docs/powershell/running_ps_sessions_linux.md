---
title: "Running Veeam PowerShell Session on Linux Machines"
product: "vbr"
doc_type: "powershell"
...
* A machine that runs the PowerShell session must have PowerShell version 7 installed.
...
To configure Veeam Backup PowerShell on a Veeam Software Appliance, do the following:
