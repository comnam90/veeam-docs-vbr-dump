...
[Add-HyperFlexHost](add-hyperflexhost.md)
...
[Add-ThinkSystemSnapshot](add-thinksystemsnapshot.md)

[Add-VBR1111SystemsS3Repository](add-vbr1111systemss3repository.md)

[Add-VBRAdCloudTenant](add-vbradcloudtenant.md)

[Add-VBRAdvancedLatencyOptions](add-vbradvancedlatencyoptions.md)

[Add-VBRAmazonAccount](add-vbramazonaccount.md)

[Add-VBRAmazonS3CompatibleRepository](add-vbramazons3compatiblerepository.md)

[Add-VBRAmazonS3ExternalRepository](add-vbramazons3externalrepository.md)

[Add-VBRAmazonS3GlacierRepository](add-vbramazons3glacierrepository.md)

[Add-VBRAmazonS3Repository](add-vbramazons3repository.md)

[Add-VBRAmazonS3Server](add-vbramazons3server.md)

[Add-VBRApplicationBackupJob](add-vbrapplicationbackupjob.md)

[Add-VBRApplicationGroup](add-vbrapplicationgroup.md)

[Add-VBRArchiveBackupAvailabilityPeriod](add-vbrarchivebackupavailabilityperiod.md)
...
[Add-VBRAzureBlobRepository](add-vbrazureblobrepository.md)

[Add-VBRAzureBlobServer](add-vbrazureblobserver.md)

[Add-VBRAzureComputeBackupCopyJob](add-vbrazurecomputebackupcopyjob.md)

[Add-VBRAzureDataBoxRepository](add-vbrazuredataboxrepository.md)

[Add-VBRAzureExternalRepository](add-vbrazureexternalrepository.md)
...
[Add-VBRBackupJob](add-vbrbackupjob.md)

[Add-VBRBackupRepository](add-vbrbackuprepository.md)

[Add-VBRBackupServerCertificate](add-vbrbackupservercertificate.md)

[Add-VBRBackupToTapeJob](add-vbrbackuptotapejob.md)

[Add-VBRCatalystCopyJob](add-vbrcatalystcopyjob.md)

[Add-VBRCDPPolicy](add-vbrcdppolicy.md)

[Add-VBRCDPProxy](add-vbrcdpproxy.md)

[Add-VBRCloudArchiveBackupAvailabilityPeriod](add-vbrcloudarchivebackupavailabilityperiod.md)

[Add-VBRCloudCDPPolicy](add-vbrcloudcdppolicy.md)

[Add-VBRCloudGateway](add-vbrcloudgateway.md)

[Add-VBRCloudGatewayCertificate](add-vbrcloudgatewaycertificate.md)

[Add-VBRCloudGatewayPool](add-vbrcloudgatewaypool.md)

[Add-VBRCloudProvider](add-vbrcloudprovider.md)

[Add-VBRCloudProviderCredentials](add-vbrcloudprovidercredentials.md)
...
[Add-VBRComputerBackupCopyJob](add-vbrcomputerbackupcopyjob.md)

[Add-VBRComputerBackupJob](add-vbrcomputerbackupjob.md)

[Add-VBRComputerFileProxyServer](add-vbrcomputerfileproxyserver.md)

[Add-VBRComputerRecoveryToken](add-vbrcomputerrecoverytoken.md)

[Add-VBRCopyJob](add-vbrcopyjob.md)

[Add-VBRCredentials](add-vbrcredentials.md)

[Add-VBRDataCloudVaultRepository](add-vbrdatacloudvaultrepository.md)
...
[Add-VBREC2BackupCopyJob](add-vbrec2backupcopyjob.md)
...
[Add-VBRFiler](add-vbrfiler.md)

[Add-VBRFileToTapeJob](add-vbrfiletotapejob.md)

[Add-VBRGoogleCloudAccount](add-vbrgooglecloudaccount.md)

[Add-VBRGoogleCloudComputeAccount](add-vbrgooglecloudcomputeaccount.md)

[Add-VBRGoogleCloudExternalRepository](add-vbrgooglecloudexternalrepository.md)
...
[Add-VBRHvAdvancedVirtualLab](add-vbrhvadvancedvirtuallab.md)
...
[Add-VBRHvReplicaJob](add-vbrhvreplicajob.md)

[Add-VBRHvScvmm](add-vbrhvscvmm.md)

[Add-VBRHvSimpleVirtualLab](add-vbrhvsimplevirtuallab.md)

[Add-VBRIBMCloudRepository](add-vbribmcloudrepository.md)

[Add-VBRIsilonHost](add-vbrisilonhost.md)

[Add-VBRJobObject](add-vbrjobobject.md)

[Add-VBRKMSServer](add-vbrkmsserver.md)

[Add-VBRLinux](add-vbrlinux.md)

[Add-VBRLocation](add-vbrlocation.md)

[Add-VBRMalwareDetectionExclusion](add-vbrmalwaredetectionexclusion.md)

[Add-VBRMongoDBBackupJob](add-vbrmongodbbackupjob.md)

[Add-VBRNASBackupJob](add-vbrnasbackupjob.md)

[Add-VBRNASFileServer](add-vbrnasfileserver.md)

[Add-VBRNASNFSServer](add-vbrnasnfsserver.md)

[Add-VBRNASProxyServer](add-vbrnasproxyserver.md)

[Add-VBRNASSMBServer](add-vbrnassmbserver.md)

[Add-VBRNDMPServer](add-vbrndmpserver.md)

[Add-VBRNetworkTrafficRule](add-vbrnetworktrafficrule.md)

[Add-VBRNutanixHost](add-vbrnutanixhost.md)

[Add-VBRObjectStorageBackupJob](add-vbrobjectstoragebackupjob.md)

[Add-VBRObjectToTapeJob](add-vbrobjecttotapejob.md)

[Add-VBRPluginBackupCopyJob](add-vbrpluginbackupcopyjob.md)

[Add-VBRPreferredNetwork](add-vbrpreferrednetwork.md)

[Add-VBRProtectionGroup](add-vbrprotectiongroup.md)

[Add-VBRS3CompatibleServer](add-vbrs3compatibleserver.md)

[Add-VBRS3GlacierCompatibleRepository](add-vbrs3glaciercompatiblerepository.md)

[Add-VBRScaleOutBackupRepository](add-vbrscaleoutbackuprepository.md)

[Add-VBRSmbV3Cluster](add-vbrsmbv3cluster.md)

[Add-VBRSmbV3Host](add-vbrsmbv3host.md)

[Add-VBRSureBackupContentScanJob](add-vbrsurebackupcontentscanjob.md)

[Add-VBRSureBackupJob](add-vbrsurebackupjob.md)

[Add-VBRSyslogEventFilter](add-vbrsyslogeventfilter.md)

[Add-VBRSyslogServer](add-vbrsyslogserver.md)

[Add-VBRTapeFilesJob](add-vbrtapefilesjob.md)
...
[Add-VBRTapeVMJob](add-vbrtapevmjob.md)

[Add-VBRUniversalCDPPolicy](add-vbruniversalcdppolicy.md)

[Add-VBRUserRoleAssignment](add-vbruserroleassignment.md)

[Add-VBRvCDCDPPolicy](add-vbrvcdcdppolicy.md)

[Add-VBRvCDCloudCDPPolicy](add-vbrvcdcloudcdppolicy.md)

[Add-VBRvCDCloudReplicaJob](add-vbrvcdcloudreplicajob.md)

[Add-VBRvCDCloudSubTenant](add-vbrvcdcloudsubtenant.md)

[Add-VBRvCDCloudSubUser](add-vbrvcdcloudsubuser.md)

[Add-VBRvCDCloudTenant](add-vbrvcdcloudtenant.md)

[Add-VBRvCDReplicaJob](add-vbrvcdreplicajob.md)
...
[Add-VBRvCloudJobObject](add-vbrvcloudjobobject.md)

[Add-VBRvCloudVC](add-vbrvcloudvc.md)

[Add-VBRViAdvancedVirtualLab](add-vbrviadvancedvirtuallab.md)

[Add-VBRViApplicationGroup](add-vbrviapplicationgroup.md)
...
[Add-VBRViLinuxProxy](add-vbrvilinuxproxy.md)

[Add-VBRViProxy](add-vbrviproxy.md)

[Add-VBRViReplicaJob](add-vbrvireplicajob.md)

[Add-VBRViSimpleVirtualLab](add-vbrvisimplevirtuallab.md)

[Add-VBRViSureBackupJob](add-vbrvisurebackupjob.md)

[Add-VBRVMExclusion](add-vbrvmexclusion.md)
...
[Add-VSBApplicationGroup](add-vsbapplicationgroup.md)
...
[Apply-VBRBackgroundRetention](apply-vbrbackgroundretention.md)

[Apply-VBRLocation](apply-vbrlocation.md)

[Apply-VBRManagedByAgentPolicy](apply-vbrmanagedbyagentpolicy.md)

Assign

[Assign-VBRInstanceWorkload](assign-vbrinstanceworkload.md)

Clear

[Clear-VBRManagedByAgentPolicyCache](clear-vbrmanagedbyagentpolicycache.md)
...
[Compare-VBRUnstructuredBackupFLRItem](compare-vbrunstructuredbackupflritem.md)

[Compare-VBRUnstructuredBackupFLRItemAttributes](compare-vbrunstructuredbackupflritemattributes.md)

[Compare-VBRWindowsGuestItemsAttributes](compare-vbrwindowsguestitemsattributes.md)
...
[Connect-VBRHvVirtualLab](connect-vbrhvvirtuallab.md)

[Connect-VBRServer](connect-vbrserver.md)

[Connect-VBRViVirtualLab](connect-vbrvivirtuallab.md)

[Connect-VBRWindowsGuestProductionMachine](connect-vbrwindowsguestproductionmachine.md)
...
[Convert-VBRLegacyCopyBackup](convert-vbrlegacycopybackup.md)

[Convert-VBRNASBackupRootFormat](convert-vbrnasbackuprootformat.md)

[Convert-VBRNASBackupSANFormat](convert-vbrnasbackupsanformat.md)

[Convert-VBRNASBackupStorageFormat](convert-vbrnasbackupstorageformat.md)

Copy

[Copy-VBRAntivirusConfigurationFile](copy-vbrantivirusconfigurationfile.md)

[Copy-VBRBackup](copy-vbrbackup.md)

[Copy-VBRBackupCopyJob](copy-vbrbackupcopyjob.md)

[Copy-VBRComputerBackupCopyJob](copy-vbrcomputerbackupcopyjob.md)

[Copy-VBRComputerBackupJob](copy-vbrcomputerbackupjob.md)

[Copy-VBRJob](copy-vbrjob.md)

[Copy-VBRLinuxGuestItem](copy-vbrlinuxguestitem.md)

[Copy-VBRNASBackup](copy-vbrnasbackup.md)

[Copy-VBRUnstructuredBackup](copy-vbrunstructuredbackup.md)

[Copy-VBRWindowsGuestItem](copy-vbrwindowsguestitem.md)

Deploy

[Deploy-VBRAzureApplianceTemplate](deploy-vbrazureappliancetemplate.md)

[Deploy-VBRAzureLinuxRestoreAppliance](deploy-vbrazurelinuxrestoreappliance.md)

Detach

[Detach-VBRBackup](detach-vbrbackup.md)

Disable

[Disable-VBRApplicationBackupJob](disable-vbrapplicationbackupjob.md)

[Disable-VBRArchiveExtentMaintenanceMode](disable-vbrarchiveextentmaintenancemode.md)

[Disable-VBRArchiveExtentSealedMode](disable-vbrarchiveextentsealedmode.md)

[Disable-VBRBackgroundRetention](disable-vbrbackgroundretention.md)

[Disable-VBRBackupCopyJob](disable-vbrbackupcopyjob.md)

[Disable-VBRCapacityExtentMaintenanceMode](disable-vbrcapacityextentmaintenancemode.md)

[Disable-VBRCapacityExtentSealedMode](disable-vbrcapacityextentsealedmode.md)

[Disable-VBRCatalystCopyJob](disable-vbrcatalystcopyjob.md)

[Disable-VBRCDPPolicy](disable-vbrcdppolicy.md)

[Disable-VBRCDPProxy](disable-vbrcdpproxy.md)

[Disable-VBRCloudGateway](disable-vbrcloudgateway.md)

[Disable-VBRCloudGatewayPool](disable-vbrcloudgatewaypool.md)
...
[Disable-VBRComputerBackupCopyJob](disable-vbrcomputerbackupcopyjob.md)

[Disable-VBRComputerBackupJob](disable-vbrcomputerbackupjob.md)

[Disable-VBRComputerFileProxyServer](disable-vbrcomputerfileproxyserver.md)

[Disable-VBREPJob](disable-vbrepjob.md)

[Disable-VBRFreeAgentInstanceConsumption](disable-vbrfreeagentinstanceconsumption.md)
...
[Disable-VBRLicenseAutoUpdate](disable-vbrlicenseautoupdate.md)

[Disable-VBRMailNotification](disable-vbrmailnotification.md)

[Disable-VBRNASProxyServer](disable-vbrnasproxyserver.md)

[Disable-VBRPluginJob](disable-vbrpluginjob.md)

[Disable-VBRPreferredNetworkDataTransfer](disable-vbrpreferrednetworkdatatransfer.md)
...
[Disable-VBRRepositoryExtentSealedMode](disable-vbrrepositoryextentsealedmode.md)

[Disable-VBRStorageLatencyControl](disable-vbrstoragelatencycontrol.md)

[Disable-VBRSureBackupJob](disable-vbrsurebackupjob.md)

[Disable-VBRTapeDrive](disable-vbrtapedrive.md)

[Disable-VBRTapeLibraryMaintenance](disable-vbrtapelibrarymaintenance.md)

[Disable-VBRTapeProtection](disable-vbrtapeprotection.md)

[Disable-VBRvCDReplicaJob](disable-vbrvcdreplicajob.md)

[Disable-VBRViProxy](disable-vbrviproxy.md)

[Disable-VSBJob](disable-vsbjob.md)

[Disable-VSBJobSchedule](disable-vsbjobschedule.md)

Disconnect

[Disconnect-VBRAmazonS3Service](disconnect-vbramazons3service.md)

[Disconnect-VBRAzureBlobService](disconnect-vbrazureblobservice.md)

[Disconnect-VBRGoogleCloudService](disconnect-vbrgooglecloudservice.md)

[Disconnect-VBRServer](disconnect-vbrserver.md)

Download

[Download-VBRDeletedArchivedBackupFile](download-vbrdeletedarchivedbackupfile.md)

Eject

[Eject-VBRTapeDrive](eject-vbrtapedrive.md)

[Eject-VBRTapeMedium](eject-vbrtapemedium.md)

Enable

[Enable-VBRApplicationBackupJob](enable-vbrapplicationbackupjob.md)

[Enable-VBRArchiveExtentMaintenanceMode](enable-vbrarchiveextentmaintenancemode.md)

[Enable-VBRArchiveExtentSealedMode](enable-vbrarchiveextentsealedmode.md)

[Enable-VBRBackgroundRetention](enable-vbrbackgroundretention.md)

[Enable-VBRBackupCopyJob](enable-vbrbackupcopyjob.md)

[Enable-VBRCapacityExtentMaintenanceMode](enable-vbrcapacityextentmaintenancemode.md)

[Enable-VBRCapacityExtentSealedMode](enable-vbrcapacityextentsealedmode.md)

[Enable-VBRCatalystCopyJob](enable-vbrcatalystcopyjob.md)

[Enable-VBRCDPPolicy](enable-vbrcdppolicy.md)

[Enable-VBRCDPProxy](enable-vbrcdpproxy.md)

[Enable-VBRCloudGateway](enable-vbrcloudgateway.md)

[Enable-VBRCloudGatewayPool](enable-vbrcloudgatewaypool.md)
...
[Enable-VBRComputerBackupCopyJob](enable-vbrcomputerbackupcopyjob.md)

[Enable-VBRComputerBackupJob](enable-vbrcomputerbackupjob.md)

[Enable-VBRComputerFileProxyServer](enable-vbrcomputerfileproxyserver.md)

[Enable-VBREPJob](enable-vbrepjob.md)

[Enable-VBRFreeAgentInstanceConsumption](enable-vbrfreeagentinstanceconsumption.md)
...
[Enable-VBRLicenseAutoUpdate](enable-vbrlicenseautoupdate.md)

[Enable-VBRMailNotification](enable-vbrmailnotification.md)

[Enable-VBRNASProxyServer](enable-vbrnasproxyserver.md)

[Enable-VBRPluginJob](enable-vbrpluginjob.md)

[Enable-VBRPreferredNetworkDataTransfer](enable-vbrpreferrednetworkdatatransfer.md)
...
[Enable-VBRRepositoryExtentSealedMode](enable-vbrrepositoryextentsealedmode.md)

[Enable-VBRStorageLatencyControl](enable-vbrstoragelatencycontrol.md)

[Enable-VBRSureBackupJob](enable-vbrsurebackupjob.md)

[Enable-VBRTapeDrive](enable-vbrtapedrive.md)

[Enable-VBRTapeLibraryMaintenance](enable-vbrtapelibrarymaintenance.md)

[Enable-VBRTapeProtection](enable-vbrtapeprotection.md)

[Enable-VBRvCDReplicaJob](enable-vbrvcdreplicajob.md)

[Enable-VBRViProxy](enable-vbrviproxy.md)

[Enable-VSBJob](enable-vsbjob.md)

[Enable-VSBJobSchedule](enable-vsbjobschedule.md)
...
[Export-VBRAudit](export-vbraudit.md)

[Export-VBRBackup](export-vbrbackup.md)

[Export-VBRConfiguration](export-vbrconfiguration.md)

[Export-VBRJobObjectMasks](export-vbrjobobjectmasks.md)

[Export-VBRLinuxKnownHost](export-vbrlinuxknownhost.md)

[Export-VBRLocation](export-vbrlocation.md)

[Export-VBRLogs](export-vbrlogs.md)

[Export-VBRMalwareDetectionExtensionList](export-vbrmalwaredetectionextensionlist.md)

[Export-VBRRestorePoint](export-vbrrestorepoint.md)
...
[Find-VBRDatastore](find-vbrdatastore.md)

[Find-VBRHvEntity](find-vbrhventity.md)

[Find-VBRObject](find-vbrobject.md)

[Find-VBRResourcePool](find-vbrresourcepool.md)

[Find-VBRTapeCatalog](find-vbrtapecatalog.md)

[Find-VBRTapeCatalogItem](find-vbrtapecatalogitem.md)

[Find-VBRTapeCatalogItemVersion](find-vbrtapecatalogitemversion.md)
...
[Forget-VBRCloudUnavailableBackupFile](forget-vbrcloudunavailablebackupfile.md)

Generate

[Generate-VBRBackupServerCertificate](generate-vbrbackupservercertificate.md)

[Generate-VBRBackupServerDeployerKit](generate-vbrbackupserverdeployerkit.md)

[Generate-VBRCloudGatewayCertificate](generate-vbrcloudgatewaycertificate.md)

[Generate-VBREntraIDTenantUserPassword](generate-vbrentraidtenantuserpassword.md)

[Generate-VBRLicenseUsageReport](generate-vbrlicenseusagereport.md)

[Generate-VBRViMigrationSpecificationFile](generate-vbrvimigrationspecificationfile.md)
...
[Get-VBRApplicationBackupJobSession](get-vbrapplicationbackupjobsession.md)
...
[Get-VBRAzureApplianceSession](get-vbrazureappliancesession.md)
...
[Get-VBRAzureInstantRecoverySession](get-vbrazureinstantrecoverysession.md)

[Get-VBRAzureInstantRecoverySwitchingOptions](get-vbrazureinstantrecoveryswitchingoptions.md)
...
[Get-VBRBackupServerDeployerCertificate](get-vbrbackupserverdeployercertificate.md)

[Get-VBRBackupServerInfo](get-vbrbackupserverinfo.md)
...
[Get-VBRCDPFilter](get-vbrcdpfilter.md)
...
[Get-VBRCDPTaskSession](get-vbrcdptasksession.md)
...
[Get-VBRCloudTenantRestorePoint](get-vbrcloudtenantrestorepoint.md)
...
[Get-VBRComputerBackupJobSession](get-vbrcomputerbackupjobsession.md)
...
[Get-VBRCopyBackupSession](get-vbrcopybackupsession.md)
...
[Get-VBRDiscoveredComputerNetwork](get-vbrdiscoveredcomputernetwork.md)
...
[Get-VBREncryptedTapeMediumHint](get-vbrencryptedtapemediumhint.md)
...
[Get-VBRExportLogSession](get-vbrexportlogsession.md)
...
[Get-VBRFCDInstantRecoveryInfo](get-vbrfcdinstantrecoveryinfo.md)
...
[Get-VBRFreeAgentInstanceConsumptionStatus](get-vbrfreeagentinstanceconsumptionstatus.md)
...
[Get-VBRGoogleCloudBackup](get-vbrgooglecloudbackup.md)
...
[Get-VBRGoogleCloudComputeSharedSubnet](get-vbrgooglecloudcomputesharedsubnet.md)
...
[Get-VBRHistoryOptions](get-vbrhistoryoptions.md)
...
[Get-VBRHvVssProvider](get-vbrhvvssprovider.md)
...
[Get-VBRLicenseAutoUpdateStatus](get-vbrlicenseautoupdatestatus.md)
...
[Get-VBRMalwareDetectionExclusion](get-vbrmalwaredetectionexclusion.md)

[Get-VBRMalwareDetectionObject](get-vbrmalwaredetectionobject.md)

[Get-VBRMalwareDetectionOptions](get-vbrmalwaredetectionoptions.md)

[Get-VBRMalwareDetectionTaskSession](get-vbrmalwaredetectiontasksession.md)

[Get-VBRMongoDBComputer](get-vbrmongodbcomputer.md)

[Get-VBRMoveBackupSession](get-vbrmovebackupsession.md)

[Get-VBRNASBackup](get-vbrnasbackup.md)

[Get-VBRNASBackupCopyJob](get-vbrnasbackupcopyjob.md)

[Get-VBRNASBackupFLRItem](get-vbrnasbackupflritem.md)

[Get-VBRNASBackupFLRItemVersion](get-vbrnasbackupflritemversion.md)
...
[Get-VBRNASServerPath](get-vbrnasserverpath.md)
...
[Get-VBRNutanixInfrastructureVolume](get-vbrnutanixinfrastructurevolume.md)
...
[Get-VBRPluginBackupSession](get-vbrpluginbackupsession.md)

[Get-VBRPluginJob](get-vbrpluginjob.md)

[Get-VBRPluginRestoreSession](get-vbrpluginrestoresession.md)
...
[Get-VBRPublishedBackupContentInfo](get-vbrpublishedbackupcontentinfo.md)
...
[Get-VBRRecoveryPointObjective](get-vbrrecoverypointobjective.md)
...
[Get-VBRScanTaskSessionLog](get-vbrscantasksessionlog.md)
...
[Get-VBRSNMPOptions](get-vbrsnmpoptions.md)
...
[Get-VBRStorageLatencyControlOptions](get-vbrstoragelatencycontroloptions.md)
...
[Get-VBRTapeBackup](get-vbrtapebackup.md)

[Get-VBRTapeBackupSession](get-vbrtapebackupsession.md)

[Get-VBRTapeCopyDependentMedium](get-vbrtapecopydependentmedium.md)
...
[Get-VBRTapeMediaPoolOptions](get-vbrtapemediapooloptions.md)

[Get-VBRTapeMedium](get-vbrtapemedium.md)

[Get-VBRTapeRestoreAllContentDependentMedium](get-vbrtaperestoreallcontentdependentmedium.md)
...
[Get-VBRUnstructuredBackupTaskSession](get-vbrunstructuredbackuptasksession.md)
...
[Get-VBRvCDCDPFilter](get-vbrvcdcdpfilter.md)

[Get-VBRvCDCDPLongTermRestorePoint](get-vbrvcdcdplongtermrestorepoint.md)

[Get-VBRvCDCDPShortTermRestoreInterval](get-vbrvcdcdpshorttermrestoreinterval.md)

[Get-VBRvCDCloudNetworkInfo](get-vbrvcdcloudnetworkinfo.md)
...
[Get-VBRvCDCloudVM](get-vbrvcdcloudvm.md)

[Get-VBRVCDOrgVdcNetworkInfo](get-vbrvcdorgvdcnetworkinfo.md)
...
[Get-VBRViCloudVM](get-vbrvicloudvm.md)
...
[Import-VBRConfiguration](import-vbrconfiguration.md)

[Import-VBRJobObjectMasks](import-vbrjobobjectmasks.md)

[Import-VBRLinuxKnownHost](import-vbrlinuxknownhost.md)

[Import-VBRLocation](import-vbrlocation.md)

[Import-VBRMalwareDetectionExtensionList](import-vbrmalwaredetectionextensionlist.md)
...
[Install-VBRCDPFilter](install-vbrcdpfilter.md)

[Install-VBRDiscoveredComputerAgent](install-vbrdiscoveredcomputeragent.md)

[Install-VBRDiscoveredComputerCDPAgent](install-vbrdiscoveredcomputercdpagent.md)

[Install-VBRDiscoveredComputerPlugin](install-vbrdiscoveredcomputerplugin.md)

[Install-VBRLicense](install-vbrlicense.md)

[Install-VBRLinuxTransportService](install-vbrlinuxtransportservice.md)

[Install-VBRvCDCDPFilter](install-vbrvcdcdpfilter.md)

Mount

[Mount-VBRObjectStorageRepository](mount-vbrobjectstoragerepository.md)

[Mount-VBRWindowsFileRestoreItems](mount-vbrwindowsfilerestoreitems.md)
...
[New-VBRAmazonEC2Tag](new-vbramazonec2tag.md)
...
[New-VBRAzureDiskConfiguration](new-vbrazurediskconfiguration.md)
...
[New-VBRAzureTag](new-vbrazuretag.md)
...
[New-VBRComputerWarningOptions](new-vbrcomputerwarningoptions.md)
...
[New-VBRFailbackSwitchingSchedule](new-vbrfailbackswitchingschedule.md)

[New-VBRFailoverPlanObject](new-vbrfailoverplanobject.md)

[New-VBRFailoverPlanPublicIPRule](new-vbrfailoverplanpubliciprule.md)

[New-VBRFCDInstantRecoveryMappingOptions](new-vbrfcdinstantrecoverymappingoptions.md)

[New-VBRFileRestoreLinuxHelperApplianceOptions](new-vbrfilerestorelinuxhelperapplianceoptions.md)
...
[New-VBRGFSRetentionPolicy](new-vbrgfsretentionpolicy.md)
...
[New-VBRGoogleCloudFolder](new-vbrgooglecloudfolder.md)
...
[New-VBRHvInstantRecoveryHelperAppliance](new-vbrhvinstantrecoveryhelperappliance.md)
...
[New-VBRHvVirtualDeviceMappingRule](new-vbrhvvirtualdevicemappingrule.md)

[New-VBRHvVirtualLabProxyAppliance](new-vbrhvvirtuallabproxyappliance.md)

[New-VBRHvVirtualLabStaticIPMappingRule](new-vbrhvvirtuallabstaticipmappingrule.md)
...
[New-VBRMSSQLCredentialsOptions](new-vbrmssqlcredentialsoptions.md)

[New-VBRMSSQLOptions](new-vbrmssqloptions.md)

[New-VBRMSSQLProcessingOptions](new-vbrmssqlprocessingoptions.md)

[New-VBRMSSQLStorageOptions](new-vbrmssqlstorageoptions.md)
...
[New-VBRNASBackupPathMask](new-vbrnasbackuppathmask.md)

[New-VBRNASBackupSecondaryTarget](new-vbrnasbackupsecondarytarget.md)

[New-VBRNASBackupVersionRetentionOptions](new-vbrnasbackupversionretentionoptions.md)

[New-VBRNASBackupWildcardMask](new-vbrnasbackupwildcardmask.md)
...
[New-VBRObjectStorageBackupServerPathMask](new-vbrobjectstoragebackupserverpathmask.md)
...
[New-VBROracleRMANOptions](new-vbroraclermanoptions.md)

[New-VBROracleRMANProcessingOptions](new-vbroraclermanprocessingoptions.md)

[New-VBROracleRMANStorageOptions](new-vbroraclermanstorageoptions.md)
...
[New-VBRRecoveryPointObjective](new-vbrrecoverypointobjective.md)

[New-VBRReplicaApplicationProcessingOptions](new-vbrreplicaapplicationprocessingoptions.md)
...
[New-VBRSanIntegrationOptions](new-vbrsanintegrationoptions.md)
...
[New-VBRSAPHANAStorageOptions](new-vbrsaphanastorageoptions.md)

[New-VBRSAPOnOracleOptions](new-vbrsaponoracleoptions.md)

[New-VBRSAPOnOracleProcessingOptions](new-vbrsaponoracleprocessingoptions.md)

[New-VBRSAPOnOracleStorageOptions](new-vbrsaponoraclestorageoptions.md)
...
[New-VBRSimpleRetentionPolicy](new-vbrsimpleretentionpolicy.md)
...
[New-VBRUniversalCDPCloudDestination](new-vbruniversalcdpclouddestination.md)

[New-VBRUniversalCDPNetworkMappingRule](new-vbruniversalcdpnetworkmappingrule.md)

[New-VBRUniversalCDPvCDCloudDestination](new-vbruniversalcdpvcdclouddestination.md)
...
[New-VBRViDiskMigrationMappingRule](new-vbrvidiskmigrationmappingrule.md)
...
[Publish-StoragePluginArchivedSnapshot](publish-storagepluginarchivedsnapshot.md)

[Publish-VBRArchiveRestorePoint](publish-vbrarchiverestorepoint.md)

[Publish-VBRBackupContent](publish-vbrbackupcontent.md)

[Publish-VBRCloudArchiveRestorePoint](publish-vbrcloudarchiverestorepoint.md)

Rehydrate

[Rehydrate-VBRDeletedBackupFile](rehydrate-vbrdeletedbackupfile.md)
...
[Remove-StoragePluginArchivedSnapshot](remove-storagepluginarchivedsnapshot.md)

[Remove-StoragePluginHost](remove-storagepluginhost.md)

[Remove-StoragePluginSnapshot](remove-storagepluginsnapshot.md)

[Remove-ThinkSystemHost](remove-thinksystemhost.md)

[Remove-ThinkSystemSnapshot](remove-thinksystemsnapshot.md)

[Remove-VBRAdvancedLatencyOptions](remove-vbradvancedlatencyoptions.md)

[Remove-VBRAmazonAccount](remove-vbramazonaccount.md)

[Remove-VBRApplicationBackupJob](remove-vbrapplicationbackupjob.md)

[Remove-VBRApplicationGroup](remove-vbrapplicationgroup.md)

[Remove-VBRArchiveObjectStorageRepository](remove-vbrarchiveobjectstoragerepository.md)

[Remove-VBRAzureAccount](remove-vbrazureaccount.md)

[Remove-VBRAzureADAccount](remove-vbrazureadaccount.md)

[Remove-VBRAzureApplianceTemplate](remove-vbrazureappliancetemplate.md)

[Remove-VBRAzureBlobAccount](remove-vbrazureblobaccount.md)

[Remove-VBRAzureRestoreProxy](remove-vbrazurerestoreproxy.md)

[Remove-VBRBackup](remove-vbrbackup.md)

[Remove-VBRBackupCopyJob](remove-vbrbackupcopyjob.md)

[Remove-VBRBackupFile](remove-vbrbackupfile.md)

[Remove-VBRBackupRepository](remove-vbrbackuprepository.md)

[Remove-VBRBackupServerDeployerCertificate](remove-vbrbackupserverdeployercertificate.md)

[Remove-VBRBackupSession](remove-vbrbackupsession.md)

[Remove-VBRCatalystCopyJob](remove-vbrcatalystcopyjob.md)

[Remove-VBRCDPPolicy](remove-vbrcdppolicy.md)

[Remove-VBRCDPProxy](remove-vbrcdpproxy.md)

[Remove-VBRCDPReplica](remove-vbrcdpreplica.md)

[Remove-VBRCloudGateway](remove-vbrcloudgateway.md)

[Remove-VBRCloudGatewayPool](remove-vbrcloudgatewaypool.md)

[Remove-VBRCloudHardwarePlan](remove-vbrcloudhardwareplan.md)

[Remove-VBRCloudProvider](remove-vbrcloudprovider.md)

[Remove-VBRCloudProviderCredentials](remove-vbrcloudprovidercredentials.md)
...
[Remove-VBRCloudTenantBackup](remove-vbrcloudtenantbackup.md)

[Remove-VBRCloudVLANConfiguration](remove-vbrcloudvlanconfiguration.md)

[Remove-VBRComputerBackupCopyJob](remove-vbrcomputerbackupcopyjob.md)

[Remove-VBRComputerBackupJob](remove-vbrcomputerbackupjob.md)

[Remove-VBRComputerFileProxyServer](remove-vbrcomputerfileproxyserver.md)

[Remove-VBRComputerRecoveryToken](remove-vbrcomputerrecoverytoken.md)
...
[Remove-VBREncryptedBackup](remove-vbrencryptedbackup.md)

[Remove-VBREncryptionKey](remove-vbrencryptionkey.md)

[Remove-VBREntraIdLogsBackupJob](remove-vbrentraidlogsbackupjob.md)

[Remove-VBREntraIdTenant](remove-vbrentraidtenant.md)

[Remove-VBREntraIDTenantBackupJob](remove-vbrentraidtenantbackupjob.md)

[Remove-VBRExternalRepository](remove-vbrexternalrepository.md)

[Remove-VBRFailoverPlan](remove-vbrfailoverplan.md)

[Remove-VBRFiler](remove-vbrfiler.md)

[Remove-VBRGoogleCloudAccount](remove-vbrgooglecloudaccount.md)

[Remove-VBRGoogleCloudComputeAccount](remove-vbrgooglecloudcomputeaccount.md)

[Remove-VBRHighAvailabilityCluster](remove-vbrhighavailabilitycluster.md)

[Remove-VBRHvProxy](remove-vbrhvproxy.md)

[Remove-VBRIsilonHost](remove-vbrisilonhost.md)

[Remove-VBRJob](remove-vbrjob.md)

[Remove-VBRJobObject](remove-vbrjobobject.md)

[Remove-VBRKMSServer](remove-vbrkmsserver.md)

[Remove-VBRLocation](remove-vbrlocation.md)

[Remove-VBRMalwareDetectionExclusion](remove-vbrmalwaredetectionexclusion.md)

[Remove-VBRNASBackup](remove-vbrnasbackup.md)

[Remove-VBRNASBackupJob](remove-vbrnasbackupjob.md)

[Remove-VBRNASProxyServer](remove-vbrnasproxyserver.md)

[Remove-VBRNASServer](remove-vbrnasserver.md)

[Remove-VBRNDMPServer](remove-vbrndmpserver.md)

[Remove-VBRNetworkTrafficRule](remove-vbrnetworktrafficrule.md)

[Remove-VBRNutanixHost](remove-vbrnutanixhost.md)

[Remove-VBRObjectStorageRepository](remove-vbrobjectstoragerepository.md)

[Remove-VBRPluginJob](remove-vbrpluginjob.md)

[Remove-VBRPreferredNetwork](remove-vbrpreferrednetwork.md)

[Remove-VBRProtectionGroup](remove-vbrprotectiongroup.md)
...
[Remove-VBRUnstructuredBackup](remove-vbrunstructuredbackup.md)

[Remove-VBRUnstructuredBackupJob](remove-vbrunstructuredbackupjob.md)

[Remove-VBRUnstructuredServer](remove-vbrunstructuredserver.md)

[Remove-VBRUserRoleAssignment](remove-vbruserroleassignment.md)

[Remove-VBRvCDReplica](remove-vbrvcdreplica.md)

[Remove-VBRvCDReplicaJob](remove-vbrvcdreplicajob.md)

[Remove-VBRViProxy](remove-vbrviproxy.md)

[Remove-VBRVirtualLab](remove-vbrvirtuallab.md)

[Remove-VBRVMExclusion](remove-vbrvmexclusion.md)
...
[Remove-VSBSession](remove-vsbsession.md)

[Remove-VSBVirtualLab](remove-vsbvirtuallab.md)

Request

[Request-VBREntraIdLogin](request-vbrentraidlogin.md)
...
[Reset-VBRAgentCertificate](reset-vbragentcertificate.md)

[Reset-VBRBackupServerClientCertificate](reset-vbrbackupserverclientcertificate.md)

[Reset-VBRCloudTenant](reset-vbrcloudtenant.md)

[Reset-VBRDiscoveredComputer](reset-vbrdiscoveredcomputer.md)
...
[Reset-VBRPluginCertificate](reset-vbrplugincertificate.md)

[Reset-VBRProtectionGroupCertificate](reset-vbrprotectiongroupcertificate.md)
...
[Restore-VBREntraIDTenantItemAttributes](restore-vbrentraidtenantitemattributes.md)

[Restore-VBRNASBackupFLRItem](restore-vbrnasbackupflritem.md)

[Restore-VBRUnstructuredBackupFLRItem](restore-vbrunstructuredbackupflritem.md)

Retry

[Retry-VBRCopyBackupSession](retry-vbrcopybackupsession.md)

[Retry-VBRMoveBackupSession](retry-vbrmovebackupsession.md)

Save

[Save-VBREntraIdLogsBackupFLRItem](save-vbrentraidlogsbackupflritem.md)

[Save-VBRNASBackupFLRItem](save-vbrnasbackupflritem.md)

[Save-VBRUnstructuredBackupFLRItem](save-vbrunstructuredbackupflritem.md)

Send

[Send-VBRScaleOutBackupRepositoryReport](send-vbrscaleoutbackuprepositoryreport.md)
...
[Set-ThinkSystemHost](set-thinksystemhost.md)

[Set-VBR1111SystemsS3Repository](set-vbr1111systemss3repository.md)

[Set-VBRAdCloudTenant](set-vbradcloudtenant.md)

[Set-VBRADContainer](set-vbradcontainer.md)

[Set-VBRAdvancedLatencyOptions](set-vbradvancedlatencyoptions.md)

[Set-VBRAmazonAccount](set-vbramazonaccount.md)

[Set-VBRAmazonEC2Container](set-vbramazonec2container.md)

[Set-VBRAmazonS3CompatibleRepository](set-vbramazons3compatiblerepository.md)

[Set-VBRAmazonS3ExternalRepository](set-vbramazons3externalrepository.md)

[Set-VBRAmazonS3GlacierRepository](set-vbramazons3glacierrepository.md)

[Set-VBRAmazonS3Repository](set-vbramazons3repository.md)

[Set-VBRAmazonS3Server](set-vbramazons3server.md)

[Set-VBRApplicationBackupJob](set-vbrapplicationbackupjob.md)

[Set-VBRApplicationGroup](set-vbrapplicationgroup.md)

[Set-VBRApplicationProcessingOptions](set-vbrapplicationprocessingoptions.md)
...
[Set-VBRAzureBlobAccount](set-vbrazureblobaccount.md)

[Set-VBRAzureBlobRepository](set-vbrazureblobrepository.md)

[Set-VBRAzureBlobServer](set-vbrazureblobserver.md)

[Set-VBRAzureComputeBackupCopyJob](set-vbrazurecomputebackupcopyjob.md)

[Set-VBRAzureContainer](set-vbrazurecontainer.md)

[Set-VBRAzureDataBoxRepository](set-vbrazuredataboxrepository.md)

[Set-VBRAzureExternalRepository](set-vbrazureexternalrepository.md)

[Set-VBRAzureInstantRecoverySwitchingOptions](set-vbrazureinstantrecoveryswitchingoptions.md)
...
[Set-VBRBackupCacheOptions](set-vbrbackupcacheoptions.md)

[Set-VBRBackupCopyJob](set-vbrbackupcopyjob.md)

[Set-VBRBackupCopyJobStorageOptions](set-vbrbackupcopyjobstorageoptions.md)
...
[Set-VBRCatalystCopyJob](set-vbrcatalystcopyjob.md)

[Set-VBRCDPPolicy](set-vbrcdppolicy.md)

[Set-VBRCDPPolicyRetentionOptions](set-vbrcdppolicyretentionoptions.md)

[Set-VBRCDPProxy](set-vbrcdpproxy.md)

[Set-VBRCloudCDPPolicy](set-vbrcloudcdppolicy.md)

[Set-VBRCloudFailoverPlanObject](set-vbrcloudfailoverplanobject.md)

[Set-VBRCloudGateway](set-vbrcloudgateway.md)

[Set-VBRCloudGatewayPool](set-vbrcloudgatewaypool.md)

[Set-VBRCloudProvider](set-vbrcloudprovider.md)

[Set-VBRCloudProviderCredentials](set-vbrcloudprovidercredentials.md)
...
[Set-VBRComputerBackupCopyJob](set-vbrcomputerbackupcopyjob.md)

[Set-VBRComputerBackupJob](set-vbrcomputerbackupjob.md)

[Set-VBRComputerDestinationOptions](set-vbrcomputerdestinationoptions.md)

[Set-VBRComputerFileProxyServer](set-vbrcomputerfileproxyserver.md)

[Set-VBRComputerGFSMonthlyOptions](set-vbrcomputergfsmonthlyoptions.md)

[Set-VBRComputerGFSOptions](set-vbrcomputergfsoptions.md)

[Set-VBRComputerGFSWeeklyOptions](set-vbrcomputergfsweeklyoptions.md)

[Set-VBRComputerGFSYearlyOptions](set-vbrcomputergfsyearlyoptions.md)

[Set-VBRComputerIndexingOptions](set-vbrcomputerindexingoptions.md)

[Set-VBRComputerRecoveryToken](set-vbrcomputerrecoverytoken.md)

[Set-VBRComputerWarningOptions](set-vbrcomputerwarningoptions.md)

[Set-VBRConfigurationBackupJob](set-vbrconfigurationbackupjob.md)

[Set-VBRCredentials](set-vbrcredentials.md)

[Set-VBRCSVContainer](set-vbrcsvcontainer.md)

[Set-VBRDatabaseProcessingOptions](set-vbrdatabaseprocessingoptions.md)

[Set-VBRDataCloudVaultRepository](set-vbrdatacloudvaultrepository.md)
...
[Set-VBREC2BackupCopyJob](set-vbrec2backupcopyjob.md)

[Set-VBREncryptedBackupPassword](set-vbrencryptedbackuppassword.md)

[Set-VBREncryptedTapeMediumPassword](set-vbrencryptedtapemediumpassword.md)
...
[Set-VBRFailbackSwitchingSchedule](set-vbrfailbackswitchingschedule.md)

[Set-VBRFailoverPlan](set-vbrfailoverplan.md)

[Set-VBRFailoverPlanObject](set-vbrfailoverplanobject.md)

[Set-VBRFiler](set-vbrfiler.md)

[Set-VBRFileToTapeJob](set-vbrfiletotapejob.md)

[Set-VBRFullBackupOptions](set-vbrfullbackupoptions.md)

[Set-VBRGeneralUpdateOptions](set-vbrgeneralupdateoptions.md)

[Set-VBRGFSRetentionPolicy](set-vbrgfsretentionpolicy.md)

[Set-VBRGlobalNotificationOptions](set-vbrglobalnotificationoptions.md)

[Set-VBRGoogleCloudAccount](set-vbrgooglecloudaccount.md)

[Set-VBRGoogleCloudComputeAccount](set-vbrgooglecloudcomputeaccount.md)

[Set-VBRGoogleCloudExternalRepository](set-vbrgooglecloudexternalrepository.md)

[Set-VBRGoogleCloudRepository](set-vbrgooglecloudrepository.md)

[Set-VBRHealthCheckOptions](set-vbrhealthcheckoptions.md)

[Set-VBRHistoryOptions](set-vbrhistoryoptions.md)
...
[Set-VBRHvCluster](set-vbrhvcluster.md)

[Set-VBRHvHost](set-vbrhvhost.md)

[Set-VBRHvInstantRecoveryHelperAppliance](set-vbrhvinstantrecoveryhelperappliance.md)

[Set-VBRHvIsolatedNetworkOptions](set-vbrhvisolatednetworkoptions.md)

[Set-VBRHvProductionNetworkOptions](set-vbrhvproductionnetworkoptions.md)

[Set-VBRHvReplicaJob](set-vbrhvreplicajob.md)

[Set-VBRHvScvmm](set-vbrhvscvmm.md)

[Set-VBRHvServerConfiguration](set-vbrhvserverconfiguration.md)

[Set-VBRHvServerVolume](set-vbrhvservervolume.md)

[Set-VBRHvVirtualLab](set-vbrhvvirtuallab.md)

[Set-VBRHvVirtualLabProxyAppliance](set-vbrhvvirtuallabproxyappliance.md)

[Set-VBRHvVirtualLabStaticIPMappingRule](set-vbrhvvirtuallabstaticipmappingrule.md)

[Set-VBRIBMCloudRepository](set-vbribmcloudrepository.md)

[Set-VBRImmutabilityLockExpirationDate](set-vbrimmutabilitylockexpirationdate.md)

[Set-VBRIndividualComputerContainer](set-vbrindividualcomputercontainer.md)

[Set-VBRInternetProxyUpdateOptions](set-vbrinternetproxyupdateoptions.md)

[Set-VBRIsilonHost](set-vbrisilonhost.md)
...
[Set-VBRJobAdvancedViOptions](set-vbrjobadvancedvioptions.md)
...
[Set-VBRJobScriptOptions](set-vbrjobscriptoptions.md)

[Set-VBRJobVssOptions](set-vbrjobvssoptions.md)

[Set-VBRKMSServer](set-vbrkmsserver.md)

[Set-VBRLinux](set-vbrlinux.md)

[Set-VBRLinuxFileRestoreHelperHost](set-vbrlinuxfilerestorehelperhost.md)

[Set-VBRLinuxScheduleOptions](set-vbrlinuxscheduleoptions.md)

[Set-VBRLinuxSelectedVolume](set-vbrlinuxselectedvolume.md)

[Set-VBRLinuxTrustedHostPolicy](set-vbrlinuxtrustedhostpolicy.md)

[Set-VBRLocation](set-vbrlocation.md)

[Set-VBRMacScheduleOptions](set-vbrmacscheduleoptions.md)

[Set-VBRMailNotificationConfiguration](set-vbrmailnotificationconfiguration.md)

[Set-VBRMalwareDetectionExclusion](set-vbrmalwaredetectionexclusion.md)

[Set-VBRMalwareDetectionObjectAsClean](set-vbrmalwaredetectionobjectasclean.md)

[Set-VBRMalwareDetectionOptions](set-vbrmalwaredetectionoptions.md)

[Set-VBRMongoDBBackupJob](set-vbrmongodbbackupjob.md)

[Set-VBRMongoDBContainer](set-vbrmongodbcontainer.md)

[Set-VBRMongoDBOplogProcessingOptions](set-vbrmongodboplogprocessingoptions.md)

[Set-VBRMongoDBProcessingOptions](set-vbrmongodbprocessingoptions.md)

[Set-VBRMSSQLProcessingOptions](set-vbrmssqlprocessingoptions.md)

[Set-VBRMySQLProcessingOptions](set-vbrmysqlprocessingoptions.md)

[Set-VBRNASBackupArchivalOptions](set-vbrnasbackuparchivaloptions.md)

[Set-VBRNASBackupJob](set-vbrnasbackupjob.md)

[Set-VBRNASBackupJobObject](set-vbrnasbackupjobobject.md)

[Set-VBRNASBackupSecondaryTarget](set-vbrnasbackupsecondarytarget.md)

[Set-VBRNASBackupVersionRetentionOptions](set-vbrnasbackupversionretentionoptions.md)

[Set-VBRNasFilerNFSServer](set-vbrnasfilernfsserver.md)

[Set-VBRNasFilerSMBServer](set-vbrnasfilersmbserver.md)

[Set-VBRNASFileServer](set-vbrnasfileserver.md)

[Set-VBRNASInstantRecoveryMigration](set-vbrnasinstantrecoverymigration.md)

[Set-VBRNASNFSServer](set-vbrnasnfsserver.md)
...
[Set-VBRNASSMBServer](set-vbrnassmbserver.md)

[Set-VBRNDMPServer](set-vbrndmpserver.md)

[Set-VBRNetworkTrafficRule](set-vbrnetworktrafficrule.md)

[Set-VBRNetworkTrafficRuleOptions](set-vbrnetworktrafficruleoptions.md)

[Set-VBRNotificationOptions](set-vbrnotificationoptions.md)

[Set-VBRNutanixHost](set-vbrnutanixhost.md)

[Set-VBRObjectRestorePointStatus](set-vbrobjectrestorepointstatus.md)

[Set-VBRObjectStorageBackupJob](set-vbrobjectstoragebackupjob.md)

[Set-VBRObjectStorageBackupJobObject](set-vbrobjectstoragebackupjobobject.md)

[Set-VBRObjectToTapeJob](set-vbrobjecttotapejob.md)

[Set-VBROracleProcessingOptions](set-vbroracleprocessingoptions.md)

[Set-VBROracleRMANProcessingOptions](set-vbroraclermanprocessingoptions.md)

[Set-VBRPluggableDatabasesOptions](set-vbrpluggabledatabasesoptions.md)

[Set-VBRPluginBackupCopyJob](set-vbrpluginbackupcopyjob.md)

[Set-VBRPluginCopyJobStorageOptions](set-vbrplugincopyjobstorageoptions.md)

[Set-VBRPostgreSQLProcessingOptions](set-vbrpostgresqlprocessingoptions.md)

[Set-VBRProtectionGroup](set-vbrprotectiongroup.md)

[Set-VBRProtectionGroupNotificationOptions](set-vbrprotectiongroupnotificationoptions.md)

[Set-VBRPSQLDatabaseServerLimits](set-vbrpsqldatabaseserverlimits.md)

[Set-VBRRecoveryPointObjective](set-vbrrecoverypointobjective.md)

[Set-VBRReplicaApplicationProcessingOptions](set-vbrreplicaapplicationprocessingoptions.md)

[Set-VBRRepositoryExtent](set-vbrrepositoryextent.md)

[Set-VBRRepositoryMountServerOptions](set-vbrrepositorymountserveroptions.md)
...
[Set-VBRS3CompatibleServer](set-vbrs3compatibleserver.md)

[Set-VBRS3GlacierCompatibleRepository](set-vbrs3glaciercompatiblerepository.md)

[Set-VBRSanIntegrationOptions](set-vbrsanintegrationoptions.md)

[Set-VBRSAPHANAProcessingOptions](set-vbrsaphanaprocessingoptions.md)

[Set-VBRSAPOnOracleProcessingOptions](set-vbrsaponoracleprocessingoptions.md)

[Set-VBRScaleOutBackupRepository](set-vbrscaleoutbackuprepository.md)

[Set-VBRScriptProcessingOptions](set-vbrscriptprocessingoptions.md)

[Set-VBRSecurityOptions](set-vbrsecurityoptions.md)
...
[Set-VBRServerScheduleOptions](set-vbrserverscheduleoptions.md)

[Set-VBRSimpleRetentionPolicy](set-vbrsimpleretentionpolicy.md)

[Set-VBRSNMPOptions](set-vbrsnmpoptions.md)

[Set-VBRSNMPReceiver](set-vbrsnmpreceiver.md)

[Set-VBRSQLProcessingOptions](set-vbrsqlprocessingoptions.md)

[Set-VBRStorageLatencyControlOptions](set-vbrstoragelatencycontroloptions.md)

[Set-VBRStorageOptions](set-vbrstorageoptions.md)

[Set-VBRSureBackupContentScanJob](set-vbrsurebackupcontentscanjob.md)

[Set-VBRSureBackupJob](set-vbrsurebackupjob.md)

[Set-VBRSureBackupJobScheduleOptions](set-vbrsurebackupjobscheduleoptions.md)

[Set-VBRSureBackupJobVerificationOptions](set-vbrsurebackupjobverificationoptions.md)

[Set-VBRSureBackupLinkedJob](set-vbrsurebackuplinkedjob.md)

[Set-VBRSureBackupStartupOptions](set-vbrsurebackupstartupoptions.md)

[Set-VBRSureBackupTestScript](set-vbrsurebackuptestscript.md)

[Set-VBRSureBackupVM](set-vbrsurebackupvm.md)

[Set-VBRSyntheticFullOptions](set-vbrsyntheticfulloptions.md)
...
[Set-VBRTapeMediaPoolOptions](set-vbrtapemediapooloptions.md)
...
[Set-VBRUniversalCDPPolicy](set-vbruniversalcdppolicy.md)

[Set-VBRUnstructuredBackupArchivalOptions](set-vbrunstructuredbackuparchivaloptions.md)

[Set-VBRUnstructuredBackupSecondaryTarget](set-vbrunstructuredbackupsecondarytarget.md)

[Set-VBRUnstructuredBackupVersionRetentionOptions](set-vbrunstructuredbackupversionretentionoptions.md)

[Set-VBRUploadStreamsConfiguration](set-vbruploadstreamsconfiguration.md)

[Set-VBRUserRoleAssignment](set-vbruserroleassignment.md)

[Set-VBRvCDCDPPolicy](set-vbrvcdcdppolicy.md)

[Set-VBRvCDCloudCDPPolicy](set-vbrvcdcloudcdppolicy.md)

[Set-VBRvCDCloudReplicaJob](set-vbrvcdcloudreplicajob.md)

[Set-VBRvCDCloudTenant](set-vbrvcdcloudtenant.md)

[Set-VBRvCDIndividualObjectStoragePolicy](set-vbrvcdindividualobjectstoragepolicy.md)

[Set-VBRvCDReplicaJob](set-vbrvcdreplicajob.md)

[Set-VBRvCenter](set-vbrvcenter.md)

[Set-VBRVCenterName](set-vbrvcentername.md)

[Set-VBRvCloudOrganizationJobMapping](set-vbrvcloudorganizationjobmapping.md)

[Set-VBRViApplicationGroup](set-vbrviapplicationgroup.md)

[Set-VBRViCloudHardwarePlan](set-vbrvicloudhardwareplan.md)

[Set-VBRViCloudHWPlanDatastore](set-vbrvicloudhwplandatastore.md)

[Set-VBRViCloudReplicaJob](set-vbrvicloudreplicajob.md)

[Set-VBRViLinuxProxy](set-vbrvilinuxproxy.md)

[Set-VBRViNetworkMappingRule](set-vbrvinetworkmappingrule.md)

[Set-VBRViProxy](set-vbrviproxy.md)

[Set-VBRViReplicaJob](set-vbrvireplicajob.md)

[Set-VBRViSureBackupJob](set-vbrvisurebackupjob.md)

[Set-VBRViVirtualDevice](set-vbrvivirtualdevice.md)

[Set-VBRViVirtualDeviceMappingRule](set-vbrvivirtualdevicemappingrule.md)

[Set-VBRViVirtualLab](set-vbrvivirtuallab.md)

[Set-VBRViVirtualLabIPMappingRule](set-vbrvivirtuallabipmappingrule.md)

[Set-VBRViVirtualLabNetworkOptions](set-vbrvivirtuallabnetworkoptions.md)

[Set-VBRViVirtualLabProxyAppliance](set-vbrvivirtuallabproxyappliance.md)

[Set-VBRVmBiosUuid](set-vbrvmbiosuuid.md)

[Set-VBRVMExclusion](set-vbrvmexclusion.md)

[Set-VBRWindowsWorkstationScheduleOptions](set-vbrwindowsworkstationscheduleoptions.md)

[Set-VBRWinServer](set-vbrwinserver.md)
...
[Start-VBRApplicationBackupJob](start-vbrapplicationbackupjob.md)

[Start-VBRArchiveTierSync](start-vbrarchivetiersync.md)
...
[Start-VBRCapacityTierSync](start-vbrcapacitytiersync.md)

[Start-VBRCatalystCopyJob](start-vbrcatalystcopyjob.md)

[Start-VBRCDPLinuxFileRestore](start-vbrcdplinuxfilerestore.md)

[Start-VBRCDPReplicaFailback](start-vbrcdpreplicafailback.md)

[Start-VBRCDPReplicaFailover](start-vbrcdpreplicafailover.md)

[Start-VBRCDPWindowsFileRestore](start-vbrcdpwindowsfilerestore.md)

[Start-VBRCloudTapeRestore](start-vbrcloudtaperestore.md)

[Start-VBRCloudTenantBackupEvacuation](start-vbrcloudtenantbackupevacuation.md)

[Start-VBRComputerBackupJob](start-vbrcomputerbackupjob.md)

[Start-VBRComputerVolumeRestore](start-vbrcomputervolumerestore.md)

[Start-VBRConfigurationBackupJob](start-vbrconfigurationbackupjob.md)

[Start-VBRDownloadBackup](start-vbrdownloadbackup.md)

[Start-VBRDownloadBackupFile](start-vbrdownloadbackupfile.md)

[Start-VBRDownloadTenantBackup](start-vbrdownloadtenantbackup.md)

[Start-VBREntraIdDBRepositoryRescan](start-vbrentraiddbrepositoryrescan.md)

[Start-VBREntraIdLogsBackupFLRSession](start-vbrentraidlogsbackupflrsession.md)

[Start-VBREntraIDTenantBackupJob](start-vbrentraidtenantbackupjob.md)
...
[Start-VBRFCDInstantRecovery](start-vbrfcdinstantrecovery.md)

[Start-VBRFCDInstantRecoveryMigration](start-vbrfcdinstantrecoverymigration.md)

[Start-VBRHighAvailabilityClusterFailover](start-vbrhighavailabilityclusterfailover.md)

[Start-VBRHighAvailabilityClusterSwitchover](start-vbrhighavailabilityclusterswitchover.md)
...
[Start-VBRLinuxGuestItemRestore](start-vbrlinuxguestitemrestore.md)

[Start-VBRNASBackupFLRSession](start-vbrnasbackupflrsession.md)

[Start-VBRNASBackupHealthCheck](start-vbrnasbackuphealthcheck.md)

[Start-VBRNasBackupRestore](start-vbrnasbackuprestore.md)
...
[Start-VBRNDMPVolumeRestore](start-vbrndmpvolumerestore.md)

[Start-VBRObjectStorageBackupRestore](start-vbrobjectstoragebackuprestore.md)

[Start-VBROffloadBackupFile](start-vbroffloadbackupfile.md)

[Start-VBRQuickBackup](start-vbrquickbackup.md)

[Start-VBRQuickMigration](start-vbrquickmigration.md)

[Start-VBRReplicaFailover](start-vbrreplicafailover.md)
...
[Start-VBRScaleOutBackupRepositoryRebalance](start-vbrscaleoutbackuprepositoryrebalance.md)

[Start-VBRScanBackup](start-vbrscanbackup.md)
...
[Start-VBRTapeCopy](start-vbrtapecopy.md)

[Start-VBRTapeFileRestore](start-vbrtapefilerestore.md)

[Start-VBRTapeInventory](start-vbrtapeinventory.md)

[Start-VBRTapeObjectStorageRestore](start-vbrtapeobjectstoragerestore.md)

[Start-VBRTapeRestore](start-vbrtaperestore.md)

[Start-VBRTapeRestoreAllContent](start-vbrtaperestoreallcontent.md)

[Start-VBRTapeRestoreFiles](start-vbrtaperestorefiles.md)

[Start-VBRTapeVerification](start-vbrtapeverification.md)

[Start-VBRUnstructuredBackupFLRSession](start-vbrunstructuredbackupflrsession.md)

[Start-VBRUnstructuredBackupHealthCheck](start-vbrunstructuredbackuphealthcheck.md)

[Start-VBRvCDCDPReplicaFailback](start-vbrvcdcdpreplicafailback.md)

[Start-VBRvCDCDPReplicaFailover](start-vbrvcdcdpreplicafailover.md)

[Start-VBRvCDReplicaFailback](start-vbrvcdreplicafailback.md)

[Start-VBRvCDReplicaFailover](start-vbrvcdreplicafailover.md)

[Start-VBRvCDReplicaJob](start-vbrvcdreplicajob.md)

[Start-VBRvCloudInstantRecovery](start-vbrvcloudinstantrecovery.md)

[Start-VBRvCloudQuickMigration](start-vbrvcloudquickmigration.md)

[Start-VBRvCloudRestoreVApp](start-vbrvcloudrestorevapp.md)

[Start-VBRvCloudRestoreVm](start-vbrvcloudrestorevm.md)

[Start-VBRViComputerInstantRecovery](start-vbrvicomputerinstantrecovery.md)

[Start-VBRViInstantRecoveryDiskMigration](start-vbrviinstantrecoverydiskmigration.md)

[Start-VBRViInstantRecoveryMigration](start-vbrviinstantrecoverymigration.md)

[Start-VBRViInstantVMDiskRecovery](start-vbrviinstantvmdiskrecovery.md)

[Start-VBRViReplicaFailback](start-vbrvireplicafailback.md)

[Start-VBRViReplicaFailover](start-vbrvireplicafailover.md)

[Start-VBRViVirtualDiskRestore](start-vbrvivirtualdiskrestore.md)

[Start-VBRViVMMigration](start-vbrvivmmigration.md)

[Start-VBRVMRestoreToAmazon](start-vbrvmrestoretoamazon.md)
...
[Stop-VBRApplicationBackupJob](stop-vbrapplicationbackupjob.md)

[Stop-VBRAzureInstantRecovery](stop-vbrazureinstantrecovery.md)

[Stop-VBRBackupCopyJob](stop-vbrbackupcopyjob.md)

[Stop-VBRCDPReplicaFailback](stop-vbrcdpreplicafailback.md)

[Stop-VBRCDPReplicaFailover](stop-vbrcdpreplicafailover.md)

[Stop-VBRCloudTapeRestore](stop-vbrcloudtaperestore.md)

[Stop-VBRCloudTenantNetworkAppliance](stop-vbrcloudtenantnetworkappliance.md)

[Stop-VBRComputerBackupJob](stop-vbrcomputerbackupjob.md)

[Stop-VBRCopyBackupSession](stop-vbrcopybackupsession.md)

[Stop-VBREntraIdLogsBackupFLRSession](stop-vbrentraidlogsbackupflrsession.md)

[Stop-VBREntraIDTenantBackupJob](stop-vbrentraidtenantbackupjob.md)

[Stop-VBREntraIDTenantItemRestoreSession](stop-vbrentraidtenantitemrestoresession.md)

[Stop-VBREntraIDTenantRestore](stop-vbrentraidtenantrestore.md)

[Stop-VBRFCDInstantRecovery](stop-vbrfcdinstantrecovery.md)

[Stop-VBRHvReplicaFailback](stop-vbrhvreplicafailback.md)

[Stop-VBRInstantRecovery](stop-vbrinstantrecovery.md)

[Stop-VBRInstantRecoveryMigration](stop-vbrinstantrecoverymigration.md)

[Stop-VBRJob](stop-vbrjob.md)

[Stop-VBRLinuxFileRestore](stop-vbrlinuxfilerestore.md)

[Stop-VBRLinuxGuestItemRestore](stop-vbrlinuxguestitemrestore.md)

[Stop-VBRMoveBackupSession](stop-vbrmovebackupsession.md)

[Stop-VBRNASBackupFLRSession](stop-vbrnasbackupflrsession.md)

[Stop-VBRNASInstantRecovery](stop-vbrnasinstantrecovery.md)

[Stop-VBRReplicaFailover](stop-vbrreplicafailover.md)

[Stop-VBRSession](stop-vbrsession.md)

[Stop-VBRSureBackupJob](stop-vbrsurebackupjob.md)

[Stop-VBRUnstructuredBackupFLRItemComparison](stop-vbrunstructuredbackupflritemcomparison.md)

[Stop-VBRUnstructuredBackupFLRSession](stop-vbrunstructuredbackupflrsession.md)

[Stop-VBRvCDCDPReplicaFailback](stop-vbrvcdcdpreplicafailback.md)

[Stop-VBRvCDCDPReplicaFailover](stop-vbrvcdcdpreplicafailover.md)

[Stop-VBRvCDReplicaFailback](stop-vbrvcdreplicafailback.md)

[Stop-VBRvCDReplicaFailover](stop-vbrvcdreplicafailover.md)

[Stop-VBRvCDReplicaJob](stop-vbrvcdreplicajob.md)

[Stop-VBRViInstantVMDiskRecovery](stop-vbrviinstantvmdiskrecovery.md)

[Stop-VBRViReplicaFailback](stop-vbrvireplicafailback.md)

[Stop-VBRVMRestoreToAmazon](stop-vbrvmrestoretoamazon.md)

[Stop-VBRVMRestoreToAzure](stop-vbrvmrestoretoazure.md)

[Stop-VBRVMRestoreToGoogleCloud](stop-vbrvmrestoretogooglecloud.md)

[Stop-VBRWindowsFileRestore](stop-vbrwindowsfilerestore.md)

[Stop-VBRWindowsGuestItemRestore](stop-vbrwindowsguestitemrestore.md)

[Stop-VSBJob](stop-vsbjob.md)

Switch

[Switch-VBRAzureInstantRecoveryMigration](switch-vbrazureinstantrecoverymigration.md)

[Switch-VBRCloudTenantsQuotaRepositoryToSOBR](switch-vbrcloudtenantsquotarepositorytosobr.md)
...
[Sync-HyperFlexHost](sync-hyperflexhost.md)
...
[Sync-ThinkSystemHost](sync-thinksystemhost.md)

[Sync-ThinkSystemVolume](sync-thinksystemvolume.md)
...
[Sync-VBRCloudTenantResource](sync-vbrcloudtenantresource.md)

[Sync-VBRComputerBackupCopyJob](sync-vbrcomputerbackupcopyjob.md)

[Sync-VBRFileToTapeJob](sync-vbrfiletotapejob.md)

[Sync-VBRIsilonHost](sync-vbrisilonhost.md)

[Sync-VBRIsilonVolume](sync-vbrisilonvolume.md)

[Sync-VBRNASBackupMetadata](sync-vbrnasbackupmetadata.md)

[Sync-VBRNutanixHost](sync-vbrnutanixhost.md)

[Sync-VBRNutanixVolume](sync-vbrnutanixvolume.md)

[Sync-VBRObjectToTapeJob](sync-vbrobjecttotapejob.md)

[Sync-VBRSOBREntityState](sync-vbrsobrentitystate.md)

[Sync-VBRUnstructuredBackupMetadata](sync-vbrunstructuredbackupmetadata.md)
...
[Test-VBRMailNotificationConfiguration](test-vbrmailnotificationconfiguration.md)
...
[Uninstall-VBRCDPFilter](uninstall-vbrcdpfilter.md)

[Uninstall-VBRDiscoveredComputerAgent](uninstall-vbrdiscoveredcomputeragent.md)

[Uninstall-VBRDiscoveredComputerCDPAgent](uninstall-vbrdiscoveredcomputercdpagent.md)

[Uninstall-VBRDiscoveredComputerPlugin](uninstall-vbrdiscoveredcomputerplugin.md)

[Uninstall-VBRLicense](uninstall-vbrlicense.md)

[Uninstall-VBRLinuxTransportService](uninstall-vbrlinuxtransportservice.md)

[Uninstall-VBRServerComponent](uninstall-vbrservercomponent.md)

[Uninstall-VBRvCDCDPFilter](uninstall-vbrvcdcdpfilter.md)

Unmount

[Unmount-VBRObjectStorageRepository](unmount-vbrobjectstoragerepository.md)

Unpublish

[Unpublish-VBRBackupContent](unpublish-vbrbackupcontent.md)

Update

[Update-VBRLicense](update-vbrlicense.md)

[Update-VBRNasBackupPath](update-vbrnasbackuppath.md)

[Update-VBRServerComponent](update-vbrservercomponent.md)

[Update-VBRUnstructuredBackupPath](update-vbrunstructuredbackuppath.md)

Upgrade

[Upgrade-VBRBackup](upgrade-vbrbackup.md)
