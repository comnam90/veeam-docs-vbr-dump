---
title: "Working with Scale-Out Backup Repositories"
source_url: "https://helpcenter.veeam.com/docs/vbr/powershell/sobr_operations.html"
last_updated: "1/25/2024"
product_version: "13.0.1.1071"
---

# Working with Scale-Out Backup Repositories

In this article

You can use the cmdlets in this topic to perform the following operations:

| Cmdlet / Folder | Operation |
| --- | --- |
| [Add-VBRScaleOutBackupRepository](add-vbrscaleoutbackuprepository.md) | Adds scale-out backup repositories to Veeam Backup & Replication. |
