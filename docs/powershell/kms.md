...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBRKMSServer](add-vbrkmsserver.md) | Adds KMS servers to the Veeam Backup & Replication console. |
| [Get-VBRKMSServer](get-vbrkmsserver.md) | Returns KMS servers added to the Veeam Backup & Replication console. |
