...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBRGoogleCloudAccount](add-vbrgooglecloudaccount.md) | Creates Google Cloud credentials records. |
| [Get-VBRGoogleCloudAccount](get-vbrgooglecloudaccount.md) | Returns the array of Google Cloud credentials records. |
