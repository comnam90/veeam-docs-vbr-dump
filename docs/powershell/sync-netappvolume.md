---
title: "Sync-NetAppVolume"
source_url: "https://helpcenter.veeam.com/docs/vbr/powershell/sync-netappvolume.html"
...
Run the [Sync-NetAppHost](sync-netapphost.md) cmdlet to rescan an entire NetApp storage system.

|  |
| --- |
| ![Sync-NetAppVolume](images/icon_note.webp) Note: |
...
| --- | --- | --- | --- | --- | --- |
| Volume | Specifies an array of storage volumes that you want to rescan. | Accepts the CSanVolume[] object. To get this object, run the [Get-NetAppVolume](get-netappvolume.md) cmdlet. | True | Named | True (ByValue, ByProperty Name) |
...
1. Run the [Get-NetAppVolume](get-netappvolume.md) cmdlet. Specify the Name parameter value. Save the result to the $volume variable.
