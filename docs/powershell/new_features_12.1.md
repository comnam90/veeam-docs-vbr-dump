...
In this version, you can run the [New-VBRDecryptionSet](new-vbrdecryptionset.md) cmdlet to define security settings, manage encryption keys and decrypt data encrypted with the KMS server.
...
|  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| New Cmdlets  | Cmdlet | Operation | | [Add-VBRKMSServer](add-vbrkmsserver.md) | Adds KMS servers to the Veeam Backup & Replication console. | | [Get-VBRKMSServer](get-vbrkmsserver.md) | Returns KMS servers added to the Veeam Backup & Replication console. | | [Set-VBRKMSServer](set-vbrkmsserver.md) | Modifies settings of KMS servers. | | [Remove-VBRKMSServer](remove-vbrkmsserver.md) | Removes KMS servers from the Veeam Backup & Replication console. | |
...
|  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| New Cmdlets  | Cmdlet | Operation | | [Add-VBRSyslogServer](add-vbrsyslogserver.md) | Adds a syslog server to Veeam Backup & Replication. | | [Set-VBRSyslogServer](set-vbrsyslogserver.md) | Modifies syslog server settings. | | [Get-VBRSyslogServer](get-vbrsyslogserver.md) | Returns syslog server settings. | | [Remove-VBRSyslogServer](remove-vbrsyslogserver.md) | Removes a syslog server. | |
...
|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| New Cmdlets  | Cmdlet | Operation | | Enable-VBRIndependentRetention | Enables previously disabled background retention for backups. | | Disable-VBRIndependentRetention | Disables background retention for backups. | |
...
|  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| New Cmdlets  | Cmdlet | Operation | | [Add-VBRObjectToTapeJob](add-vbrobjecttotapejob.md) | Creates an object to tape job. | | [Set-VBRObjectToTapeJob](set-vbrobjecttotapejob.md) | Modifies an object to tape job. | | [Start-VBRTapeObjectStorageRestore](start-vbrtapeobjectstoragerestore.md) | Starts the restore of objects from tape. | |
