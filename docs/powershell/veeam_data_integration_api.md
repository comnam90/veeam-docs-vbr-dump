...
| Cmdlet | Operation |
| --- | --- |
| [Publish-VBRBackupContent](publish-vbrbackupcontent.md) | Publishes disks from a backup or replica using the iSCSI or FUSE protocol. |
| [Get-VBRPublishedBackupContentSession](get-vbrpublishedbackupcontentsession.md) | Returns sessions that are running to publish disks from a backup or replica. |
