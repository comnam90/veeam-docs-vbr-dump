...
| Cmdlet | Operation |
| --- | --- |
| [Install-VBRDiscoveredComputerPlugin](install-vbrdiscoveredcomputerplugin.md) | Installs Veeam Plug-Ins on discovered computers. |
| [Uninstall-VBRDiscoveredComputerPlugin](uninstall-vbrdiscoveredcomputerplugin.md) | Removes Veeam Plug-In from a specific computer. |
