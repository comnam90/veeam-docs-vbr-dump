...
| Cmdlet | Operation |
| --- | --- |
| [Add-HyperFlexHost](add-hyperflexhost.md) | Adds Cisco HyperFlex storage systems to the backup infrastructure. |
| [Get-HyperFlexHost](get-hyperflexhost.md) | Returns Cisco HyperFlex storage systems. |
| [Set-HyperFlexHost](set-hyperflexhost.md) | Modifies Cisco HyperFlex storage settings. |
