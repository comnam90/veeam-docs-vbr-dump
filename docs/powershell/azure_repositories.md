...
| [New-VBRAzureComputeProxyAppliance](new-vbrazurecomputeproxyappliance.md) | Adds Azure compute proxy appliance to Veeam Backup & Replication. |
| [Set-VBRAzureBlobRepository](set-vbrazureblobrepository.md) | Modifies settings of Azure Blob storage repository added to Veeam Backup & Replication. |
