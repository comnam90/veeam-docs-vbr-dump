...
| Cmdlet | Operation |
| --- | --- |
| [Get-VBRGoogleCloudRegion](get-vbrgooglecloudregion.md) | Returns the array of geographic locations for the Google Cloud object storage. |
| [Get-VBRGoogleCloudBucket](get-vbrgooglecloudbucket.md) | Returns the array of Google Cloud buckets. |
