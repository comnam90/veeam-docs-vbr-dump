...
|  |
| --- |
| Start-VBRNasBackupRestore -RestorePoint <VBRNASBackupRestorePoint> [-PreservePermissions] [-RollBack] [-OverwriteMode <VBRNASBackupRestoreOverwriteMode>] [-RunAsync] [-Force] [-RetrievalSettings <VBRUnstructuredBackupColdStorageRetrievalSettings>]  [<CommonParameters>] |

* Starts restore of backups created by the file backup job to another location.

|  |
| --- |
| Start-VBRNasBackupRestore -RestorePoint <VBRNASBackupRestorePoint> -DestinationServer <VBRNASServer> -DestinationFolderPath <String> [-PreservePermissions] [-PreserveHierarchy] [-RollBack] [-OverwriteMode <VBRNASBackupRestoreOverwriteMode>] [-RunAsync] [-Force] [-RetrievalSettings <VBRUnstructuredBackupColdStorageRetrievalSettings>]  [<CommonParameters>] |
...
| Force | Defines that the cmdlet will restore backups created by the file backup job without showing warnings in the PowerShell console. | SwitchParameter | False | Named | False |
