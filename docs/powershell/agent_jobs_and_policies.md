...
* [Veeam Agent Management Backup Jobs](veeam_agent_management_backup_jobs.md)
* [Veeam Agent Job Target Settings](veeam_agent_job_target_settings.md)
* [Veeam Agent Job Backup Scope](veeam_agent_job_backup_scope.md)
