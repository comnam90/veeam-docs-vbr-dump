...
| [Add-VBRvCDCloudCDPPolicy](add-vbrvcdcloudcdppolicy.md) | Creates a VDC CDP policy. |
| [Set-VBRvCDCloudCDPPolicy](set-vbrvcdcloudcdppolicy.md) | Modifies a VDC CDP policy. |
