...
product: "vbr"
doc_type: "powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/powershell/enable-vbrtapedrive.html"
...
Run the [Disable-VBRTapeDrive](disable-vbrtapedrive.md) cmdlet to disable a tape drive.

Parameters

| Parameter | Description | Type | Required | Position | Accept |
| --- | --- | --- | --- | --- | --- |
| Drive | Specifies the array of drives. The cmdlet will enable these drives. | Accepts the [VBRTapeDrive[]](vbrtapedrive.md) object. To get this object, run the [Get-VBRTapeDrive](get-vbrtapedrive.md) cmdlet. | True | Named | True (ByValue, ByProperty Name) |
