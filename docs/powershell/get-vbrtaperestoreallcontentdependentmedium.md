...
product: "vbr"
doc_type: "powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/powershell/get-vbrtaperestoreallcontentdependentmedium.html"
...
This cmdlet returns dependent tapes that store other parts of the backup. You may want to run this cmdlet before you start the [Start-VBRTapeCopy](start-vbrtapecopy.md) cmdlet, to get information on the dependent tapes.
