...
| --- |
| Note |
| Scale-out backup repositories require Enterprise or Enterprise Plus, Veeam Universal License product edition. |

In this section

* [Working with Scale-Out Backup Repositories](sobr_operations.md)
* [Performance Tier](sobr_performance_tier.md)
