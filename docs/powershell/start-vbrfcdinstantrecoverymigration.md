...
| TargetDatastore | Specifies a target datastore to which you want to migrate FCDs.  Note: The datastore must be located in the same vCenter, where a cluster to to which Veeam Backup & Replication will register FCDs, is located. | Accepts the VBRViDatastore object. To create this object, run the [Find-VBRViDatastore](find-vbrvidatastore.md) cmdlet. | True | 1 | False |
