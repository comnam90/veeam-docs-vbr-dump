...
| Cmdlet | Operation |
| --- | --- |
| [Start-VBRRestoreVM](start-vbrrestorevm.md) | Starts restore of the entire VMware VM. |
| [Start-VBRHvRestoreVM](start-vbrhvrestorevm.md) | Starts restore of the entire Hyper-V VM. |
