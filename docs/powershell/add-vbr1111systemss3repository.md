---
title: "Add-VBR1111SystemsS3Repository"
...
Adds the 11:11 Cloud object storage repository to the backup infrastructure.
...
This cmdlet adds the 11:11 Cloud object storage repository to the backup infrastructure.
...
Adding 11:11 Cloud Object Storage Repository to Backup Infrastructure

This example shows how to add 11:11 cloud object storage repository to the backup infrastructure. The repository will have the following settings:
...
5. Run the Add-VBR1111SystemsS3Repository cmdlet. Specify the following settings:
