...
|  |
| --- |
| ![WAN Acceleration](images/icon_note.webp) Note: |
| WAN acceleration requires Enterprise Plus, Veeam Universal License product edition. |

In This Section

| Cmdlet | Operation |
| --- | --- |
| [Add-VBRWANAccelerator](add-vbrwanaccelerator.md) | Creates a WAN accelerator |
| [Get-VBRWANAccelerator](get-vbrwanaccelerator.md) | Looks for existing WAN accelerators |
