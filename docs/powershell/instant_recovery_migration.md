...
| Cmdlet | Operation |
| --- | --- |
| [Start-VBRViInstantRecoveryMigration](start-vbrviinstantrecoverymigration.md) | Starts VMs quick migration to specified ESXi host. |
| [Start-VBRHvInstantRecoveryMigration](start-vbrhvinstantrecoverymigration.md) | Performs migration of instantly recovered VMs to a Hyper-V host. |
