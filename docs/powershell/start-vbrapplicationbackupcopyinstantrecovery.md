...
| Server | Specifies the application backup repository host on which Veeam Backup & Replication will mount the restore point data via NFS. | Accepts the CHost object. To get this object, run the [Get-VBRServer](get-vbrserver.md) cmdlet. | True | Named | False |
