...
| --- | --- | --- |
| Properties | VBREntraIDTenantItemComparisonProperty[] | Array of all or changed properties of a tenant item. |
| References | VBREntraIDTenantItemComparisonReference[] | Array of all or changed references of a tenant item. |
