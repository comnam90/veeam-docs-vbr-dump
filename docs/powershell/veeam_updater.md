...
| [Get-VBRInternetProxyUpdateOptions](get-vbrinternetproxyupdateoptions.md) | Returns internet proxy update settings. |
| [New-VBRMaintenanceWindowOptions](new-vbrmaintenancewindowoptions.md) | Configures a maintenance window for automatic update installation. |
| [Set-VBRGeneralUpdateOptions](set-vbrgeneralupdateoptions.md) | Modifies general update settings for the Linux-based backup server and Veeam Infrastructure Appliances. |
| [Set-VBRInternetProxyUpdateOptions](set-vbrinternetproxyupdateoptions.md) | Modifies internet proxy update settings. |
