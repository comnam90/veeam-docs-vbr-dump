...
* [Discovered Computers](plugin_management_computers.md)
* [Application Backup Policies](plugin_management_policies_manage.md)
* [Application Backup Policy Settings for Veeam Plug-In for Oracle RMAN](plugin_management_policies_rman.md)
* [Application Backup Policy Settings for Veeam Plug-In for SAP HANA](plugin_management_policies_sap_hana.md)
