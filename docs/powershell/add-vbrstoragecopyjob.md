...
product: "vbr"
doc_type: "powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/powershell/add-vbrstoragecopyjob.html"
last_updated: "2026"
...
|  |
| --- |
| Add-VBRStorageCopyJob [-Name] <String> [-BackupWindowOptions <VBRBackupWindowOptions>] [-Description <String>] [-EnableHealthCheck] [-Force] [-KeepSecondaryCopies] [-NotificationOptions <VBRNotificationOptions>] [-ScriptOptions <VBRJobScriptOptions>] [-SecondaryCopiesRetentionPeriod <Int32>] -SourceRepository <CBackupRepository[]> -TargetRepository <CBackupRepository[]> [<CommonParameters>] |
