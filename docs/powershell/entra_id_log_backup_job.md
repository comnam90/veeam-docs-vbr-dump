...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBREntraIDLogsBackupJob](add-vbrentraidlogsbackupjob.md) | Creates a Microsoft Entra ID log backup job. |
| [Get-VBREntraIDLogsBackupJob](get-vbrentraidlogsbackupjob.md) | Returns Microsoft Entra ID log backup jobs. |
