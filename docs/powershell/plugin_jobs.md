...
| Cmdlet | Operation |
| --- | --- |
| [Get-VBRPluginJob](get-vbrpluginjob_standalone.md) | Returns backup jobs that were created with standalone Veeam Plug-Ins and backup copy jobs of backups created with Veeam Plug-Ins. |
| [Remove-VBRPluginJob](remove-vbrpluginjob_standalone.md) | Removes backup jobs that were created with standalone Veeam Plug-Ins and backup copy jobs of backups created with Veeam Plug-Ins from the Veeam Backup & Replication infrastructure. |
