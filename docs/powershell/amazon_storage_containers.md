...
| Cmdlet | Operation |
| --- | --- |
| [Get-VBRAmazonS3Region](get-vbramazons3region.md) | Returns the array of geographic locations for the Amazon S3 object storage. |
| [Get-VBRAmazonS3Bucket](get-vbramazons3bucket.md) | Returns the array of Amazon S3 buckets. |
