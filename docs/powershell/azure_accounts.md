...
| Cmdlet | Operation |
| --- | --- |
| [Add-VBRAzureBlobAccount](add-vbrazureblobaccount.md) | Creates Azure Blob credentials records. |
| [Get-VBRAzureBlobAccount](get-vbrazureblobaccount.md) | Returns the array of the Azure Blob credentials records. |
