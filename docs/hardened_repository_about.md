...
* Image-level virtual machine backups and backup copies (VMware, Hyper-V, Cloud Director, Nutanix AHV, OLVM, Proxmox and RHV)
...
* [How Immutability Works](hardened_repository_immutability.md)
