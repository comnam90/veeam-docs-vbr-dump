...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agents_protection_group_advanced_notify_web.html"
last_updated: "2026"
...
3. Enable the Send email notifications to the following recipients option and specify a recipient’s email address. You can enter several addresses separated by a semicolon.
...
To configure a custom notification for the protection group, select Use custom notification settings. You can specify the following notification settings:
...
[![Specify Notifications Settings](images/protection_group_notify_web.webp)](images/protection_group_notify_web.webp "Specify Notifications Settings")
