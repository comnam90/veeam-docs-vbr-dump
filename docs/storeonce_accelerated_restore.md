...
| --- |
| Note |
| To further accelerate the process of restore, Veeam Backup & Replication reads VM data from HPE StoreOnce in multiple threads. |
...
The accelerated restore of entire VM and restore to Microsoft Azure have the following limitations:
