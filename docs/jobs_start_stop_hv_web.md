...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/jobs_start_stop_hv_web.html"
...
[![Starting and Stopping Jobs](images/start_backup_job_hv_web.webp)](images/start_backup_job_hv_web.webp)
...
1. In the management pane, click the Jobs node.
2. In the working area, right-click the job and select Stop. In the displayed window, click Gracefully.

[![Starting and Stopping Jobs](images/stop_job_hv_web.webp)](images/stop_job_hv_web.webp)
