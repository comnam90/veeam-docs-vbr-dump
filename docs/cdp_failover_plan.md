...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/cdp_failover_plan.html"
...
When you perform failback or permanent failover, you need to process each VM individually. For more information, see [Performing Failback](cdp_performing_failback.md) and [Performing Permanent Failover](cdp_performing_perm_failover.md). When you undo failover, you can process the whole group. For more information, see [Undoing Failover by Failover Plans](failover_plan_undo.md).

Related Topics

* [Creating Failover Plans](cdp_creating_failover_plans.md)
* [Running Failover Plans](cdp_running_failover_plans.md)
* [Undoing Failover by Failover Plans](cdp_failover_plan_undo.md)
