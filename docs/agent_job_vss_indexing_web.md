...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_job_vss_indexing_web.html"
last_updated: "2026"
...
* Select Index everything if you want to index all files within the backup scope that you have specified at the [Backup Mode](agent_job_mode_web.md) step of the wizard. Veeam Agent for Microsoft Windows will index all files that reside:
...
[![Specify Indexing Settings](images/agent_job_vss_indexing_web.webp)](images/agent_job_vss_indexing_web.webp "Specify Indexing Settings")
