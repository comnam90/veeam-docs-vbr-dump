...
Sent when a user updates High Availability cluster settings. For more information, see [Editing High Availability Cluster Settings](https://helpcenter.veeam.com/docs/vbr/userguide/high_availbility_cluster_editing.html).
