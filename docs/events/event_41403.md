...
Sent when a user starts the storage system rescan manually. For more information, see [Rescan (Storage Discovery) Process](https://helpcenter.veeam.com/docs/vbr/userguide/storage_discovery_process.html).
