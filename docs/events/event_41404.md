...
Sent when the storage system rescan starts automatically. For more information, see [Rescan (Storage Discovery) Process](https://helpcenter.veeam.com/docs/vbr/userguide/storage_discovery_process.html).
