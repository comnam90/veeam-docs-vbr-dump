...
Sent when a user performs failover for the High Availability cluster. For more information, see [Failover](https://helpcenter.veeam.com/docs/vbr/userguide/high_availability_failover.html).
