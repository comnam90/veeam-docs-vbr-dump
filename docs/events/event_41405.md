...
Sent when a storage system rescan session is finished. For more information, see [Rescan (Storage Discovery) Process](https://helpcenter.veeam.com/docs/vbr/userguide/storage_discovery_process.html).
