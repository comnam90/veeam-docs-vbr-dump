...
Sent when a user disables proactive technical support services and diagnostic data sharing. For more information, see [Viewing License Information](https://helpcenter.veeam.com/docs/vbr/userguide/license_view.html).
