...
Sent when a machine is automatically marked as clean if no malware activities were found during the proactive signature-based scan session. For more information, see [Signature Detection](https://helpcenter.veeam.com/docs/vbr/userguide/malware_detection_signature_detection.html).
