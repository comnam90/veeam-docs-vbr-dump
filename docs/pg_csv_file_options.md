...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pg_csv_file_options.html"
...
|  |
| --- |
| ![Step 5. Specify Discovery and Deployment Options](images/icon_note.webp) NOTE |
...
2. Click Advanced to specify advanced settings for the protection group. To learn more, see [Specify Advanced Protection Group Settings](pg_csv_file_advanced.md).

![Step 5. Specify Discovery and Deployment Options](images/pg_csv_options.webp "Specify Discovery and Deployment Options")
