...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_backup_job_create_assign_vms_web.html"
last_updated: "2026"
...
At the Sources step of the wizard, specify the backup scope — resources that Veeam Backup & Replication will back up.
...
[![Select VMs to Back Up](images/pve_backup_job_create_assign_vms_web.webp)](images/pve_backup_job_create_assign_vms_web.webp "Select VMs to Back Up")
...
[![Select Disks and Volume Groups](images/pve_backup_job_create_disk_excludes_web.webp)](images/pve_backup_job_create_disk_excludes_web.webp "Select Disks and Volume Groups")
