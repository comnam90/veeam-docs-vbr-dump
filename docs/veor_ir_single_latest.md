...
To perform instant recovery to the latest state on the backup file, perform the following steps:

1. [Launch the Instant Recovery wizard](veor_ir_single_latest_wizard.md).
