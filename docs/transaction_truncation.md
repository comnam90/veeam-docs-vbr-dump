...
![Transaction Log Truncation](images/truncate_logs.webp)
...
You can choose to back up logs with Veeam Backup & Replication. For more information, see [Microsoft SQL Server Log Backup](sql_backup.md) and [Oracle Log Backup](oracle_backup.md).
