...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_restore_how_flr.html"
...
1. Mounts the disks of the backed-up VM to the [mount server](guest_file_recovery.md) specified for the recovery operation.
...
To learn how to recover individual VM files and folders, see [Performing File-Level Restore](hpe_vm_guest_restore.md).
