...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vesql_export_mdf_single_pit_restore_point.html"
...
At this step of the wizard, select a state as of which you want to export your database:
