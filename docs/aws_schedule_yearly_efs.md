...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_schedule_yearly_efs.html"
last_updated: "2026"
...
If a restore point is older than the specified time limit, the backup appliance removes the restore from the chain. For more information, see [EFS Backup Retention](aws_retention_backup_efs.md).
...
[![Creating EFS Backup Policy](images/aws_schedule_yearly_efs.webp)](images/aws_schedule_yearly_efs.webp "Creating EFS Backup Policy")
