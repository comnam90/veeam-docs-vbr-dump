...
1. (Optional) Convert the snapshot clones from thin to thick provisioning to prevent data loss after removing the storage system from Veeam Backup & Replication.
2. Start the InterSystems IRIS instance.
