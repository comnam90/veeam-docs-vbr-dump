...
* Veeam Backup & Replication on Microsoft Windows uses Data Protection API (DPAPI). For more information, see [Microsoft Docs](https://learn.microsoft.com/en-us/dotnet/standard/security/how-to-use-data-protection).
