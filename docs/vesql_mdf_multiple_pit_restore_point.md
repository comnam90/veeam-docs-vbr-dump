...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vesql_mdf_multiple_pit_restore_point.html"
...
* Select the Restore to a specific point in time option to load data as of the specified point in time.
...
![Step 3. Specify Restore Point](images/export_mult_pit.webp "Specifying Restore Point")
