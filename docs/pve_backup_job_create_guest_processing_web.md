...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_backup_job_create_guest_processing_web.html"
last_updated: "2026"
...
* [Enable application-aware processing](pve_backup_job_create_gp_applications_web.md) — to create transactionally consistent backups that will guarantee proper recovery of VM applications, without data loss.
...
* [Enable guest file system indexing and malware detection](pve_backup_job_create_gp_indexing_web.md) — to create a catalog of guest OS files that will allow you to search for specific items during file-level restore. This will also allow you to receive reports about malware files and suspicious system activity detected on VMs included into the backup scope.
* [Choose guest interaction proxies](pve_backup_job_create_gp_proxy_web.md) — to select specific servers that Veeam Backup & Replication will use when communicating with guest OSes of VMs included into the backup scope.
* [Manage VM guest OS credentials](pve_backup_job_create_gp_credentials_web.md) — to specify credentials that Veeam Backup & Replication will use to access guest OSes of all VMs included into the backup scope.
...
[![Launch Add Job Wizard](images/pve_backup_job_create_guest_processing_web.webp)](images/pve_backup_job_create_guest_processing_web.webp "Launch Add Job Wizard")
