...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_backups_copy_tape.html"
last_updated: "2026"
...
| --- |
| Note |
| You cannot restore Sangfor aSV VMs directly from tapes. To restore a Sangfor aSV VM, you must first restore its backups to a repository as described in section [Backup Restore from Tape to Repository](vm_restore_from_tape_to_repository.md). |

[![Backup to Tape Jobs](images/sangfor_backups_copy_tape.webp)](images/sangfor_backups_copy_tape.webp "Backup to Tape Jobs")
