...
| --instance | Use the --instance parameter only with the --exclude-from-managed-mode parameter.  Specifies the instance whose databases are excluded from the backup scope of an application backup policy. |
