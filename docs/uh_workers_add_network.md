...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_workers_add_network.html"
last_updated: "2026"
...
2. If DHCP is enabled in the selected network, the IP address of the worker VM will be obtained automatically. If DHCP is disabled in the selected network or if you want to specify a static IP address manually, select the Use the following IP address option and enter the necessary IP address, subnet mask and default gateway.

1. Repeat steps 1–2 to add more network interfaces. For more information on multi-network configuration, see [Configuring Multiple Networks](uh_multiple_networks.md).
...
[![Specify Worker Network Settings](images/uh_workers_add_network.webp)](images/uh_workers_add_network.webp "Specify Worker Network Settings")
