...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_retrieving_sql_data.html"
last_updated: "2026"
...
To retrieve archived data, you can launch the data retrieval process either from the [Data Retrieval wizard](#retrieval) before you begin a restore operation, or directly from the [SQL Database Restore wizard](azure_sql_restore.md). When you retrieve archived data, you can choose one of the following priority options:
...
[![Retrieving SQL Data from Archive](images/azure_launch_sql_data_retrieval.webp)](images/azure_launch_sql_data_retrieval.webp "Retrieving SQL Data from Archive")
...
[![Retrieving Data from Archive](images/azure_data_retrieval_wizard.webp)](images/azure_data_retrieval_wizard.webp "Retrieving Data from Archive")
...
[![Extending Data Availability](images/azure_extend_availability_sql.webp)](images/azure_extend_availability_sql.webp "Extending Data Availability")
