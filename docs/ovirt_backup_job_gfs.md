...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/ovirt_backup_job_gfs.html"
...
After you configure the GFS retention policy settings, [schedule active full or synthetic full backups](ovirt_backup_job_advanced.md). Otherwise, no new full backups will be automatically produced, and Veeam Plug-in for oVirt KVM will be unable to leverage them for long-term retentions.
...
![Configuring GFS Policy Schedules](images/ovirt_backup_job_add_destination_gfs.webp "Select Restore Point")
