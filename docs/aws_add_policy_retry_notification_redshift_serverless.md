...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_policy_retry_notification_redshift_serverless.html"
last_updated: "2026"
...
When retrying backup policies, the backup appliance processes only those namespaces that failed to be backed up during the previous attempt.
...
| --- |
| Note |
| To be able to specify email notification settings for the Redshift Serverless Backup policy, you must configure [global notification settings](aws_email_settings.md) first. |
...
[![Creating Redshift Serverless Backup Policy](images/aws_backup_add_retry_notification_redshift_serverless.webp)](images/aws_backup_add_retry_notification_redshift_serverless.webp "Creating Redshift Serverless Backup Policy")
