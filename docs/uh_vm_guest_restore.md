...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_vm_guest_restore.html"
last_updated: "2026"
...
With guest OS file recovery (file-level restore), you can restore individual guest OS files and folders from VM backups created with Veeam Plug-in for Universal Hypervisor API. When restoring files and folders, you do not need to extract the VM image to a staging location or start the VM prior to restore. For more information on VM guest OS file restore, see [Guest OS File Recovery](guest_file_recovery.md).
...
[![VM Guest OS Files Restore](images/uh_restore_guest_files.webp)](images/uh_restore_guest_files.webp "VM Guest OS Files Restore")
