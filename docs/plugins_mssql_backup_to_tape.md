...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/plugins_mssql_backup_to_tape.html"
last_updated: "2026"
...
Veeam Backup & Replication will copy all closed backup files stored in the repository and skip backup files that are not yet closed. For details on when Veeam Plug-In for Microsoft SQL Server closes backup files, see [How Backup Chain Works](mssql_backup_chain.md#chain).
...
For details, see [Performing Restore](mssql_db_restore.md).
