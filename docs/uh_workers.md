...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_workers.html"
last_updated: "2026"
...
| --- |
| Important |
| To modify the worker settings, use the Veeam Backup & Replication console as described in section [Editing Workers](uh_workers_edit.md). Making any configuration changes to VMs running as workers manually in the universal hypervisor administration portal may cause technical issues. |
...
* [Adding Workers](uh_workers_add.md)
* [Testing Workers](uh_workers_test.md)
* [Enabling and Disabling Workers](uh_workers_disable.md)
* [Editing Workers](uh_workers_edit.md)
* [Disabling Automatic Worker Updates](uh_workers_update.md)
* [Removing Workers](uh_workers_remove.md)
