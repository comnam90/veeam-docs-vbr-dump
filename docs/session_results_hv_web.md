...
To view the detailed statistics for a specific job session, open the backup job details and click the necessary session in the History box. For more information on the backup job details, see [Viewing Backup Job Details](realtime_statistics_hv_web.md).
