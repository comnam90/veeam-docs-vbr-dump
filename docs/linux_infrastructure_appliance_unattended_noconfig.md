...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/linux_infrastructure_appliance_unattended_noconfig.html"
last_updated: "2026"
...
1. Repack the ISO file. To rebuild the modified Veeam Infrastructure Appliance ISO image on Linux, you can use the free open-source utility [xorriso](https://www.gnu.org/software/xorriso/) (available for most Linux distributions and also works under Windows WSL).
...
1. The automatic installation finishes at the [Read and Accept License Agreements](jeos_install_license.md) step. To complete the Initial Configuration wizard, continue the process described in the [Installing Veeam Infrastructure Appliance with ISO](linux_infrastructure_appliance_install.md) section.
