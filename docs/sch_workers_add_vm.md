...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sch_workers_add_vm.html"
last_updated: "2026"
...
2. In the Name field, specify a name for the worker. The maximum length of the name is 40 characters; only the following characters are supported: a-z, A-Z, 0-9, -.
...
[![Specify Worker VM Settings](images/sch_workers_add_vm.webp)](images/sch_workers_add_vm.webp "Specify Worker VM Settings")
