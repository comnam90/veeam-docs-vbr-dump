...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/mfa_cas_server.html"
...
This step is only available if you have selected the Basic Authentication option at the [Select Authentication Method](select_authentication_method_mfa.md#basic) step.
