...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/oracle_log_shipping_hv.html"
...
* Over PowerShell Direct. Veeam Backup & Replication obtains transaction logs from the VM guest OS over PowerShell Direct, bypassing the network. Veeam Backup & Replication uses the backup server as a log shipping server, no matter which log shipping server is selected in the backup job settings.
