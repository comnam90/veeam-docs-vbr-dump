...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_policy_retry_notification_dynamo.html"
last_updated: "2026"
...
When retrying backup policies, the backup appliance processes only those tables that failed to be backed up during the previous attempt.
...
| --- |
| Note |
| To be able to specify email notification settings for the DynamoDB Backup policy, you must configure [global notification settings](aws_email_settings.md) first. |
...
[![Creating DynamoDB Backup Policy](images/aws_backup_add_retry_notification_dynamodb.webp)](images/aws_backup_add_retry_notification_dynamodb.webp "Creating DynamoDB Backup Policy")
