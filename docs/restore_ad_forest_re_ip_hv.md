...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_ad_forest_re_ip_hv.html"
last_updated: "2026"
...
5. To place a restored domain controller in a specific VLAN, select the VLAN ID check box and enter a VLAN ID from 1 to 4094.
6. In the Description field, enter a description for the re-IP rule.
7. Click OK.

![Step 9. Configure Re-IP Rules](images/restore_ad_forest_re_ip_hv_ipv4.webp "New Re-IP Rule Dialog (IPv4)")
...
![Step 9. Configure Re-IP Rules](images/restore_ad_forest_re_ip_hv_ipv6.webp "New Re-IP Rule Dialog (IPv6)")
