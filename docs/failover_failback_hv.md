...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/failover_failback_hv.html"
...
For more information on how failover is performed, see [Failover](failover_hv.md).
...
For more information on how planned failover is performed, see [Planned Failover](planned_failover_hv.md).
...
For more information on failover plans, see [Failover Plans](failover_plan_hv.md).
...
For more information on how permanent failover is performed, see [Permanent Failover](permanent_failover_hv.md).
...
For more information on how failover undo is performed, see [Undoing Failover](failover_undo_hv.md).
...
If the source host is not available, you can recover a VM with the same configuration as the source VM and switch to it. For more information on how failback is performed, see [Failback](failback_hv.md).
...
For more information on how failback commit is performed, see [Failback Commit](commit_failback_hv.md).
...
For more information on how failback undo is performed, see [Failback Undo](undo_failback_hv.md).
...
* [Failover Plans](failover_plan_hv.md)
* [Failover](failover_hv.md)
* [Permanent Failover](permanent_failover_hv.md)
* [Planned Failover](planned_failover_hv.md)
* [Failover Undo](undo_failover_hv.md)
* [Failback](failback_hv.md)
