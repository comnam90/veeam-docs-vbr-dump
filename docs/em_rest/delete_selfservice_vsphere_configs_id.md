---
title: "DELETE /selfService/vSphere/Configs/{ID}"
product: "vbr"
doc_type: "em_rest"
...
|  |
| --- |
| Request:  DELETE https://localhost:9398/api/selfService/vSphere/Configs/ee1018b4-6f52-489e-80b7-8005e0b2d640  Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj  Response:  202 Accepted  Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1">   <Links>     <Link Rel="Delete" Type="Task" Href="https://localhost:9398/api/tasks/task-1" />   </Links>   <TaskId>task-1</TaskId>   <State>Running</State>   <Operation>DeleteVSphereConfigs</Operation> </Task> |
