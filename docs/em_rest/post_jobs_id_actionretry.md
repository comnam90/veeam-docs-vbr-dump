---
title: "POST /jobs/{ID}?action=retry"
product: "vbr"
doc_type: "em_rest"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/post_jobs_id_actionretry.html"
last_updated: "2026"
...
To retry a job, send the POST HTTP request to the /jobs/{ID}?action=retry URL.

HTTP Request

|  |
| --- |
| POST https://<Enterprise-Manager>:9398/api/jobs/{ID}?action=retry |
