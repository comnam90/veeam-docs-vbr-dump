---
title: "get_vmrestorepoints_id_mountpoints"
...
To get a list of mount points, send the GET HTTP request to the /vmRestorePoints/{ID}/mounts resource.

HTTP Request

|  |
| --- |
| GET https://<Enterprise-Manager>:9398/api/vmRestorePoints/{ID}/mounts |
...
In the response body, the REST API returns a representation of the /vmRestorePoints/{ID}/mounts resource.

Example

The example below returns a list of mountpoints for the VM restore point having ID fb87163e-687d-4006-96c9-0451b5423b85:
