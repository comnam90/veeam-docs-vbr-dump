---
title: "post_nas_jobs_id_actiontogglescheduleenabled"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/post_nas_jobs_id_actiontogglescheduleenabled.html"
...
Disables or enables a file share backup job having the specified ID. The file share backup job is configured in Veeam Backup & Replication.

A disabled job remains in the list of file share backup jobs on the backup server, but does not run according to specified job scheduling settings. To enable a job, perform the Disable operation once again.

Request

To disable or enable a file share backup job, send the POST HTTP request to the /nas/jobs/{ID}/toggleScheduleEnabled URL.

HTTP Request

|  |
| --- |
| POST https://<Enterprise-Manager>:9398/api/nas/jobs/{ID}/toggleScheduleEnabled |
...
The example below disables or enables a file share backup job having ID 93dfbb3e-f420-45cf-addc-4ee9297113f2.

|  |
| --- |
| Request:  POST https://localhost:9398/api/agents/jobs/93dfbb3e-f420-45cf-addc-4ee9297113f2/toggleScheduleEnabled    Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj    Response:  202 Accepted    Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1"> |
