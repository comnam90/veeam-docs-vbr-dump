---
title: "POST /cdpPolicies/{ID}&action=enable"
product: "vbr"
doc_type: "em_rest"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/post_cdppolicies_id_actionenable.html"
...
Enables a disabled CDP policy having the specified ID.

Request

To enable a CDP policy, send the POST HTTP request to the /cdpPolicies/{ID}?action=enable URL.

HTTP Request

|  |
| --- |
| POST https://<Enterprise-Manager>:9398/api/cdpPolicies/{ID}?action=enable |
...
The example below enables a CDP policy having ID bc933bb6-0cc5-47b6-a1ec-e062b9e29877.

|  |
| --- |
| Request:  POST https://localhost:9398/api/cdpPolicies/bc933bb6-0cc5-47b6-a1ec-e062b9e29877?action=enable    Request Headers:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj    Response:  202 Accepted    Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1"> |
