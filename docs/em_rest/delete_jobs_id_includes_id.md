---
title: "DELETE /jobs/{ID}/includes/{ID}"
product: "vbr"
doc_type: "em_rest"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/delete_jobs_id_includes_id.html"
...
| --- |
| Note |
| If a job processes only one object (VM or VM container), you cannot delete this object with Veeam Backup Enterprise Manager REST API. |
...
To remove a VM or a VM container from the job so that the VM or VM container is no longer processed, send the DELETE HTTP request to the /jobs/{ID}/includes/{ID} resource.
...
|  |
| --- |
| Request:  DELETE https://localhost:9398/api/jobs/d1b85018-2769-45be-89bc-03f66b60e6cb/includes/27a1d57f-7c15-43c6-9162-d05aff1c9bb9    Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj    Response:  202 Accepted    Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1"> |
