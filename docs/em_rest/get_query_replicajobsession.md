...
| Name | String | Name of the replication job session resource, for example: exch@2025-08-26 22:28:51. |
...
|  |
| --- |
| Request:  GET https://localhost:9398/api/query?type=ReplicaJobSession&format=Entities&filter=BackupServerName=="enterprise06.tech.local";Result==Success  Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj  Response:  200 OK  Response Body:  <QueryResult xmlns="http://www.veeam.com/ent/v1.0">   <Entities>     <ReplicaJobSessions>       <ReplicaJobSession Type="ReplicaJobSession" Href="https://localhost:9398/api/replicaSessions/1bffbda3-39a8-41eb-b9a0-200b98f3c5e9?format=Entity" Name="Replication Job 1@2025-06-15 22:06:57" UID="urn:veeam:ReplicaJobSession:1bffbda3-39a8-41eb-b9a0-200b98f3c5e9">         <Links>           <Link Rel="Up" Type="BackupServerReference" Href="https://localhost:9398/api/backupServers/7445e6ce-86f5-4171-b909-dac209c66563" Name="enterprise06.tech.local" />           <Link Rel="Up" Type="JobReference" Href="https://localhost:9398/api/jobs/1aa9734e-60e1-4fb6-87df-bbaa9bf38de8" Name="Replication Job 1" />           <Link Rel="Alternate" Type="ReplicaJobSessionReference" Href="https://localhost:9398/api/replicaSessions/1bffbda3-39a8-41eb-b9a0-200b98f3c5e9" Name="Replication Job 1@2025-06-15 22:06:57" />           <Link Rel="Down" Type="ReplicaTaskSessionReferenceList" Href="https://localhost:9398/api/replicaSessions/1bffbda3-39a8-41eb-b9a0-200b98f3c5e9/replicaTaskSessions" />         </Links>         <JobUid>urn:veeam:Job:1aa9734e-60e1-4fb6-87df-bbaa9bf38de8</JobUid>         <JobName>Replication Job 1</JobName>         <JobType>Replica</JobType>         <CreationTimeUTC>2025-06-15T22:06:57.263Z</CreationTimeUTC>         <EndTimeUTC>2025-06-15T22:11:06.11Z</EndTimeUTC>         <State>Stopped</State>         <Result>Success</Result>         <Progress>100</Progress>         <IsRetry>false</IsRetry>       </ReplicaJobSession>     </ReplicaJobSessions>   </Entities>   <PagingInfo PagesCount="1" PageSize="100" PageNum="1">     <Links>       <Link Rel="First" Href="https://localhost:9398/api/query?type=ReplicaJobSession&format=Entities&filter=BackupServerName=="enterprise06.tech.local";Result==Success&pageSize=100&page=1" />       <Link Rel="Last" Href="https://localhost:9398/api/query?type=ReplicaJobSession&format=Entities&filter=BackupServerName=="enterprise06.tech.local";Result==Success&pageSize=100&page=1" />     </Links>   </PagingInfo> </QueryResult> |
