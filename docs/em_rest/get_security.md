...
product: "vbr"
doc_type: "em_rest"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/get_security.html"
...
To get access to the Veeam Backup Enterprise Manager security settings, send the GET HTTP request to the /security resource.

HTTP Request

|  |
| --- |
| GET https://<Enterprise-Manager>:9398/api/security |
