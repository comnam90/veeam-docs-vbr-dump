...
| GfsRetentionPolicy | Boolean | Defines whether long-term (GFS) retention policy settings are enabled for the job. If you set this option to True, you need to [specify GFS retention settings](#gfsretention) for the job in the GFSRetentionPolicy section of the request. |
| Yes | 0/1 |
...
|  |
| --- |
| <?xml version="1.0" encoding="utf-8"?> <Job Type="Job" Href="https://localhost:9398/api/jobs/6c86549b-154f-4566-a76e-52bd64a33aea?format=Entity" Name="DB Backup" UID="urn:veeam:Job:6c86549b-154f-4566-a76e-52bd64a33aea" xmlns="http://www.veeam.com/ent/v1.0" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">   <Description>Backup of SQL database server</Description>   <ScheduleConfigured>true</ScheduleConfigured>   <ScheduleEnabled>true</ScheduleEnabled> </Job> |
