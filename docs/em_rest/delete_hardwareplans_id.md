---
title: "DELETE /cloud/hardwarePlans/{ID}"
product: "vbr"
doc_type: "em_rest"
...
|  |
| --- |
| Request:  DELETE https://localhost:9398/api/cloud/hardwarePlans/d2d37ef0-dc9d-43b4-9fa4-b4e850fab171  Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj  Response:  202 Accepted  Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1">   <Links>     <Link Rel="Delete" Type="Task" Href="https://localhost:9398/api/tasks/task-1" />   </Links>   <TaskId>task-1</TaskId>   <State>Running</State>   <Operation>DeleteCloudHardwarePlan</Operation> </Task> |
