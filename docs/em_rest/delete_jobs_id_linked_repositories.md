---
title: "DELETE /jobs/{ID}/linkedBackupRepositories/{ID}"
product: "vbr"
doc_type: "em_rest"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/delete_jobs_id_linked_repositories.html"
...
Deletes a specific backup repository linked to a backup copy job with the specified ID.
...
To remove a linked repository from a backup copy job, send the DELETE HTTP request to the /jobs/{ID}/linkedBackupRepositories/{ID} resource.

HTTP Request

|  |
| --- |
| DELETE https://<Enterprise-Manager>:9398/api/jobs/{ID}/linkedBackupRepositories/{ID} |
...
The example below removes a linked repository from a backup copy job.

|  |
| --- |
| Request:  DELETE https://localhost:9398/api/jobs/d1b85018-2769-45be-89bc-03f66b60e6cb/linkedBackupRepositories/27a1d57f-7c15-43c6-9162-d05aff1c9bb9    Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj    Response:  202 Accepted    Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1"> |
