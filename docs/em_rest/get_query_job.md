---
title: "GET /query?type=Job"
product: "vbr"
doc_type: "em_rest"
source_url: "https://helpcenter.veeam.com/docs/vbr/em_rest/get_query_job.html"
...
Returns a resource representation of a collection of jobs created on backup servers that are connected to Veeam Backup Enterprise Manager. For details, see [/jobs](jobs.md).
...
| BackupServerUid | UidType | UID of the backup server parent to the job resource. |
| BackupServerName | String | Name of the backup server parent to the job resource. |
...
|  |
| --- |
| Request:  GET https://localhost:9398/api/query?type=Job&format=Entities&sortAsc=name&filter=Platform==vCloud&JobType==Backup    Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj    Response:  200 OK    Response Body:  <QueryResult xmlns="http://www.veeam.com/ent/v1.0"> |
