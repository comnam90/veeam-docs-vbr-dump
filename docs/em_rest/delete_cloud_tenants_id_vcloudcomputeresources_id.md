...
The example below removes the organization VDC with ID 9202597f-96ea-41ef-a528-caf0e36e4d76 from the tenant account with ID 6faeea03-a787-4b2d-a0e5-3fe215d50c53.

|  |
| --- |
| Request:  DELETE https://localhost:9398/api/cloud/tenants/6faeea03-a787-4b2d-a0e5-3fe215d50c53/vCloudComputeResources/9202597f-96ea-41ef-a528-caf0e36e4d76  Request Header:  X-RestSvcSessionId   NDRjZmJkYmUtNWE5NS00MTU2LTg4NjctOTFmMDY5YjdjMmNj  Response:  202 Accepted  Response Body:  <Task xmlns="http://www.veeam.com/ent/v1.0" Type="Task" Href="https://localhost:9398/api/tasks/task-1">   <Links>     <Link Rel="Delete" Type="Task" Href="https://localhost:9398/api/tasks/task-1" />   </Links>   <TaskId>task-1</TaskId>   <State>Running</State>   <Operation>DeletevCloudTenantComputeResource</Operation> </Task> |
