...
If the computer has backups created by a backup policy, also click the General tab.
...
* If the computer has backups created by a backup policy, click Permissions and details on the toolbar (or right-click the computer and select Permissions and details), then click the General tab.
* If the computer has no backups created by a backup policy, click Details on the toolbar (or right-click the computer and select Details).
