...
| --- |
| NOTE |
| If you want to change a backup repository, you must disable a policy. To learn more, see [Enabling and Disabling Backup Policy](manage_policy_disable.md). In this case during the next run the policy will produce a full backup. |
