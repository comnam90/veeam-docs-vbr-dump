...
* [Veeam Cryptographic Module](https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/4282) — for Linux-based components and services. This module is also used for [Veeam Data Mover](veeam_transport_service.md) installed on Microsoft Windows-based machines.
