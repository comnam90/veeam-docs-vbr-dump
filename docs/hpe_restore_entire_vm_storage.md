...
If you restore the VM to the original cluster, Veeam Backup & Replication will automatically select the same datastore where the original VM disks were stored at the moment of backup. If you restore the VM to a new cluster, you will have to select a datastore manually.
