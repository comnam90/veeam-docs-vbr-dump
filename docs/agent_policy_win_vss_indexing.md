---
title: "File Indexing"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_win_vss_indexing.html"
...
* Select Index everything if you want to index all files within the backup scope that you have specified at the [Backup mode](agent_policy_win_mode.md) step of the wizard. Veeam Agent for Microsoft Windows will index all files that reside:
...
![File Indexing](images/agent_policy_win_vss_indexing.webp "Specify Indexing Settings")
