...
[![Step 3. Specify Credentials](images/add_server_windows_creds_web.webp)](images/add_server_windows_creds_web.webp)

1. To customize network ports used by Veeam Backup & Replication components, click Network settings. For default ports used by the Veeam Backup & Replication components, see [Ports](used_ports.md).
