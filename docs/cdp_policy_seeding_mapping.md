...
| --- |
| Important |
| Consider the following:   * Backups for seeding must be created by Veeam Backup & Replication.  * Backups for seeding must not reside in a scale-out backup repository. |
