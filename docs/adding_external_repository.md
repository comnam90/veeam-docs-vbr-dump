...
1. [Launch the New External Repository wizard](external_repository_launching_wizard.md).
2. [Specify the repository name and description](external_repository_name.md).
3. [Specify the cloud account](external_repository_account.md).
4. [Specify cloud storage details](external_repository_details.md).
5. [Configure encryption](external_repository_s3_encryption.md).
