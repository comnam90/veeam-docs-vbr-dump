...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_job_gfs_vm_web.html"
...
From the If multiple full backups exist, use one from drop-down list, select a week day when Veeam Backup & Replication must assign the weekly GFS flag to a full restore point.
...
[![Click to zoom in](images/vm_backup_job_gfs_web.webp)](images/vm_backup_job_gfs_web.webp "Click to zoom in")
