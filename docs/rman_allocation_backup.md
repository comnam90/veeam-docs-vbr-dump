...
Set the path to the libOracleRMANPlugin.so file as the SBT\_LIBRARY.

* For Microsoft Windows:

Set the path to %PROGRAMFILES%\Veeam\VeeamPluginforOracleRMAN\OracleRMANPlugin.dll.
...
If you have exported Veeam Plug-In configuration files, run the following command to see the contents of the configuration file.
...
If you have exported Veeam Plug-In configuration files, find the channel allocation definition in the configuration file.
