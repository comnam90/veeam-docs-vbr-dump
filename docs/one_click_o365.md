...
1. [Launch the Restore wizard](launch_restore_mfa_one_click.md).
2. [Select an authentication method](select_authentication_method_mfa_one_click.md).
3. [Log in to Microsoft 365](login_on_to_office_365_mfa_one_click.md).
