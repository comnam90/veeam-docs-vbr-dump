...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_job_vss_scripts_vm_web.html"
...
[![Click to zoom in](images/vm_backup_job_vss_pre-post_web.webp)](images/vm_backup_job_vss_pre-post_web.webp "Click to zoom in")
