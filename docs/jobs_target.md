...
* You can use the move to another repository operation described in the [Moving Backups to Another Repository](move_backup.md#repo) section. In this case, Veeam Backup & Replication moves all backups to a new repository and automatically reconfigures the job to target to the new location.
