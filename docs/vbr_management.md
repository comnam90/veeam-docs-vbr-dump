...
* [Veeam ONE](https://helpcenter.veeam.com/docs/one/userguide/about_one.html?ver=13): a solution that enables real-time monitoring, business documentation and management reporting for Veeam Backup & Replication, VMware vSphere and Microsoft Hyper-V.
