...
![Veeam Backup Repository Settings](images/agent_policy_vbr_linux.webp)
...
| --- |
| NOTE |
| You must enable backup file encryption in the [backup job storage settings](agent_advanced_storage_linux.md) if you back up data to the Veeam Data Cloud Vault storage added as a Veeam backup repository. |
