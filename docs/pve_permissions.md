...
| Setup Account | The account used to install Veeam Backup & Replication and Veeam Plug-In for AWS must have the Local Administrator permissions on the backup server. |
