...
When you restore your data with this option, you can specify a target mailbox, specify a target folder to which you want to restore data and configure restore options.

You can also use [1-Click Restore](vex_vbr_restore_one_click.md) if you do not want to configure a restore session and prefer to restore your data using the default settings.
