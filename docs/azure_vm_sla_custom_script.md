...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_vm_sla_custom_script.html"
last_updated: "2026"
...
| --- |
| Important |
| The backup appliance will try to run a script residing in the specified directory for all Azure VMs added to the SLA-based backup policy. If you want to execute different scripts for different Azure VMs, ensure that script files uploaded to these VMs have the same path and name. |
...
[![Adding Backup Policy](images/azure_vm_protection_custom_script.webp)](images/azure_vm_protection_custom_script.webp "Adding Backup Policy")
