...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_background_retention_disable_hv.html"
...
You can manually disable [background retention](background_retention_job_hv.md), which is launched every 24 hours at 00:30. You can enable disabled background retention at any time.
