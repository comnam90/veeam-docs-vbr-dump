...
[![Recover Tenant Database](images/recover_saphana_studio_launch.webp)](images/recover_saphana_studio_launch.webp "Recover Tenant Database")

1. Enter the operating system user credentials.

![Restoring Databases (SAP HANA Studio)](images/recover_saphana_studio_login.webp)

1. Recovery process requires the database to be shut down. In the pop-up window, click OK to confirm the database shutdown.

![Restoring Databases (SAP HANA Studio)](images/recover_saphana_turn_off_db.webp)
...
![Restoring Databases (SAP HANA Studio)](images/recover_saphana_studio_recovery_type.webp)
...
![Restoring Databases (SAP HANA Studio)](images/recover_saphana_studio_catalog.webp)

1. Select the required backup to restore.

![Restoring Databases (SAP HANA Studio)](images/recover_saphana_select_backup.webp)

1. At the Locate Log Backups step, click Next.

![Restoring Databases (SAP HANA Studio)](images/recover_saphana_studio_log.webp)
...
![Restoring Databases (SAP HANA Studio)](images/recover_saphana_studio_other.webp)

1. At the Review Recovery Settings step, click Finish.

![Restoring Databases (SAP HANA Studio)](images/recover_saphana_studio_finish.webp)
