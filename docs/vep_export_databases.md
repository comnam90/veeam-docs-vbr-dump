...
1. [Launch the Export wizard](vep_export_wizard.md).
2. [Select databases](vep_export_select_databases.md).
3. [Specify a restore point](vep_export_specify_restore_point.md).
4. [Specify target host](vep_export_specify_target_host.md).
