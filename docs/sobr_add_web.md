...
1. [Launch New Scale-Out Backup Repository Wizard](sobr_launch_wev.md).
2. [Specify scale-out backup repository name](sobr_add_name_web.md).
3. [Add performance extents](sobr_add_extents_web.md).
4. [Specify backup placement policy](sobr_add_policy_web.md).
