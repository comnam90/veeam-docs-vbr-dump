...
Before creating a job, [check prerequisites](plugins_sap_maxdb_backup_copy_create_prerequisites.md). Then use the New Backup Copy Job wizard to configure a backup copy job.

1. [Launch Backup Copy Job wizard](plugins_sap_maxdb_backup_copy_create_launch.md).
2. [Specify a job name and description](plugins_sap_maxdb_backup_copy_create_name.md).
3. [Select backups to process](plugins_sap_maxdb_backup_copy_create_backups.md).
4. [Define backup copy target](plugins_sap_maxdb_backup_copy_create_target.md).
5. [Specify advanced settings](plugins_sap_maxdb_backup_copy_create_advanced.md).
