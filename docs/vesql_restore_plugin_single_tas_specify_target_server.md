...
[![Specifying Target SQL Server](images/vesql_restore_plugin_specify_target_server.webp)](images/vesql_restore_plugin_specify_target_server.webp "Specifying Target SQL Server")
