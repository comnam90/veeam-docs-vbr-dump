...
After you have launched a publishing operation to a Microsoft SQL Server machine (as described in [Publishing to Specified Server](vesql_publishing_databases.md)), you can quickly republish a state of the database to the same server.
