...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/entra_id_backup_properties.html"
...
You can restore the logs from any of these points. To learn how to restore the log data, see [Entra ID Log Restore](entra_id_log_restore.md).
