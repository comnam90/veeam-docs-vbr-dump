...
* Bottleneck — a bottleneck in the data transmission process. For more information on job bottlenecks, see [Performance Bottlenecks](detecting_bottlenecks.md).
