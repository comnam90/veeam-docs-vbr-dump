...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/surebackup_job_troubleshooting.html"
...
If a VM fails to be verified, you can start it in the troubleshooting mode to investigate the issue. This can be helpful for diagnosing internal connectivity issues in the lab and inspecting the appropriate values for [Maximum allowed boot time and Application initialization timeout](surebackup_job_tests_vm.md#startup).
