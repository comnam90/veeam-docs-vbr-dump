...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vesql_instant_hiw_web_ui.html"
last_updated: "2026"
...
2. The Veeam Mount Service uses backup files to start 2 [iSCSI mount sessions](vesql_mount_operations_web_ui.md) in parallel.
...
After synchronization, you can switch over to the recovered database. For more information about the available switchover options, see [Switchover](vesql_ir_web_ui_switchover.md).
...
[![How Instant Recovery Works](images/vesql_ir_web_ui.webp)](images/vesql_ir_web_ui.webp "How Instant Recovery Works")
