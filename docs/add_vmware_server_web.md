...
To add a VMware vSphere server using the Veeam Backup & Replication web UI, use the New VMware Server wizard.

1. [Launch the New VMware Server wizard](vmware_server_launch_web.md).
2. [Specify a server name or address](vmware_server_name_web.md).
