...
1. In the \Plugins\SAP on Oracle\x64 folder, find the VeeamPluginforSAPOracle-13.0.3.29-1.x86\_64.rpm file.
...
1. In the \VeeamPluginForSAPonOracle-13.0.3.29-1\veeam-openssl3 folder, find the veeam-openssl3-3.0.0.31-1.x86\_64.rpm package.
2. In the \VeeamPluginForSAPonOracle-13.0.3.29-1\x64 folder, find the VeeamPluginforSAPOracle-13.0.3.29-1.x86\_64.rpm package.
...
|  |
| --- |
| rpm -i VeeamPluginforSAPOracle-13.0.3.29-1.x86\_64.rpm |
...
2. In the \VeeamPluginforSAPOracle-13.0.3.29-1\x64 folder, find the VeeamPluginforSAPOracle.tar.gz setup archive.
