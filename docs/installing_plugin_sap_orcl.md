...
1. In the \Plugins\SAP on Oracle\x64 folder, find the VeeamPluginforSAPOracle-13.1.0.411-1.x86\_64.rpm file.
...
2. In the \VeeamPluginforSAPOracle-13.1.0.411\x64 folder, find the VeeamPluginforSAPOracle-13.1.0.411-1.x86\_64.rpm package.
...
|  |
| --- |
| rpm -i VeeamPluginforSAPOracle-13.1.0.411-1.x86\_64.rpm |
...
1. Upload openssl-fips-redistributable-3.1.2-3.1.2.2-1.x86\_64.rpm and VeeamPluginforSAPOracle.tar.gz files to the Oracle server.
...
1. In the \VeeamPluginforSAPOracle-13.1.0.411\openssl-fips-redistributable-3.1.2 folder, find the openssl-fips-redistributable-3.1.2-3.1.2.2-1.x86\_64.rpm package.
2. In the \VeeamPluginforSAPOracle-13.1.0.411\x64 folder, find the VeeamPluginforSAPOracle.tar.gz setup archive.
