...
![Viewing License Information Using Console](images/view_license.webp)
...
You can additionally configure the following settings:
...
Selecting this option also enables diagnostic data sharing. The telemetry log is shared once a week. You can review the contents of the telemetry log at the following location on your backup server: C:\ProgramData\Veeam\Backup\Utils\VMC.log.
...
For peculiarities of socket licensing, see the [Licensing](licensing.md#socket) section.

![Viewing License Information Using Console](images/license_view_sockets.webp)
...
By default, Veeam Backup & Replication allows Veeam Agents to connect to the Veeam backup server and consume instances in the license. If you do not want Veeam Agents to consume instances, clear the Allow unlicensed agents to consume instances check box.

|  |
| --- |
| Note |
| The Allow unlicensed agents to consume instances check box also affects Veeam Agents installed as components of MongoDB Backup. If you clear the check box, application backup policies for MongoDB will fail. For details on MongoDB Backup, see the [Solution Architecture](mongo_hiw.md) section. |

For more information on Veeam Agents licensing, see the following user guides:
...
* If you work with Veeam Agents installed as components of MongoDB Backup, see the [Licensing](mongo_plan_and_manage_licensing.md) section in MongoDB Backup.

![Viewing License Information Using Console](images/license_view_instances.webp)
...
![Viewing License Information Using Console](images/license_view_capacity.webp)

Viewing Information on Points

With a rental license, Veeam Backup & Replication applies the license to protected tenant workloads.
...
![Viewing License Information Using Console](images/license_view_points.webp)

Creating Current License Consumption Report

If you have an instance license and at least one instance is already consumed by Veeam Backup & Replication, you can create a Current License Consumption report. To run the report, click Create Report in the License tab of the License Information window.
...
* Workload sub-type (vSphere, Hyper-V, and so on)
