---
title: "Step 6. Configure Private Endpoints"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_pne_dns_endpoints.html"
last_updated: "2026"
...
1. [Locate private endpoints for your Veeam storage account in Microsoft Azure](azure_pne_dns_endpoints_locate.md).
2. [Configure the private endpoint for Azure Blob Storage](azure_pne_dns_endpoints_blobs.md).
3. [Configure private endpoint for Azure Queue Storage](azure_pne_dns_endpoints_queues.md).
