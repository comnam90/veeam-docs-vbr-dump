...
| Oracle database | Veeam Plug-In for Oracle RMAN supports Standard and Enterprise Editions of the following Oracle Database versions:   * 23ai * 21c * 19c * 18c * 12c * 11g Release 2 |
