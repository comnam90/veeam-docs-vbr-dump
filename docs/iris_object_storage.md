...
You can use object storage in Veeam Backup & Replication as a primary backup repository. For details, see [Backup Repositories](backup_repository.md).
