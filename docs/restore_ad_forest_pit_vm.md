...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_ad_forest_pit_vm.html"
last_updated: "2026"
...
* Select a specific point in time — restores the forest to any other restore point. Select a restore point from the list.
...
![Step 2. Specify Forest and Point in Time](images/restore_ad_forest_pit.webp "Specifying the Forest and Restore Point")
