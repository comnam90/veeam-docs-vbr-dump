...
To restore MongoDB data items, Veeam Backup & Replication uses the MongoDB Items Restore wizard and Veeam Explorer for MongoDB.

Use the MongoDB Items Restore wizard to start the restore the process:

1. [Launch the MongoDB Items Restore wizard](mongo_application_backups_restore_launch.md).
2. [Select a restore point](mongo_application_backups_restore_point.md).
3. [Specify restore reason](mongo_application_backups_restore_reason.md).
4. [Complete the restore process](mongo_application_backups_restore_summary.md).
