...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/instant_nas_recovery.html"
...
* [Performing Instant File Share Recovery](performing_instant_file_share_recovery.md)
* [Migrating File Share to Production](migrate_share_to_production.md)
* [Stopping File Share Publishing](stop_nas_publish.md)
