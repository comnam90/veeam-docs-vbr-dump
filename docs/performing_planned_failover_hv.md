...
1. [Check prerequisites](planned_failover_before_you_begin_hv.md).
2. [Launch the Planned Failover wizard](planned_failover_launch_hv.md).
3. [Select VMs](planned_failover_vms_hv.md).
