...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_restore_how_entire.html"
last_updated: "2026"
...
1. [This step applies only if you perform restore to the original location and if the source VM is still present in the location] Connects to the Sangfor aSV server over REST API to power off and remove the source VM.
...
1. Connects to the Sangfor aSV server over REST API, configures a VM and creates empty virtual disks in the target location.
...
To learn how to restore an entire VM, see [Performing VM Restore](sangfor_restore_entire_vm.md).
