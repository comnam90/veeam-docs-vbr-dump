...
1. [Launch the wizard](hpe_add_launch.md).
2. [Specify storage name or address and storage role](nimble_add_name.md).
3. [Specify credentials](nimble_add_credentials.md).
4. [Specify VMware access options](nimble_add_options.md).
5. [Specify Veeam Agent access options](nimble_agents_access.md).
