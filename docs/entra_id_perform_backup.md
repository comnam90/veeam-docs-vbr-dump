...
* Tenant backup jobs that protect tenant data, such as users, groups, administrative units, roles, applications, conditional access policies and intune policies.
