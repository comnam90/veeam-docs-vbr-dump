...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_guest_general_linux_web.html"
last_updated: "2026"
...
If you select this option, you will need to specify database processing settings. For more information, see [Oracle Processing Settings](agent_policy_guest_oracle_linux_web.md), [MySQL Processing Settings](agent_policy_guest_mysql_linux_web.md) and [PostgreSQL Processing Settings](agent_policy_guest_postgresql_linux_web.md).
...
[![Application-Aware Processing](images/agent_policy_guest_general_linux_web.webp)](images/agent_policy_guest_general_linux_web.webp "Application-Aware Processing")
