...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agents_protection_group_options_web.html"
last_updated: "2026"
...
1. If you want to instruct Veeam Backup & Replication to automatically upgrade Veeam Agent on discovered computers when a new version of Veeam Agent appears on the Veeam Backup & Replication server, in the Deployment section, make sure that the Auto-update backup agents check box is selected.
...
1. [For protection groups that include Linux computers] Select the Install nosnap backup agent check box if you want to install the nosnap version of Veeam Agent for Linux on protected Linux computers.
...
1. Select the Reboot automatically if required check box to allow Veeam Backup & Replication to reboot a protected computer. In particular, the reboot operation is required as part of the Veeam CBT driver installation process.
2. Click Configure advanced settings to specify advanced settings for the protection group. To learn more, see [Specify Advanced Protection Group Settings](agents_protection_group_advanced_web.md).

[![Specify Discovery and Deployment Options](images/protection_group_options_web.webp)](images/protection_group_options_web.webp "Specify Discovery and Deployment Options")
