...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/xen_workers_update.html"
last_updated: "2026"
...
1. At the Networks step of the Edit Xen Worker wizard, click Advanced and clear the Check for updates online check box. Then, click Finish to save changes made to the worker settings.

[![Updating Workers](images/xen_workers_update.webp)](images/xen_workers_update.webp "Updating Workers")

Related Topics

[Ports](xen_used_ports.md)
