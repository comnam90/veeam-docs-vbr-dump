...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vet_login_restore_channels.html"
...
This step is only available if you have selected the Modern authentication option at the [previous step](vet_select_auth_restore_channels.md) of the wizard.
...
Make sure to log in with the user account that has required permissions assigned. For more information, see [Permissions](vet_permissions.md).
