...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/cdp_retention.html"
...
For more information on technical points, short-term restore points, long-term restore points and when they are created, see [CDP Replication Chain](cdp_replica_chain.md).
