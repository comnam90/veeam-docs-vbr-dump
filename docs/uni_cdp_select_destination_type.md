...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uni_cdp_select_destination_type.html"
last_updated: "2026"
...
For more information on the required infrastructure, see [Backup Infrastructure for Universal CDP](uni_cdp_infrastructure.md).

* Cloud Host to replicate workloads to the cloud host allocated to you by the service provider (SP). This option is available only if the service provider is added to the backup infrastructure.
...
![Step 5. Select Destination Type](images/uni_cdp_policy_destination_type.webp)
