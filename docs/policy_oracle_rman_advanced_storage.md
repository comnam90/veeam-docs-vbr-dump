...
* Select Veeam compression if you want to perform default data compression with Data Mover by Veeam Software. If this option selected, Data Mover will use the ZSTD compression algorithm.
* Select RMAN compression if you want to perform data compression with Oracle RMAN.
...
![Storage Settings](images/plugins_policy_rman_storage_advanced_storage.webp)
