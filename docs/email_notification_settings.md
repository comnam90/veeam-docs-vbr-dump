...
* [Configure global email notification settings in Veeam Backup & Replication](general_email_notifications.md).
* [Configure job notification settings](job_email_notifications.md).
