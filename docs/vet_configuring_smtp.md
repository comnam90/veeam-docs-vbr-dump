...
By default, Veeam Explorer for Microsoft Teams establishes a connection to the smtp.office365.com server.

1. In the From field, specify the email address to be shown as a sender.
2. In the Send a test email to field, specify the email address to which Veeam Explorer for Microsoft Teams sends a test email message.
