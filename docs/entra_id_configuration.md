...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/entra_id_configuration.html"
...
6. [Optional] Configure global email notification options to get notifications with results on jobs performed on the backup server. For more information, see section [Configuring Global Email Notification Settings](general_email_notifications.md).
