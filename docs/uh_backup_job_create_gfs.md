...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_backup_job_create_gfs.html"
last_updated: "2026"
...
After you configure the GFS retention policy settings, [schedule active full or synthetic full backups](uh_backup_job_create_advanced.md). Otherwise, no new full backups will be automatically produced, and Veeam Backup & Replication will be unable to leverage them for long-term retentions.
...
[![Specify Backup GFS Settings](images/uh_backup_job_create_gfs.webp)](images/uh_backup_job_create_gfs.webp "Specify Backup GFS Settings")
