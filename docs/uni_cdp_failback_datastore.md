...
If configuration and disk files of VMs must be placed in different datastores, select the files of the necessary type, click Datastore and select the datastore.
