...
1. Set the scale-out repository as the target for backups using one of the following commands depending on the OS you are using:
...
1. Map the imported backups using one of the following commands depending on the OS you are using:
