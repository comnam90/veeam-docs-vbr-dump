---
title: "Veeam Explorer for PostgreSQL"
product: "vbr"
...
| [Stop-VEPSQLRestoreSession](stop-vepsqlrestoresession.md) | Stops an active restore session initiated to perform operations with PostgreSQL instances. |
| [Get-VEPSQLInstance](get-vepsqlinstance.md) | Returns backed-up PostgreSQL instances. |
| [Get-VEPSQLInstanceRestoreInterval](get-vepsqlinstancerestoreinterval.md) | Returns details on the available restore period for a backed-up PostgreSQL instance. |
| [Get-VEPSQLTablespace](get-vepsqltablespace.md) | Returns tablespaces for a backed-up PostgreSQL instance. |
| [Start-VEPSQLInstanceRestore](start-vepsqlinstancerestore.md) | Restores a backed-up PostgreSQL instance. |
| [Get-VEPSQLInstanceRestore](get-vepsqlinstancerestore.md) | Returns information about the restore processes for backed-up PostgreSQL instances. |
| [Stop-VEPSQLInstanceRestore](stop-vepsqlinstancerestore.md) | Stops the restore process for a backed-up PostgreSQL instance. |
| [Restart-VEPSQLInstanceRestore](restart-vepsqlinstancerestore.md) | Restarts a failed restore process for a backed-up PostgreSQL instance. |
| [Start-VEPSQLInstancePublish](start-vepsqlinstancepublish.md) | Publishes a backed-up PostgreSQL instance. |
| [Get-VEPSQLInstancePublish](get-vepsqlinstancepublish.md) | Returns active publishing sessions for backed-up PostgreSQL instances. |
...
| [Stop-VEPSQLInstanceInstantRecovery](stop-vepsqlinstanceinstantrecovery.md) | Stops an active instant recovery session for a PostgreSQL instance. |
...
| [Stop-VEPSQLDatabaseExport](stop-vepsqldatabaseexport.md) | Stops an active export session for a PostgreSQL database. |
