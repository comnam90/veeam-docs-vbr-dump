...
| UseSSL | Defines that Veeam Explorer for Microsoft OneDrive for Business will enable a secure connection for sending emails.  If you do not provide this parameter, email messages will be sent through a connection that does not require TLS authentication.  Default: False | SwitchParameter | False | Named | False |
...
| From | Specifies an email address of the email sender. | String | True | Named | False |
