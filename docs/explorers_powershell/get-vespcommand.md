...
![](//img.veeam.com/helpcenter/baggage/arrow_next.svg)Example 1. Getting All Veeam Explorer for Microsoft SharePoint and Veeam Explorer for Microsoft OneDrive for Business Cmdlets

|  |  |
| --- | --- |
| This command returns all Veeam Explorer for Microsoft SharePoint and Veeam Explorer for Microsoft OneDrive for Business cmdlets.  |  | | --- | | Get-VESPCommand | |
