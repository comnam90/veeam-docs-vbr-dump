...
|  |  |
| --- | --- |
| This command returns the Get-VETItem cmdlet.  |  | | --- | | Get-VETCommand -Name Get-VETItem | |

![](//img.veeam.com/helpcenter/baggage/arrow_next.svg)Example 3. Getting Cmdlets by Verb

|  |  |
| --- | --- |
| This command returns a list of cmdlets whose names contain the Get verb.  |  | | --- | | Get-VETCommand -Verb Get | |

![](//img.veeam.com/helpcenter/baggage/arrow_next.svg)Example 4. Getting Cmdlets that Contain Specific Noun

|  |  |
| --- | --- |
| This command returns a list of cmdlets whose names contain the VETItem noun.  |  | | --- | | Get-VETCommand -Noun VETItem | |
