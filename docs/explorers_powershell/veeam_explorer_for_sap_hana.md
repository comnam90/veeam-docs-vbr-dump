---
title: "Veeam Explorer for SAP HANA"
product: "vbr"
...
| [Get-VEHANARestoreSession](get-vehanarestoresession.md) | Returns active restore sessions started to perform operations with backed-up SAP HANA databases. |
| [Stop-VEHANARestoreSession](stop-vehanarestoresession.md) | Stops an active restore session started to perform operations with backed-up SAP HANA databases. |
| [Get-VEHANASystem](get-vehanasystem.md) | Returns information about a backed-up SAP HANA system. |
| [Get-VEHANADatabase](get-vehanadatabase.md) | Returns backed-up SAP HANA databases. |
...
| [Enable-VEHANAExtendedLogging](enable-vehanaextendedlogging.md) | Enables the extended logging mode for Veeam Explorer for SAP HANA. |
| [Disable-VEHANAExtendedLogging](disable-vehanaextendedlogging.md) | Disables the extended logging mode for Veeam Explorer for SAP HANA. |
