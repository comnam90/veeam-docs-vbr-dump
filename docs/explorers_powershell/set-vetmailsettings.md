---
title: "Set-VETMailSettings"
product: "vbr"
doc_type: "explorers_powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/explorers_powershell/set-vetmailsettings.html"
...
Modifies Veeam Explorer for Microsoft Teams email settings. Veeam Explorer for Microsoft Teams uses these settings to send Microsoft Teams posts and files as attachments in email messages and deliver export reports.
...
|  |
| --- |
| Set-VETMailSettings [-EnableSendingEmails] [-Server <String>] [-Port <Int32>] [-UseAuthentication] [-UseSSL] [-Credentials <PSCredential>] -From <String> [<CommonParameters>] |

* Modify email settings to use a Google account for authentication.

|  |
| --- |
| Set-VETMailSettings [-EnableSendingEmails] [-GoogleGmail] [-ClientId <String>] [-ClientSecret <SecureString>] [<CommonParameters>] |

* Modify email settings to use a Microsoft 365 account for authentication.

|  |
| --- |
| Set-VETMailSettings [-EnableSendingEmails] [-ClientId <String>] [-Microsoft365] [-MailApiUrl <String>] [-TenantId <String>] [<CommonParameters>] |

Detailed Description

This cmdlet modifies email settings for Veeam Explorer for Microsoft Teams. To modify settings, you need to enter the necessary parameters with new values. The parameters that you omit will remain unchanged.

|  |
| --- |
| Note |
| Email settings are global, they will be applied to all operations configured in Veeam Explorer for Microsoft Teams. |

Parameters

| Parameter | Description | Type | Required | Position | Accept Pipeline Input |
| --- | --- | --- | --- | --- | --- |
| EnableSendingEmails | Defines that Veeam Explorer for Microsoft Teams will send email messages.  Default: False | SwitchParameter | False | Named | False |
...
| UseSSL | Defines that Veeam Explorer for Microsoft Teams will enable a secure connection for sending emails. If you do not provide this parameter, email messages will be sent through the connection that does not require SSL authentication.  Default: False | SwitchParameter | False | Named | False |
...
| GoogleGmail | Defines that Veeam Explorer for Microsoft Teams will send email messages on behalf of a Google account.  Default: False | SwitchParameter | True | Named | False |
...
| Microsoft365 | Defines that Veeam Explorer for Microsoft Teams will send email messages on behalf of a Microsoft 365 account.  Default: False | SwitchParameter | True | Named | False |
...
|  |  |
| --- | --- |
| This command sends email messages through the default SMTP server with basic authentication.  |  | | --- | | Set-VETMailSettings -EnableSendingEmails -Server smtp.office365.com -Port 25 -From vet@tech.com |  Run the Set-VETMailSettings cmdlet and specify the following settings:   * Provide the EnableSendingEmails parameter.  * Specify the Server parameter value. * Specify the Port parameter value.  * Specify the From parameter value. |
...
|  |  |
| --- | --- |
| This command configures email messages with the following settings:   * Email messages will be sent on behalf of the Google account. * Authentication to Google will be performed using an application preinstalled by Veeam.   |  | | --- | | Set-VETMailSettings -EnableSendingEmails -GoogleGmail |  Run the Set-VETMailSettings cmdlet and specify the following settings:   * Provide the EnableSendingEmails parameter. * Provide the GoogleGmail parameter. |
