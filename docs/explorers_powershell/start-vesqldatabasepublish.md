---
title: "Start-VESQLDatabasePublish"
product: "vbr"
doc_type: "explorers_powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/explorers_powershell/start-vesqldatabasepublish.html"
last_updated: "2026"
...
* Publish a database using the credentials specified in the backup job.

|  |
| --- |
| Start-VESQLDatabasePublish [-Database] <VESQLDatabase> [-DatabaseName <String>] -ServerName <String> [-InstanceName <String>] [-Port <Int32>] [-ToPointInTimeUtc <DateTime>] [-Force] [<CommonParameters>] |

* Publish a database using explicitly provided credentials.

|  |
| --- |
| Start-VESQLDatabasePublish [-Database] <VESQLDatabase> [-DatabaseName <String>] -ServerName <String> [-InstanceName <String>] [-Port <Int32>] [-UseSQLAuthentication] -SqlCredentials <PSCredential> [-GuestCredentials <PSCredential>] [-ToPointInTimeUtc <DateTime>] [-Force] [<CommonParameters>] |

* Publish a database using a Group Managed Service Account (gMSA) for authentication.

|  |
| --- |
| Start-VESQLDatabasePublish [-Database] <VESQLDatabase> [-DatabaseName <String>] -ServerName <String> [-InstanceName <String>] [-Port <Int32>] -GMSAAccount <String> [-ToPointInTimeUtc <DateTime>] [-Force] [<CommonParameters>] |
...
| ToPointInTimeUtc | Specifies a point in time within the restore interval of a Microsoft SQL Server database.  The cmdlet will publish the database to the state of the specified point in time.  Note: Make sure that the value you assign to this parameter is converted to Universal Coordinated Time (UTC). | DateTime | False | Named | False |
...
The cmdlet returns the [VESQLDatabasePublish](vesqldatabasepublish.md) object that contains a published Microsoft SQL Server database.
...
2. Run the Start-VESQLDatabasePublish cmdlet. Specify the following settings:
