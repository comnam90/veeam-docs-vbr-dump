...
| Recurse | Defines that the cmdlet will return Active Directory objects with their child objects. For example, the Computer object can contain Shared Folder and Printer objects. | SwitchParameter | False | 3 | False |
