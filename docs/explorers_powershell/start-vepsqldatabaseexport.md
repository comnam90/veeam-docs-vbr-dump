...
| Database | Specifies a backed-up PostgreSQL database that you want to export. | Accepts the [VEPSQLDatabase](vepsqldatabase.md) type. To get this object, run the [Get-VEPSQLDatabase](get-vepsqldatabase.md) cmdlet. | True | 0 | True (ByValue) |
...
| LinuxTargetHost | Specifies the name of the target Linux server. | String | False | 4 | True (ByValue) |
