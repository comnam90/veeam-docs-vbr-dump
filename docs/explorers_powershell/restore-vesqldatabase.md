...
| ServerName | For restore to another location.  Specifies DNS name or IP address of a target SQL server. The cmdlet will restore a Microsoft SQL Server database to the specified target server. | String | False | Named | False |
