---
title: "Start-VESQLDatabaseRestore"
product: "vbr"
doc_type: "explorers_powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/explorers_powershell/start-vesqldatabaserestore.html"
last_updated: "2026"
...
* Restore a database using the credentials specified in the backup job.

|  |
| --- |
| Start-VESQLDatabaseRestore [-Database] <VESQLDatabase> [-DatabaseName <String>] [-ServerName <String>] [-InstanceName <String>] [-Port <Int32>] [-ToPointInTimeUtc <DateTime>] [-AvailabilityGroupName <String>] [-TargetFolder <String>] [-File <VESQLDatabaseFile[]>] [-TargetPath <String[]>] [-Force] [-RecoveryState <RestoreMode>] [-StandbyFilePath <String>] [<CommonParameters>] |

* Restore a database by specifying custom credentials.
...
* Restore a database using a Group Managed Service Account (gMSA).

|  |
| --- |
| Start-VESQLDatabaseRestore [-Database] <VESQLDatabase> [-DatabaseName <String>] [-ServerName <String>] [-InstanceName <String>] [-Port <Int32>] -GMSAAccount <String> [-ToPointInTimeUtc <DateTime>] [-AvailabilityGroupName <String>] [-TargetFolder <String>] [-File <VESQLDatabaseFile[]>] [-TargetPath <String[]>] [-Force] [-RecoveryState <RestoreMode>] [-StandbyFilePath <String>] [<CommonParameters>] |

Detailed Description

This cmdlet restores a backed-up Microsoft SQL Server database. You can restore a Microsoft SQL Server database to the original location or to another location.
...
| ServerName | For restore to another location.  Specifies DNS name or IP address of a Microsoft SQL target server. The cmdlet will restore a Microsoft SQL Server database to the specified target server. | String | False | Named | False |
...
| GMSAAccount | For restore using gMSA.  Specifies a gMSA that will be used to authenticate to the target server and the Microsoft SQL Server instance. | String | True | Named | False |
...
| ToPointInTimeUtc | Specifies a point in time in UTC within the restore interval of a Microsoft SQL Server database.  The cmdlet will restore the database to the state of the specified point in time. | DateTime | False | Named | False |
| AvailabilityGroupName | Specifies the name of the AlwaysOn availability group. The cmdlet will add a Microsoft SQL Server database to the specified group. | String | False | Named | False |
| TargetFolder | For restoring Microsoft SQL Server database files to one location.  Specifies the destination folder. The cmdlet will restore all database files to that folder.  Note: This parameter is not available if you use the TargetPath parameter. | String | False | Named | False |
...
The cmdlet returns the [VESQLDatabaseRestore](vesqldatabaserestore.md) object that contains details on the restore job for a Microsoft SQL Server database.
