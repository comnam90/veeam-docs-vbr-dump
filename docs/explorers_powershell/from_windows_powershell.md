...
|  |
| --- |
| dnf install https://repository.veeam.com/rocky/9.2/vbr/13.0/optional/x86\_64/veeam-optional-release-latest-13.0.2.29-1.x86\_64.rpm -y |
...
|  |
| --- |
| dnf install veeam-powershell -y  dnf install veeam-vbr-pkg-mount.x86\_64 veeam-vbr-pkg-transport.x86\_64 veeam-vbr-pkg-deployment.x86\_64 -y  dnf install /opt/veeam/vbr/Packages/veeamdeployment-13.0.2.29-1.x86\_64.rpm -y  dnf install /opt/veeam/vbr/Packages/veeam-mount-13.0.2.29-1.x86\_64.rpm -y  dnf install /opt/veeam/vbr/Packages/veeamtransport-13.0.2.29-1.x86\_64.rpm -y |
