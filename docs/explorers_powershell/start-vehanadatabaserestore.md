...
| UseSSL | Defines that Veeam Explorer for SAP HANA will use the TLS protocol to establish a secure connection to the target SAP HANA system. | SwitchParameter | False | Named | False |
