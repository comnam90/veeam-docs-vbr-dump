...
| --- |
| Note |
| In Veeam Backup & Replication 13.1, this cmdlet became deprecated. Use the [Start-VEADItemExport](start-veaditemexport.md) cmdlet to export Active Directory objects and containers. |
