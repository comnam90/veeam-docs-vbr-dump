...
| LinuxCredentials | Specifies Linux credentials that the cmdlet will use to connect to the Linux machine. | Accepts the [VEPSQLLinuxCredential](vepsqllinuxcredential.md) object. To get this object, run the [New-VEPSQLLinuxCredential](new-vepsqllinuxcredential.md) cmdlet. | False | Named | True (ByValue) |
