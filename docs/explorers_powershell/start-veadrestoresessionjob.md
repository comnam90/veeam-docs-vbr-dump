---
title: "Start-VEADRestoreSessionJob"
product: "vbr"
doc_type: "explorers_powershell"
source_url: "https://helpcenter.veeam.com/docs/vbr/explorers_powershell/start-veadrestoresessionjob.html"
last_updated: "2026"
...
* Run the [Start-VEADItemRestore](start-veaditemrestore.md) cmdlet to restore Microsoft Active Directory objects and containers.
* Run the [Start-VEADItemExport](start-veaditemexport.md) cmdlet to export Microsoft Active Directory objects and containers.
...
The cmdlet returns the [VEADRestoreSessionJob](veadrestoresessionjob.md) object that contains settings of the restore session started to explore backed-up Microsoft Active Directory data and to perform operations with this data.
...
1. Run the Start-VEADRestoreSessionJob cmdlet. Set the $restorepoint variable as the RestorePoint parameter value and select the necessary restore point.
