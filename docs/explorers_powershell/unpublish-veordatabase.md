...
| Databases | Specifies the Oracle databases that the cmdlet will unpublish from the target Oracle server. | Accepts the [VEORPublishedDatabase](veorpublisheddatabase.md)[] object. To get this object, run the [Get-VEORPublishedDatabase](get-veorpublisheddatabase.md) cmdlet. | True | 0 | True (ByValue) |
