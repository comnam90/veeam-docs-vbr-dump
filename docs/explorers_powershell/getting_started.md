...
| Veeam.SharePoint.PowerShell | Veeam Explorer for Microsoft SharePoint and Veeam Explorer for Microsoft OneDrive | ✔ | ✔ |
...
To see a version of this document that only contains information on the modules that come with Veeam Backup for Microsoft 365 installations, see [Veeam Explorers PowerShell Reference](https://helpcenter.veeam.com/docs/vbo365/explorers_powershell/getting_started.html?ver=8).
