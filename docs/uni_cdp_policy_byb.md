...
* Check that all the required components are added to the backup infrastructure. For more information on the required components, see [Backup Infrastructure for Universal CDP](uni_cdp_infrastructure.md).
