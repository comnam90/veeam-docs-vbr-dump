...
In Veeam Explorer for Microsoft Exchange, you can connect to a service provider server to add its backups to the application scope and perform data restore operations directly from such backups.

|  |
| --- |
| Note |
| Make sure that both Veeam Explorer for Microsoft Exchange and Veeam Backup & Replication are installed on the same server and at least one service provider is added to Veeam Backup & Replication. For more information, see the [Connecting to Service Providers](https://helpcenter.veeam.com/docs/vbr/cloud/cloud_connect_sp.html?ver=13) section of the Veeam Cloud Connect Guide. |

To add Veeam Backup for Microsoft 365 service providers, do the following:

1. Do one of the following:

* On the Home tab, click Add Store > Veeam Backup for Microsoft 365 service provider on the ribbon.
* Right-click the All Stores node and select Add Veeam Backup for Microsoft 365 service provider.
