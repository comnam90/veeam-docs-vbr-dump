...
![Custom List Settings](images/list_templates.webp "Configuring Custom Lists")

See the next figure showing you what custom list templates are available.

![Custom List Settings](images/custom_lists_path_2.webp "Configuring Custom Lists")
...
![Custom List Settings](images/custom_lists_path.webp "Importing Templates Manually")
...
![Custom List Settings](images/templates_options.webp "Adding Custom List Templates")
