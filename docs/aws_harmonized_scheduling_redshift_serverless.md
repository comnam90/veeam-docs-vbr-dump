...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_harmonized_scheduling_redshift_serverless.html"
last_updated: "2026"
...
With harmonized scheduling, the backup appliance can keep restore points created according to a daily, weekly or monthly schedule for longer periods of time: Redshift backups can be kept for weeks, months and years.
...
[![Enabling Harmonized Scheduling](images/aws_redshift_serverless_policy_harmonized_daily.webp)](images/aws_redshift_serverless_policy_harmonized_daily.webp "Enabling Harmonized Scheduling")
...
[![Enabling Harmonized Scheduling](images/aws_redshift_serverless_policy_harmonized_weekly.webp)](images/aws_redshift_serverless_policy_harmonized_weekly.webp "Enabling Harmonized Scheduling")

According to the specified scheduling settings, the backup appliance will create Redshift Serverless backups in the following way:
...
[![Creating Redshift Backup Policy](images/aws_retention_backups_daily_weekly_redshift.webp)](images/aws_retention_backups_daily_weekly_redshift.webp "Creating Redshift Backup Policy")
...
[![Creating Redshift Backup Policy](images/aws_retention_backups_daily_removed_redshift.webp)](images/aws_retention_backups_daily_removed_redshift.webp "Creating Redshift Backup Policy")
...
[![Creating Redshift Backup Policy](images/aws_retention_backups_daily_rp_removed_redshift.webp)](images/aws_retention_backups_daily_rp_removed_redshift.webp "Creating Redshift Backup Policy")
...
[![Creating Redshift Backup Policy](images/aws_retention_backups_weekly_rp_removed_redshift.webp)](images/aws_retention_backups_weekly_rp_removed_redshift.webp "Creating Redshift Backup Policy")
