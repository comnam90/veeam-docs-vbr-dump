...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/plugins_sap_maxdb_deploy_repo_permissions.html"
...
* Consider supported types of backup repositories and limitations for Veeam Plug-In backups in [Veeam Backup Repositories](plugins_sap_maxdb_overview_data_backup_repos.md).
...
![Access and Encryption Settings on Repositories](images/plugins_repository_permissions_users.webp)
