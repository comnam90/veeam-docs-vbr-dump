...
When you disable a protection group, Veeam Backup & Replication does not start the rescan job upon schedule defined in the protection group settings. However, you can start the discovery process manually. To learn more, see [Rescanning Protection Group](mongo_protection_group_rescan.md).
