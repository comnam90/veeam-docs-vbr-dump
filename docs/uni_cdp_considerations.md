...
* If you reboot a workload with the RAW, FAT, FAT32 or exFAT file system, Veeam Backup & Replication starts the initial synchronization process for this workload. For other file systems, Veeam Backup & Replication continues the incremental synchronization.
