...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/postgresql_backup_hv.html"
...
* [WAL Files PostgreSQL Backup Jobs](postgresql_backup_hiw_hv.md)
* [How PostgreSQL WAL Files Backup Works](postgresql_backup_job_hv.md)
* [Retention for PostgreSQL WAL Files](postrgresql_backup_retention_hv.md)
* [Log Shipping Servers](postgresql_log_shipping_hv.md)
* [WAL Backup Statistics](postrgesql_statistics_hv.md)
