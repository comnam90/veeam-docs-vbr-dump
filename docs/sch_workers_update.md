...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sch_workers_update.html"
...
1. At the Networks step of the Edit Scale Computing HyperCore Worker wizard, click Advanced and clear the Check for updates online check box. Then, click Finish to save changes made to the worker settings.
   ...
   [![Updating Workers](images/sch_workers_update.webp)](images/sch_workers_update.webp "Updating Workers")
