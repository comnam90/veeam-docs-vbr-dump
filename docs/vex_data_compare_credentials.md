...
![Step 1. Select Authentication Method](images/compare_online_modern.webp "Select Authentication Method")
...
|  |  |  |
| --- | --- | --- |
| Perform the following steps:   1. Select the Select certificate from the Certificate Store of this server option.   ![Step 1. Select Authentication Method](images/select_certificate_wizard_step1_type_2.webp "Selecting Certificate")   1. Select the certificate from the certificate store and click Finish.   |  | | --- | | Note | | A TLS certificate that you want to use must be added to the Personal certificate store. It also must have a private exportable key. |  ![Step 1. Select Authentication Method](images/select_certificate_wizard_step2_pick_from_store.webp "Selecting Certificate") |

![](//img.veeam.com/helpcenter/baggage/arrow_next.svg)Import a TLS certificate from a file in the PFX format

|  |  |  |
| --- | --- | --- |
| Perform the following steps:   1. Select the Import certificate from a PFX file option.   ![Step 1. Select Authentication Method](images/select_certificate_wizard_step1_type_3.webp "Importing Certificate")   1. Click Browse and select a PFX file. Specify the certificate password if required.   |  | | --- | | Note | | A TLS certificate that you want to use must have a private exportable key. |  ![Step 1. Select Authentication Method](images/select_certificate_wizard_step2_import_file.webp "Importing Certificate")   1. Click Finish. |

![Step 1. Select Authentication Method](images/compare_online_modern_certificate.webp "Select Authentication Method")
...
![Step 1. Select Authentication Method](images/compare_on.webp "Select Authentication Method")
