...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/tape_add_amazon_s3_account.html"
...
2. From the Data center region drop-down list, select a region.

![Step 2. Specify Account Settings](images/snippet_os_s3_aws_account.webp)
