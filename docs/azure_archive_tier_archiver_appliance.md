...
2. You can use the default settings or customize the archiver appliance. Click Customize and in the Helper Appliance Settings window specify the following settings:
