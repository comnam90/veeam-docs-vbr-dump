...
1. In the installation disk folder, go to Plugins\SAP MaxDB\AIX\ppc64 and find the VeeamPluginforSAPMaxDB-13.1.0.411-1.aix6.1.ppc.rpm file.

1. Upload the Veeam Plug-In installation package (VeeamPluginforSAPMaxDB-13.1.0.411-1.aix6.1.ppc.rpm) to the IBM AIX server where the target SAP MaxDB database is deployed.
...
2. Open the setup archive, in the \VeeamPluginforSAPMaxDB-13.1.0.411\AIX\ppc64 directory, find the VeeamPluginforSAPMaxDB-13.1.0.411-1.aix6.1.ppc.rpm file.
3. Upload the Veeam Plug-In installation package (VeeamPluginforSAPMaxDB-13.1.0.411-1.aix6.1.ppc.rpm) to the IBM AIX server where the target SAP MaxDB database is deployed.

1. Install the plug-in from package with root privileges. Make sure the root user has privileges to add the PKG file.

|  |
| --- |
| rpm -i VeeamPluginforSAPMaxDB-13.1.0.411-1.aix6.1.ppc.rpm |
