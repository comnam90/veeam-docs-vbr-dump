---
title: "Performing VM Restore Using Web UI"
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_restore_to_pve_web.html"
last_updated: "2026"
...
1. [Launch the Entire VM Restore wizard](pve_restore_entire_vm_launch_web.md).
2. [Select a restore point](pve_restore_entire_vm_select_vms_web.md).
3. [Choose a restore mode](pve_restore_entire_vm_mode_web.md).
4. [Specify a target cluster](pve_restore_entire_vm_target_web.md).
5. [Specify a name for the restored VM](pve_restore_entire_vm_name_web.md).
6. [Select a storage where VM virtual disks will be stored](pve_restore_entire_vm_storage_web.md).
7. [Configure network settings](pve_restore_entire_vm_network_web.md).
8. [Specify a restore reason](pve_restore_entire_vm_reason_web.md).
9. [Verify restore settings](pve_restore_entire_vm_summary_web.md).
