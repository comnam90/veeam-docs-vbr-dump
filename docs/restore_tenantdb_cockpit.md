...
[![System Overview](images/plugins_tenant_recovery_manage_dbs.webp)](images/plugins_tenant_recovery_manage_dbs.webp "System Overview")

1. In the Manage Databases page, expand the toolbar options and select Recover Tenant.

[![Manage Databases](images/plugins_tenant_recovery_launch.webp)](images/plugins_tenant_recovery_launch.webp "Manage Databases")
...
[![Recovery Target](images/plugins_tenant_recovery_target.webp)](images/plugins_tenant_recovery_target.webp "Recovery Target")

1. Specify the location of the latest backup catalog and click Step 3.

[![Specify Backup Location](images/plugins_tenant_recovery_catalog_location.webp)](images/plugins_tenant_recovery_catalog_location.webp "Specify Backup Location")

1. At the Backup to be Used step, select the backup and click Step 4.

[![Backup to be Used](images/plugins_tenant_recovery_select_backup.webp)](images/plugins_tenant_recovery_select_backup.webp "Backup to be Used")

1. At the Delta Backups step, select Yes to use delta backups.

[![Delta Backups](images/plugins_tenant_recovery_delta_backups.webp)](images/plugins_tenant_recovery_delta_backups.webp "Delta Backups")
...
[![Specify Alternative Backup Locations](images/plugins_tenant_recovery_alternative_backup_location.webp)](images/plugins_tenant_recovery_alternative_backup_location.webp "Specify Alternative Backup Locations")
...
[![Check Availability of Backups](images/plugins_tenant_recovery_check_availability.webp)](images/plugins_tenant_recovery_check_availability.webp "Check Availability of Backups")
...
[![Initialize Log Area](images/plugins_tenant_recovery_initialize_log_area.webp)](images/plugins_tenant_recovery_initialize_log_area.webp "Initialize Log Area")

1. Review the recovery options and click Start Recovery.

[![Review Recovery Options](images/plugins_tenant_recovery_review.webp)](images/plugins_tenant_recovery_review.webp "Review Recovery Options")
