...
* The machine that will operate as a WAN accelerator must meet the system requirements. For more information, see [System Requirements](system_requirements_wan_accelerator.md).
