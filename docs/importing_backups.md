...
* Manually imported backups do not have an assigned repository. Veeam Backup & Replication server will perform the role of the mount server in case of the manual import.
...
* [Importing Encrypted Backups](import_encrypted.md)
