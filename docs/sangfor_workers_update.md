...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/sangfor_workers_update.html"
last_updated: "2026"
...
1. At the Networks step of the Edit Sangfor aSV Worker wizard, click Advanced and clear the Check for updates online check box. Then, click Finish to save changes made to the worker settings.

[![Disabling Automatic Worker Updates](images/sangfor_worker_update.webp)](images/sangfor_worker_update.webp)
