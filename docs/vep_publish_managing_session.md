...
Under the Publish node in the upper part of the navigation pane, you can find the instances with an ongoing or completed publishing process. Click an instance to get a more detailed overview of the publishing process in the preview pane.

Also, in the publishing session view, you can do the following:

* [Export data from the published instance](vep_published_export.md).
