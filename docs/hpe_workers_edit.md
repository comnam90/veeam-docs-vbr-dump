...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_workers_edit.html"
last_updated: "2026"
...
1. Complete the Edit HPE Morpheus VM Essentials Worker wizard:

1. To provide a new name and description for the worker or to modify the number of tasks that the worker is able to handle in parallel, follow the instructions provided in section [Adding Workers](hpe_workers_add_vm.md) (step 2).
2. To change the network to which the worker is connected or to specify a new IP address for the worker, follow the instructions provided in section [Adding Workers](hpe_workers_add_network.md) (step 3).
...
[![Editing Workers](images/hpe_workers_edit.webp)](images/hpe_workers_edit.webp "Editing Workers")
