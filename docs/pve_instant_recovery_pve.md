...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pve_instant_recovery_pve.html"
last_updated: "2026"
...
You can immediately restore virtual or physical machines into a Proxmox VE host by running it directly from a compressed and deduplicated backup file. Before you perform Instant Recovery, check the following prerequisites:
...
1. [Check prerequisites and limitations](pve_instant_recovery_byb.md).
2. [Launch the Instant Recovery wizard](pve_instant_recovery_launch.md).
3. [Choose a restore point](pve_instant_recovery_vms.md).
4. [Choose a restore mode](pve_instant_recovery_mode.md).
5. [Specify a target host](pve_instant_recovery_target_host.md).
6. [Select storage](pve_instant_recovery_target_storage.md).
7. [Specify a name for the restored VM](pve_instant_recovery_vm_name.md).
8. [Configure network settings](pve_instant_recovery_network.md).
9. [Specify a restore reason](pve_instant_recovery_reason.md).
10. [Review the configured settings](pve_instant_recovery_summary.md).
11. [Finalize the recovery process](pve_instant_recovery_finalize.md).
