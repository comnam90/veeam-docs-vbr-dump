...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/saphana_bfiles.html"
...
* A .VAB file stores a compressed copy of a SAP HANA database. Veeam Plug-In creates .VAB files for full, incremental and log backups.
