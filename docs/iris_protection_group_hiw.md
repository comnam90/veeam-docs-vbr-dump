---
title: "Protection Group for InterSystems IRIS Instances"
product: "vbr"
doc_type: "userguide"
...
# Protection Group for InterSystems IRIS Instances


In Veeam Backup & Replication, computers that you want to protect with Epic EHR System Protection are organized into protection groups. A protection group is a container in the Veeam Backup & Replication inventory aimed to combine protected computers of a specific type.
...
Veeam Backup & Replication connects to discovered computers using an administrative account or a certificate specified in the protection group settings. To learn more, see [Creating Protection Group for InterSystems IRIS Instances](iris_protection_group_create.md).
