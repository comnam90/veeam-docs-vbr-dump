...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/pg_csv_file_advanced.html"
...
* [Veeam Agent for Microsoft Windows settings](pg_csv_file_advanced_vaw.md)
* [Notification settings](pg_csv_file_advanced_notify.md)

|  |
| --- |
| ![Step 6. Specify Advanced Protection Group Settings](images/icon_tip.webp) TIP |
