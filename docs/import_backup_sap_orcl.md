...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/import_backup_sap_orcl.html"
...
1. On the SAP on Oracle server, change the target backup repository in the Veeam Plug-In settings:
