...
To restore workloads to Scale Computing HyperCore, you can use the following backups:
...
The restore procedure of entire workloads to Scale Computing HyperCore practically does not differ from the procedure described in the [Performing VM Restore](https://helpcenter.veeam.com/docs/vpsch/userguide/restore_entire_vm.html?ver=2) section in the Veeam Plug-In for Scale Computing HyperCore User Guide.
