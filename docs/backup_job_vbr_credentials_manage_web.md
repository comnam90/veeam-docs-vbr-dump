...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/backup_job_vbr_credentials_manage_web.html"
...
To display a user in the Credentials list, you must add the user to the Credentials Manager as described in section [Credentials Manager](credentials_manager.md). If you have not added the necessary user to the Credentials Manager beforehand, you can do it without closing the New Job wizard. To do that, click either the Add button, and specify the user name, password and description in the Guest OS Credentials window.
