...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/specify_target_mailbox_mfa.html"
...
You can also restore data from backups created for Exchange Online organizations to on-premises Microsoft Exchange servers and vice versa. For more information, see [Restore to On-Premises Microsoft Servers](restore_to_onprem.md).
