...
1. In the File location list, select the necessary configuration file or virtual disk and click Path. To select multiple objects at once, press and hold [Ctrl] or [Shift].
