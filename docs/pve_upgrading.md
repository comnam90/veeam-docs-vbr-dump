...
Ensure that Veeam Plug-in for Proxmox VE has been upgraded to version 1.3 or 1.5. For more information see the Veeam Plug-in for Proxmox VE User Guide, section [Installing Proxmox VE Plug-in Manually](https://helpcenter.veeam.com/archive/vbproxmoxve/1/userguide/install_plugin.html).
