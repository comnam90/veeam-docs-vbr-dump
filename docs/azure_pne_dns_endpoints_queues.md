...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/azure_pne_dns_endpoints_queues.html"
last_updated: "2025"
...
1. In the Private endpoint connections tab of the Networking window of the Veeam storage account selected at [step 6a](azure_pne_dns_endpoints_locate.md), locate the private endpoint created for Azure Queue Storage. To do that, click the link in the Private endpoint column. The private endpoint for Azure Queue Storage will have the queue value set in the Target sub-resource field.
...
3. From the Virtual network drop-down list, select the name of the VNet and click OK.
