...
[![Overall Database Status](images/sysdb_recovery_db_shutdown.webp)](images/sysdb_recovery_db_shutdown.webp "Overall Database Status")
...
[![Manage Services](images/sysdb_recovery_db_shutdown_confirm.webp)](images/sysdb_recovery_db_shutdown_confirm.webp "Manage Services")
...
[![System Overview](images/sysdb_recovery_launch.webp)](images/sysdb_recovery_launch.webp "System Overview")
...
[![Recovery Target](images/sysdb_recovery_target.webp)](images/sysdb_recovery_target.webp "Recovery Target")

1. Specify the location of the latest backup catalog and click Step 3.

[![Specify Backup Location](images/sysdb_recovery_catalog_location.webp)](images/sysdb_recovery_catalog_location.webp "Specify Backup Location")

1. At the Backup to be Used step, select the backup and click Step 4.

[![Backup to be Used](images/sysdb_recovery_select_backup.webp)](images/sysdb_recovery_select_backup.webp "Backup to be Used")
...
[![Specify Alternative Backup Locations](images/sysdb_recovery_alternative_location.webp)](images/sysdb_recovery_alternative_location.webp "Specify Alternative Backup Locations")
...
[![Check Availability of Backups](images/sysdb_recovery_check_availability.webp)](images/sysdb_recovery_check_availability.webp "Check Availability of Backups")
...
[![Initialize Log Area](images/sysdb_recovery_initialize_log.webp)](images/sysdb_recovery_initialize_log.webp "Initialize Log Area")

1. Review the recovery options and click Start Recovery.

[![Review Recovery Options](images/sysdb_recovery_review.webp)](images/sysdb_recovery_review.webp "Review Recovery Options")
