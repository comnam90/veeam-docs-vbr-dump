...
| --- |
| Tip |
| You can also switch back to original VMs, discard all changes made to their replicas while they were running, and power off these replicas. To do that, follow the instructions provided in section [Undoing Failover](pve_failover_undo.md). |
