...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_export_logs.html"
last_updated: "2026"
...
If you have any questions or issues with Veeam Plug-in for Universal Hypervisor API, you can search for a resolution on [Veeam R&D Forums](https://forums.veeam.com/) or submit a support case in the [Veeam Customer Support Portal](https://www.veeam.com/support.html).
...
1. In the program list, check the version of Veeam Plug-in for Universal Hypervisor API.

[![Viewing Product Details](images/uh_plugin_version.webp)](images/uh_plugin_version.webp "Viewing Product Details")
...
4. In the Edit Manager wizard, click Finish.
5. Wait for Veeam Backup & Replication to complete the configuration check and click Next.

At the Summary step of the wizard, the following information will be displayed:

* Universal Hypervisor Manager hostname or IP address
* Current version of universal hypervisor
* Account that is used to connect to the Universal Hypervisor Manager

![Getting Technical Support](images/uh_server_edit_version.webp)
...
[![Exporting Logs Using Veeam Backup & Replication Console](images/uh_logs_vbr.webp)](images/uh_logs_vbr.webp "Exporting Logs Using Veeam Backup & Replication Console")
