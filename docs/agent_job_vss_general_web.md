...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_job_vss_general_web.html"
last_updated: "2026"
...
1. On the General tab, in the Applications section, select Require successful processing to enable application-aware processing for this computer or protection group. Veeam Backup & Replication will fail the backup job if application processing fails.

To disable application-aware processing for a specific computer added to the backup job as a part of a protection group, select Disable application processing.
...
[For Microsoft SQL Server and Oracle] You will have to specify settings for database log handling on the SQL and Oracle tabs of the Processing Settings window. For more information, see [Microsoft SQL Server Transaction Log Settings](agent_job_vss_sql_web.md) and [Oracle Archived Log Settings](agent_job_vss_oracle_web.md).
...
[![Application-Aware Processing](images/agent_job_vss_general_web.webp)](images/agent_job_vss_general_web.webp "Application-Aware Processing")
