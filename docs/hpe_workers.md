...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_workers.html"
...
| --- |
| Important |
| To modify the worker settings, use the Veeam Backup & Replication console as described in section [Editing Workers](hpe_workers_edit.md). Making any configuration changes to VMs running as workers manually in the HPE Morpheus VM Essentials administration portal may cause technical issues. |
...
* [Adding Workers](hpe_workers_add.md)
* [Testing Workers](hpe_workers_test.md)
* [Enabling and Disabling Workers](hpe_workers_disable.md)
* [Editing Workers](hpe_workers_edit.md)
* [Disabling Automatic Worker Updates](hpe_workers_update.md)
* [Removing Workers](hpe_workers_remove.md)
