...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/preferred_network_mssql.html"
...
|  |
| --- |
| MSSQLConfigTool.exe --add-preferred-network <network\_IP\_address> <position\_in\_list> |
...
|  |
| --- |
| MSSQLConfigTool.exe --remove-preferred-network <network\_IP\_address> |
