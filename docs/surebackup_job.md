...
To overcome the situation of job overlapping, you may chain the backup and SureBackup jobs or define the timeout period for the SureBackup job. For more information, see [Specifying Job Schedule](surebackup_job_schedule_vm.md).

Related Topics

* [SureBackup Job Processing](surebackup_job_processing_vm.md)
