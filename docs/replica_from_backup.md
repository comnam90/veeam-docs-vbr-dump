...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/replica_from_backup.html"
...
Although replica from backup may resemble [replica seeding](replica_seeding.md), there is difference between these options:
...
* [How Replica from Backup Works](replica_from_backup_hiw.md)
