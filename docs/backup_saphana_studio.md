...
[![Perform Backint Backup](images/saphana_backup_studio_launch.webp)](images/saphana_backup_studio_launch.webp "Perform Backint Backup")
...
[![Destination Type](images/saphana_backup_studio_settings.webp)](images/saphana_backup_studio_settings.webp "Destination Type")

1. In the Review Backup Settings step of the wizard, click Finish to start the backup process.

[![Review Backup Settings](images/saphana_backup_studio_finish.webp)](images/saphana_backup_studio_finish.webp "Review Backup Settings")
