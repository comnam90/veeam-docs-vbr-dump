...
Before you begin, review the [limitations of database processing](agents_backup_linux_dbs_processing.md#limitations).
...
* [General Settings](agent_job_guest_general.md)
* [Processing settings for Oracle database system](agent_job_guest_oracle.md)
* [Processing settings for MySQL database system](agent_job_guest_mysql.md)
* [Processing settings for PostgreSQL database system](agent_job_guest_postgresql.md)
* [Backup job and snapshot script settings](agent_job_guest_scripts.md)
...
1. Configure file indexing settings for the selected protection group or individual computer. To learn more, see [File Indexing](agent_job_guest_indexing.md).
