...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/specify_credentials_doc.html"
...
![Step 2. Specify Credentials](images/restore_modern_auth.webp "Select Authentication Method")
...
![Step 2. Specify Credentials](images/restore_basic_auth.webp "Select Authentication Method")
...
![Step 2. Specify Credentials](images/on_premises_restore.webp "Select Authentication Method")
...
| --- |
| Note |
| When restoring Microsoft SharePoint documents and list items from a Microsoft SQL Server database, you will proceed directly to the [Specify Restore Options](vesp_restore_item_doc.md) step of the wizard. |

For more information on how to restore Microsoft SharePoint documents and list items from a Microsoft SQL Server database, see [Restoring Documents and List Items](vesp_vbr_restore_items.md).

![Step 2. Specify Credentials](images/vbr_target_site.webp "Restoring from Microsoft SQL Server Database")
