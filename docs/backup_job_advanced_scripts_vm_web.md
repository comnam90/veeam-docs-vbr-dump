...
* If you select the Run scripts on the selected days only option, from the drop-down list select week days on which the scripts must be executed.
...
[![Specify script settings](images/vm_backup_job_settings_adv_web.webp)](images/vm_backup_job_settings_adv_web.webp "Specify script settings")
