...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_advanced_backup_linux_web.html"
last_updated: "2026"
...
| --- |
| NOTE |
| Consider the following:   * Before scheduling periodic full backups, you must make sure that you have enough free space on the target location. For more information about periodic full backups, see the [Active Full Backup](https://helpcenter.veeam.com/docs/agentforlinux/userguide/active_full_backup.html?ver=13) and [Synthetic Full Backup](https://helpcenter.veeam.com/docs/agentforlinux/userguide/synthetic_full_backup.html?ver=13) sections in the Veeam Agent for Linux User Guide. * If you schedule the active full backup and synthetic full backup on the same day, Veeam Agent for Linux will perform only active full backup. Synthetic full backup will be skipped. |

[![Specify Backup Settings](images/agent_policy_settings_backup_linux_web.webp)](images/agent_policy_settings_backup_linux_web.webp "Specify Backup Settings")
