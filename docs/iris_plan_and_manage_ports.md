...
The following table describes the network ports that must be opened to ensure proper communication of the infrastructure components used to protect InterSystems IRIS instances. For the general port requirements of the backup server, see [Ports](used_ports.md) for Veeam Backup & Replication.
