...
1. [Launch the New Media Pool wizard](launch_media_pool_wizard.md).
2. [Specify a media pool name](add_media_pool_name.md).
3. [Add tapes to the media pool](add_media_pool_tapes.md).
4. [Specify media set options](add_media_pool_set.md).
5. [Specify retention settings](add_media_pool_retention.md).
