...
* [Instant Recovery to VMware vSphere](storage_instant_recovery.md)
* [Instant Disk Recovery](storage_instant_disc_recovery.md)
* [Guest OS File Restore](storage_flr_win.md)
* [Application item restore](restore_veeam_explorers_snapshots.md)

In This Section

* [Traditional Restore vs. Restore from Storage Snapshots](traditional_storage.md)
* [How Restore from Storage Snapshots Works](restore_storage_snapshots_hiw_hp.md)
* [Instant Recovery from Storage Snapshots](storage_instant_recovery.md)
* [Instant Disc Recovery from Storage Snapshots](storage_instant_disc_recovery.md)
