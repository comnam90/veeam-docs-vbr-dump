...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/vesp_login_sites.html"
...
This step is only available for data restore from backups created by Veeam Backup for Microsoft 365 and if you have selected the Modern Authentication option at the [previous step](vesp_select_authentication_method_sites.md) of the wizard.
