...
* If you have replication jobs, map VM replicas manually to each replication job.
* Re-add VM containers to the list of source VMs in the jobs settings. Click Recalculate to make sure that all source objects were found.
