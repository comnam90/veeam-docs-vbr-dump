...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/hpe_backup_job_clone.html"
...
To change the name of a cloned job, edit the job as described in section [Editing Backup Job Settings](hpe_backup_job_edit.md).
...
[![Cloning Job](images/hpe_backup_job_clone.webp)](images/hpe_backup_job_clone.webp "Cloning Job")
