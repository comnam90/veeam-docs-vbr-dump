...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/uh_restore_instant.html"
last_updated: "2026"
...
With Instant Recovery, you can immediately restore VMs running on a universal hypervisor as VMware vSphere, Microsoft Hyper-V, Nutanix AHV and Proxmox VE VMs to your production environment by running them directly from their backups. Instant VM Recovery helps you improve recovery time objectives and minimize disruption and downtime of production workloads. For more information on Instant VM Recovery, see [VM Recovery](vm_restores.md).
...
[![Instant VM Recovery](images/uh_restore_instant.webp)](images/uh_restore_instant.webp "Instant VM Recovery")
