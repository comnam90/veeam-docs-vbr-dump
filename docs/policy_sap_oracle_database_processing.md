...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/policy_sap_oracle_database_processing.html"
...
2. Specify log processing settings for the objects in the list. To learn more, see [Processing settings](policy_sap_oracle_database_processing_general.md).
...
![Step 6. Specify Database Processing Settings](images/plugins_policy_sap_oracle_database_processing.webp)
