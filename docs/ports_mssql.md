...
| Veeam Backup & Replication server | Backup repository server or gateway server | TCP | 6162 | Default port used by Veeam Data Mover Service. |
| Microsoft Windows server used as a backup repository or gateway server | TCP | 6160 | Default port used by the Veeam Installer Service and Veeam Data Mover Service. |
