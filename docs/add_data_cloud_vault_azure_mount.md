...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/add_data_cloud_vault_azure_mount.html"
last_updated: "2026"
...
At the Mount Servers step of the wizard, you can specify servers that will be used to mount backed-up Azure VM disks and copy data to restore locations. Windows mount servers are required to restore data from Windows Azure VMs and Linux mount servers are required to restore data from Azure VMs.
