...
* Veeam Backup for Microsoft Entra ID supports restore of [Hybrid identity](https://learn.microsoft.com/en-us/entra/identity/hybrid/) users — to learn how to restore these users, see [Restoring Synchronized Users (Hybrid Identity)](entra_id_restore_sync_users.md).
