...
To change the Veeam Backup & Replication service account, perform the following steps for each supported service:

1. On the Veeam Backup & Replication backup server, open the Start menu, type services.msc. Press Enter to launch the Services console.
2. In the Services console, do the following:
...
2. In the Services console, click Start to restart the service.
