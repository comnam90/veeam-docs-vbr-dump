...
1. Select the necessary workloads in the Files location list and click Path. Alternatively, you can expand a workload in the list and select individual files. Use this method if you want to place configuration and disk files to different locations.
