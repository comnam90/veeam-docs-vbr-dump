...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_policy_retry_notification_fsx.html"
last_updated: "2026"
...
| --- |
| Note |
| To be able to specify email notification settings for the FSx Backup policy, you must configure [global notification settings](aws_email_settings.md) first. |
...
[![Creating FSx Backup Policy](images/aws_backup_add_retry_notification_fsx.webp)](images/aws_backup_add_retry_notification_fsx.webp "Creating FSx Backup Policy")
