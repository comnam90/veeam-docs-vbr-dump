...
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/files_to_tape_pool_increments.html"
...
At the Incremental Backup step of the wizard, choose a media pool that will be used for archiving incremental backups of the selected files and create a schedule for incremental file backups.  Veeam Backup & Replication allows you to select different media pools for full backups and incremental backups. This can be required if you use different media set or retention settings for archiving full backups and increments.

1. From the Media pool for incremental backup list, choose a media pool that will be used for incremental file backups.
...
![Step 5. Specify Media Pool for Incremental Backups](images/files_to_tape_pool_increments.webp)
