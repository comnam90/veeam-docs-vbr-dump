...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/agent_policy_win_vss_indexing_web.html"
last_updated: "2026"
...
2. Click Customize.
3. In the Customize Guest Processing Settings window, select the check box next to the protection group or individual computer and click Guest Indexing on the toolbar.
...
* Select Index everything if you want to index all files within the backup scope that you have specified at the [Backup Mode](agent_policy_win_mode_web.md) step of the wizard. Veeam Agent for Microsoft Windows will index all files that reside:
...
[![Specify Indexing Settings](images/agent_policy_vss_indexing_web.webp)](images/agent_policy_vss_indexing_web.webp "Specify Indexing Settings")
