...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/restore_entire_bucket_byb_web.html"
last_updated: "2026"
...
* Restore data [to the original location or to another location with the overwrite option](restore_entire_bucket_restore_options_web.md#overwrite).
