...
product: "vbr"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbr/userguide/aws_add_sla_policy_guest_processing.html"
last_updated: "2026"
...
For example, you can instruct the backup appliance to execute a pre-snapshot script on an EC2 instance to quiesce its applications — this will allow the backup appliance to create a transactionally consistent snapshot while no write operations occur on on the instance volumes. After the snapshot is created, a post-snapshot script can start the applications again.
