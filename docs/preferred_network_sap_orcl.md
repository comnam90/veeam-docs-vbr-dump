...
|  |
| --- |
| SapOracleBackintConfigTool --add-preferred-network <network\_IP\_address> <position\_in\_list> |
...
The following example shows what the output of the SapOracleBackintConfigTool command with the --show-preferred-networks parameter can look like:

|  |
| --- |
| SapOracleBackintConfigTool --show-preferred-networks  Preferred networks:  1. 172.24.29.156  2. 172.24.26.189 |
...
|  |
| --- |
| SapOracleBackintConfigTool --remove-preferred-network <network\_IP\_address> |
