...
* Open the [Logs and Events](history_statistics_web.md) node. In the working area, select the necessary job and click its Status. In the History box, click the necessary job session.
